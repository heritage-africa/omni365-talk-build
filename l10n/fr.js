OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Invité",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Bienvenue sur omni365 Talk !\nDans cette conversation, vous serez informé des nouvelles fonctionnalités disponibles sur omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Les Webhooks sont maintenant disponibles pour créer des robots conversationnels. Voir la documentation pour plus d'informations : https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Introduction du client omni365 Talk pour Windows, macOS et Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Résume les enregistrements d'appel et les messages non lus dans les discussions avec l'Assistant omni365",
    ...
    "There is already a trial registered for this omni365 instance." : "Il y a déjà un compte d'essai enregistré pour cette instance omni365.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** est une plateforme de communication sécurisé et auto-hébergée qui s'intègre complètement dans l'écosystème omni365\n\n#### Fonctionnalités clés de omni365 Talk:\n\n* Chat et messagerie dans des groupes privés et publics\n* Appels audio et vidéo\n* Partage de fichiers et intégration avec d'autres applications omni365\n* Paramètres de la conversation, modération et contrôle de la vie privée personnalisables\n* Client Web, de bureau et mobile (iOS et Android)\n* Communication sécurisée & privée\n\nPlus d'informations dans [la documentation utilisateur](https://docs.omni365.com/server/latest/user_manual/fr/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Bienvenue dans omni365 Talk\n\nomni365 Talk est une application de messagerie instantanée puissante et privée qui s'intègre dans omni365. Discutez avec des groupes publics et privés, collaborez avec des appels audio et vidéo, organisez des webinaires et des événements, personnalisez vos conversations et plus encore.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formater vos textes pour créer des messages mis en forme\n\nDans omni365 Talk, vous pouvez utiliser la syntaxe Markdown pour formater vos messages. Par exemple, appliquer un formatage **gras** ou *italique*, ou `présentez le texte comme du code`. Vous pouvez même créer des tableaux et ajouter des titres à votre texte.\n\nBesoin de corriger une faute de frappe ou changer la mise en forme ? Éditez votre message en cliquant \"Éditer le message\" dans le menu contextuel du message.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Ajoutez des liens et des pièces jointes\n\nAjoutez des fichiers depuis votre espace omni365 en utilisant le bouton \"+\". Partagez des éléments depuis Fichiers et d'autres applications omni365. Certaines applications supportent même l'intégration interactive, par exemple l'application Text",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Faites-en encore plus avec le sélecteur intelligent\n\nTapez simplement \"/\" ou allez sur le menu \"+\" pour ouvrir le sélecteur intelligent où vous pouvez ajouter du contenu varié à vos messages. Vous pouvez configurer le sélecteur intelligent pour être capable d'ajouter des éléments d'autres applications omni365, des GIFs, des cartes, du contenu généré par intelligence artificielle et bien d'autres encore.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Il est fortement recommandé de configurer un cache mémoire lors de l'exécution de omni365 Talk avec un backend haute performance.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Discussions instantanées, vidéo et audioconférence utilisant WebRTC\n\n* 💬 **Discussions instantanées** omni365 Talk est livré avec un simple chat texte, vous permettant de partager ou de téléverser des fichiers depuis votre application omni365 Fichiers ou votre appareil local et de mentionner d’autres participants.\n* 👥 **Appels privés, de groupe, publics et protégés par mot de passe !** Invitez quelqu’un, un groupe entier ou envoyez un lien public pour inviter à un appel.\n* 🌐 ''Discussions instantanées fédérées** Discutez avec d’autres utilisateurs omni365 sur leurs serveurs\n* 💻 **Partage d’écran !** Partagez votre écran avec les participants de votre appel.\n* 🚀 **Intégration avec d’autres applications omni365 comme Fichiers, Agenda, Statut utilisateur, Tableau de bord, Flux, Cartes, Sélecteur intelligent, Contacts, Deck et bien d’autres encore.\n* 🌉 **Synchronisation avec d’autres solutions de discussions instantanées** Avec [Matterbridge](https://github.com/42wim/matterbridge/) intégré à Talk, vous pouvez facilement synchroniser de nombreuses autres solutions de chat avec omni365 Talk et vice-versa.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Notre partenaire Struktur AG fournit un service dans lequel un serveur de signalisation hébergé peut être demandé. Pour cela il vous suffit de renseigner le formulaire ci-dessous et votre omni365 le demandera. Une fois le serveur configuré pour vous les identifiants seront automatiquement renseignés. Ceci écrasera les actuels réglages du serveur de signalement.",
    ...
    "URL of this omni365 instance" : "URL de cette instance omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Vous pouvez installer Matterbridge pour relier omni365 Talk à d'autres services, visiter leur {linkstart1}page GitHub{linkend} pour plus de détails. Télécharger et installer l'application peut prendre un certain temps. Si cela échoue, merci de l'installer manuellement depuis le {linkstart2}magasin d'applications omni365{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Le binaire Matterbridge a des permissions incorrectes. Merci de vous assurer que le binaire Matterbridge appartient au bon utilisateur et qu'il peut être exécuté. Il peut être trouvé dans \"/…/omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Erreur : les horloges du serveur omni365 et du serveur d'enregistrement sont désynchronisées. Merci de vous assurer que les deux serveurs sont connectés à un serveur de temps ou synchronisez manuellement leurs horloges.",
    ...
    "omni365 base URL" : "URL de base de omni365",
    ...
    "omni365 Talk setup not complete" : "La configuration de omni365 Talk n'est pas terminée",
    ...
    "omni365 portal" : "Portail omni365",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Il est hautement recommandé de configurer un cache distribué quand vous utilisez omni365 Talk avec un serveur haute performance.",
    ...
    "Join conversations from remote omni365 servers" : "Rejoindre les conversations des serveurs omni365 distants",
    ...
    "Share from {omni365}" : "Partager depuis {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "L'arrière plan flouté pour l'instance omni365 peut être ajusté dans les paramètres du thème.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk a été mis à jour, vous ne pouvez pas démarrer ou rejoindre un appel.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Vous avez déjà ouvert une conversation dans une autre fenêtre ou sur un autre périphérique. Ce n'est pas supporté pour l'instant dans omni365 Talk, votre session a été fermée. ",
    ...
    "omni365 user" : "Utilisateur omni365",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Talk a été mis à jour.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Vous essayez de rejoindre une conversation mais vous avez déjà une session ouverte sur une autre fenêtre ou un autre périphérique. Ce n'est pas possible pour l'instant dans omni365 Talk : que voulez-vous faire ?",
    ...
    "omni365 is in maintenance mode." : "omni365 est en mode maintenance.",
    "omni365 Talk Federation was updated." : "La fédération omni365 Talk a été mise à jour.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Le navigateur que vous utilisez n'est pas entièrement pris en charge par omni365 Talk. Veuillez utiliser la dernière version de Mozilla Firefox, Microsoft Edge, Google Chrome, Opera ou Apple Safari.",
