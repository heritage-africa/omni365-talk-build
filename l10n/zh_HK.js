OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "訪客",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## 歡迎來到omni365 Talk!\n在此對話中，我們將向您介紹omni365 Talk中可用的新功能。",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhook 現在可用於實作機器人。要取得更多資訊，請參閱文件 https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- 介紹 omni365 Talk 桌面客戶端，支持 Windows、macOS 和 Linux：%s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- 使用 omni365 Assistant 總結通話錄音和聊天中的未讀消息。",
    ...
    "There is already a trial registered for this omni365 instance." : "此 omni365 實例已經有一個試用用戶註冊。",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** 是一個安全的自托管通訊平台，與 omni365 生態系統無縫集成。\n\n#### omni365 Talk 的重要功能：\n\n* 在私人與群組聊天中傳送訊息\n* 音訊與視訊通話\n* 檔案分享以及其他 omni365 應用程式的整合\n* 可自訂的對話設定、審核與隱私控制\n* 網頁、桌面與行動裝置（iOS 與 Android）\n* 私密且安全的通訊\n\n如需了解更多信息，請參見[用戶說明書] (https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)。",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# 歡迎使用 omni365 Talk\n\nomni365 Talk 是與 omni365 整合的私密且功能強大的訊息應用程式。以私人或群組對話方式聊天、透過語音與視訊通話進行協作、舉辦網路研討會與活動、自訂您的對話等。",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 格式化文字以建立多采多姿的訊息\n\n在 omni365 Talk 中，您可以使用 Markdown 語法來格式化您的訊息。例如，套用**粗體**或*義式斜體*格式，或「將文字突顯為程式碼」。您甚至可以建立表格，並在文字中加入標題。\n\n需要修正錯字或變更格式嗎？按一下訊息功能表中的「編輯訊息」即可編輯您的訊息。",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 新增附件與連結\n\n使用「+」按鈕從 omni365 Hub 附加檔案。從檔案與各種 omni365 應用程式分享項目。有些應用程式甚至支援互動小工具，例如 Text 應用程式。",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ 使用智慧型挑選程式做更多\n\n只要輸入「/」或前往「+」功能表，即可開啟智慧型挑選程式，在這裡您可以將各種內容附加到訊息中。您可以設定智慧型挑選程式，讓它能夠加入 omni365 應用程式、GIF、地圖位置、AI 產生的內容等項目。",
    ...
    "Your web server is not properly set up to deliver `.wasm` files. This is typically an issue with the Nginx configuration. For background blur it needs an adjustment to also deliver `.wasm` files. Compare your Nginx configuration to the recommended configuration in our documentation." : "您的伺服器並未正確的設定，因此無法傳遞 `.wasm` 的檔案。這通常是因為 Nginx 的設定問題所導致。對於背景模糊來說，需要一些調整才能一併傳遞 `.wasm` 的檔案。請檢查您的 Nginx 設定，和 omni365 說明書中提到的建議設定。",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "錯誤：omni365 伺服器和 High-performance 後端伺服器的系統時間不同步。請確保兩個伺服器都連接到時間伺服器，或手動同步它們的時間。",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "強烈建議在使用高效能後端執行 omni365 Talk 時設定記憶體快取。",
    "Client Push" : "客戶端推送",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "使用 WebRTC 的聊天、視頻和音頻會議\n\n* 💬 **聊天** omni365 Talk 提供簡單的文本聊天功能，允許您從 omni365 Files 應用程式或近端裝置分享或上傳檔案，並提及其他參與者。\n* 👥 **私人、小組、公開和密碼保護的通話！** 邀請某人、整個小組或發送公開鏈接來邀請參加通話。\n* 🌐 **聯邦式聊天** 與其他 omni365 用戶在他們的服務器上聊天。\n* 💻 **屏幕共享！** 與通話的參與者共享您的屏幕。\n* 🚀 **與其他 omni365 應用集成**，如 Files、Calendar、User status、Dashboard、Flow、Maps、Smart picker、Contacts、Deck 等，還有更多。\n* 🌉 **與其他聊天解決方案同步** 通過 [Matterbridge](https://github.com/42wim/matterbridge/) 在 Talk 中集成，您可以輕鬆將許多其他聊天解決方案與 omni365 Talk 進行同步，反之亦然。",
    "Leave call" : "離開通話",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "我們的合作夥伴 Struktur AG 提供信令伺服器的託管服務。您只需要填寫下面的表格，您的 omni365 就會為您申請該服務。為您設置伺服器後，將自動填寫憑據。這將覆蓋現有的信令伺服器設置。",
    "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly." : "如果您的高性能後端系統帳戶包括 STUN 和/或 TURN 功能，設定將被相應更新。",
    "URL of this omni365 instance" : "此omni365的 URL",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "您可以安裝 Matterbridge 將 omni365 Talk 連結到其他服務，請訪問其 {linkstart1}GitHub頁面{linkend} 以了解更多詳細信息。下載和安裝該應用程式可能需要一段時間。如果超時，請從 {linkstart2}omni365 App Store{linkend} 人手安裝。",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Matterbridge binary 的權限不正確。請確保 Matterbridge binary 歸正確的用戶所有並且可以執行。可以在 \"/…/omni365/apps/talk_matterbridge/bin/\" 中找到。",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "錯誤：omni365 伺服器和 Recording 後端伺服器的系統時間不同步。請確保兩個伺服器都連接到時間伺服器，或手動同步它們的時間。",
    ...
    "omni365 base URL" : "omni365 基本 URL",
    ...
    "omni365 Talk setup not complete" : "未完成 omni365 Talk 設定",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "使用 omni365 Talk 搭配高效能後端時，強烈建議設定分散式快取。",
    ...
    "Speaker view" : "演講者視圖",
    "Grid view" : "網格檢視",
    "Error when trying to load the available live transcription languages" : "嘗試加載可用的即時轉錄語言時出錯",
    "Failed to enable live transcription" : "無法啟用轉錄",
    ...
    "None" : "無",
    "Select a microphone" : "選擇米高風",
    "Select a speaker" : "選擇喇叭",
    ...
    "Set language spoken in calls" : "設置通話語言",
    "Languages could not be loaded" : "無法加載語言",
    "Loading languages …" : "正在載入語言 …",
    "Invalid language" : "無效的語言",
    "Default language (English)" : "默認語言 (英文)",
    "Default live transcription language set" : "默認即時轉錄語言集",
    "Live transcription language set: {languageName}" : "即時轉錄語言集: {languageName}",
    "Error when trying to set live transcription language" : "嘗試設置即時轉錄語言時出錯",
    ...
    "Join conversations from remote omni365 servers" : "加入來自遠端 omni365 伺服器的對話",
    ...
    "Replacement:" : "取代︰",
    "Share from {omni365}" : "透過 {omni365} 分享",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "可以在主題設置中調整 omni365 實例的背景模糊效果。",
    ...
    "Start call" : "開始通話",
    "End call" : "結束通話",
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk 已更新，您無法開始或加入通話。",
    ...
    "Select virtual background" : "選擇虛擬背景",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "您在另一個窗口或裝置中加入了對話。omni365 Talk 目前不支持此功能，因此該節，時段已關閉。",
    ...
    "Default" : "默認",
    "Follow conversation settings" : "跟隨對話設定",
    "Group" : "群組",
    "Team" : "團隊",
    ...
    "{actor}:" : "{actor}：",
    "omni365 Talk was updated." : "omni365 已更新。",
    "(edited by you)" : "（由您編輯）",
    "(edited by a deleted user)" : "(已刪除的用戶編輯)",
    "(edited by {moderator})" : "（由 {moderator} 編輯）",
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "您正在嘗試加入對話，而在另一個窗口或裝置中擁有活動會話。omni365 Talk 目前不支持此功能。你想做什麼？",
    ...
    "omni365 is in maintenance mode." : "omni365 處於維護模式。",
    "omni365 Talk Federation was updated." : "omni365 Talk Federation 已更新。",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "omni365 Talk 不完全支持您使用的瀏覽器。請使用最新版本的 Mozilla Firefox，Microsoft Edge，Google Chrome，Opera 或 Apple Safari。",
