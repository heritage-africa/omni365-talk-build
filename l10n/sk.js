OC.L10N.register(
    ...
    "Talk" : "Talk /Rozhovor/",
    "Guest" : "Hosť",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "Vitajte v omni365 Talk /Rozhovore/!\nV tejto konverzácii vás budeme informovať o nových funkciách, ktoré sú dostupné v aplikácii omni365 Talk /Rozhovor/.",
    ...
    "- Talk can now have commands, send \"/help\" as a chat message to see if your administrator configured some" : "- Aplikácia Talk /Rozhovor/ teraz disponuje príkazmi pre aplikáciu. To, či správca vášho omni365 nejaké nastavil, zistíte zaslaním správy s textom „/ help“",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhooky sú teraz k dispozícii na implementáciu botov. Viac informácií nájdete v dokumentácii https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Predstavujeme desktopového klienta omni365 Talk pre Windows, MacOS a Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Zhrnutie nahrávok hovorov a neprečítaných správ v rozhovoroch pomocou asistenta omni365",
    ...
    "There is already a trial registered for this omni365 instance." : "Pre túto inštanciu omni365 je už zaregistrovaná skúšobná verzia.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** je bezpečná komunikačná platforma na vlastnom serveri, ktorá sa hladko integruje do ekosystému omni365.\n\n#### Kľúčové vlastnosti omni365 Talk:\n\n* Chat a správy v súkromných a skupinových chatoch\n* Hlasové hovory a videohovory\n* Zdieľanie súborov a integrácia s inými aplikáciami omni365\n* Prispôsobiteľné nastavenia konverzácie, moderovanie a ovládanie súkromia\n* Web, počítač a mobil (iOS a Android)\n* Súkromná a bezpečná komunikácia\n\nViac informácií nájdete v [používateľskej dokumentácii](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Vitajte v omni365 Talk\n\nomni365 Talk je súkromná a výkonná aplikácia na odosielanie správ, ktorá sa integruje s omni365. Chatujte v súkromných alebo skupinových konverzáciách, spolupracujte prostredníctvom hlasových hovorov a videohovorov, organizujte webináre a udalosti, prispôsobujte si konverzácie a ďalšie.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formátujte texty pre vytváranie formátovaných správ\n\nV omni365 Talk môžete použiť syntax Markdown na formátovanie správ. Použite napríklad formátovanie **tučné** alebo *kurzíva* alebo „zvýraznenie textov ako kódu“. Môžete dokonca vytvárať tabuľky a pridávať nadpisy do textu.\n\nPotrebujete opraviť preklep alebo zmeniť formátovanie? Upravte svoju správu kliknutím na „Upraviť správu“ v ponuke správ.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Pridajte prílohy a odkazy\n\nPripojte súbory z vášho omni365 Hub pomocou tlačidla „+“. Zdieľajte položky zo súborov a rôznych aplikácií omni365. Niektoré aplikácie dokonca podporujú interaktívne miniaplikácie, napríklad aplikácia Text.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Urobte viac pomocou funkcie Smart Picker\n\nJednoducho napíšte „/“ alebo prejdite do ponuky „+“ a otvorte Smart Picker, kde môžete k svojim správam pripojiť rôzny obsah. Inteligentný výber môžete nakonfigurovať tak, aby bolo možné pridávať položky z aplikácií omni365, súbory GIF, miesta na mape, obsah generovaný AI a oveľa viac.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Pri spustení omni365 Talk s vysokovýkonným backendom sa dôrazne odporúča nakonfigurovať vyrovnávaciu pamäť.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chat, video a audiokonferencie pomocou WebRTC\n\n* 💬 **Chat** omni365 Talk prichádza s jednoduchým textovým chatom, ktorý vám umožňuje zdieľať alebo nahrávať súbory z vašej aplikácie omni365 Files alebo miestneho zariadenia a spomenúť ďalších účastníkov.\n* 👥 **Súkromné, skupinové, verejné a heslom chránené hovory!** Pozvite niekoho, celú skupinu alebo pošlite verejný odkaz na pozvanie na hovor.\n* 🌐 **Federované chaty** Chatujte s ostatnými používateľmi omni365 na ich serveroch\n* 💻 **Zdieľanie obrazovky!** Zdieľajte svoju obrazovku s účastníkmi vášho hovoru.\n* 🚀 **Integrácia s ďalšími aplikáciami omni365**, ako sú Súbory, Kalendár, Stav používateľa, Dashboard, Flow, Mapy, Inteligentný výber, Kontakty, Deck a mnoho ďalších.\n* 🌉 **Synchronizácia s inými chatovacími riešeniami** Vďaka integrácii [Matterbridge](https://github.com/42wim/matterbridge/) do aplikácie Talk môžete jednoducho synchronizovať množstvo ďalších chatovacích riešení so službou omni365 Talk a naopak.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Náš partner Struktur AG poskytuje službu, kde je možné požiadať o hosťovaný signalizačný server. Na tento účel stačí vyplniť nasledujúci formulár a omni365 o to požiada. Po nastavení servera sa prihlasovacie údaje vyplnia automaticky. Týmto sa prepíšu existujúce nastavenia signalizačného servera.",
    "URL of this omni365 instance" : "URL tejto inštancie omni365u",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Môžete si nainštalovať Matterbridge a prepojiť omni365 Talk /Rozhovor/ s niektorými ďalšími službami. Ďalšie podrobnosti nájdete na ich {linkstart1}stránke GitHub{linkend}. Stiahnutie a inštalácia aplikácie môže chvíľu trvať. V prípade, že uplynie časový limit, nainštalujte ho manuálne z {linkstart2}omni365 App Store{linkend}.",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Chyba: Systémové časy servera omni365 a servera pre nahrávací backend nie sú synchronizované. Uistite sa, že sú oba servery pripojené k časovému serveru alebo manuálne synchronizujte ich čas.",
    ...
    "omni365 base URL" : "Základná URL omni365",
    ...
    "omni365 Talk setup not complete" : "Nastavenie omni365 Talk nie je kompletné",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Pri používaní omni365 Talk s vysokovýkonným backendom sa dôrazne odporúča nastaviť distribuovanú vyrovnávaciu pamäť.",
    ...
    "Join conversations from remote omni365 servers" : "Pripojte sa k rozhovorom zo vzdialených serverov omni365",
    ...
    "Share from {omni365}" : "Zdieľané z {omni365}u",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Pripojili ste sa k rozhovoru v inom okne alebo zariadení. omni365 Talk /Rozhovor/ v súčasnosti túto možnosť nepodporuje, preto bolo sedenie ukončené.",
    ...
    "omni365 user" : "Používateľ omni365",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "K rozhovoru sa pokúšate pripojiť počas aktívnej relácie v inom okne alebo zariadení. omni365 Talk /Rozhovor/ v súčasnosti túto možnosť nepodporuje. Čo chcete urobiť?",
