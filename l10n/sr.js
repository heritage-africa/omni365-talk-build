OC.L10N.register(
    ...
    "Talk" : "Разговор",
    "Guest" : "Гост",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Добродошли у omni365 Talk!\nУ овом разговору ћете бити обавештавани о новим функционалностима која постану доступна у апликацији omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- За имплементирање ботова су доступне веб куке. За више информација, погледајте документацију https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Уводи се omni365 Talk десктоп клијент за Windows, macOS и Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Резиме снимака разговора и непрочитаних порука у ћаскањима са omni365 Асистентом",
    ...
    "There is already a trial registered for this omni365 instance." : "Већ постоји проба регистрована за ову omni365 инстанцу.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** је сигурна платфора за комуникацију која је хостована на вашој инфраструктури и која се неприметно интегрише у omni365 екосистем.\n\n#### Кључне могућности апликације omni365 Talk:\n\n* Чет и размена порука у приватним и групним ћаскањима\n* Гласовни и видео позиви\n* Дељење фајлова и интеграција са осталим omni365 апликацијама\n* Прилагодљива подешавања разговора, модерисање и контрола приватности\n* Веб, десктоп и мобилна верзија (iOS и Android)\n* Приватна и безбедна комуникација\n\n Сазнајте више у [корисничкој документацији](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Добродошли у omni365 Talk\n\nomni365 Talk је приватна и моћна апликација за размену порука која се интегрише са omni365. Чет у приватним и групним разговорима, сарадња преко гласовних и видео позива, организација вебинара и догађаја, прилагођавање ваших разговора и још доста тога.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Форматирајте текст и креирајте обогаћене поруке\n\nУ omni365 Talk можете да користите Markdown синтаксу за означавање порука које шаљете. На пример, примените **подебљано** или *курзив* форматирање, или `истакните текст као изворни кôд`. Можете чак да креирате и табеле или да додате наслове у свој текст.\n\nТреба да исправите грешку у куцању или да измените форматирање? Уредите своју поруку кликом на „Уреди поруку” у менију поруке.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Додајте прилоге и линкове\n\nКористећи дугме „+” можете да додате фајлове из свог omni365 Hub. Делите ставке из Фајлова и разних omni365 апликација. Неке апликације чак подржавају и интерактивне виџете, на пример, апликација Текст.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Урадите више употребом Паметног бирача\n\nКада желите да отворите Паметни бирач, просто откуцајте „/” или идите на „+” мени, и тако прикачите разни садржај у своје поруке. Паметни бирач можете подесити тако да буде у могућности да додаје ставке из omni365 апликација, GIF-ове, локације на мапи, AI генерисани садржај и још много тога.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Грешка: системскко време omni365 сервера и сервера позадинског механизма високе перформансе. Молимо вас да обезбедите везу оба сервера са сервером тачног времена, или ручно ускладите време на њима.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Када се omni365 Talk користи заједно са позадинским механизмом високих перформанси, снажно се препоручује да се подеси кеширање меморије.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Чет, видео & аудио конференције помоћу WebRTC\n\n* 💬 **Чет** omni365 Talk се испоручује са једноставним текст четом који вам омогућава да делите или отпремате фајлове из ваше апликације omni365 Фајлови или са локалног уређаја, као и да помињете остале учеснике.\n* 👥 **Приватни, групни, јавни и лозинком заштићени позиви!** Позовите некога, целу групу, или пошаљите јавни линк да бисте позвали у позив.\n* 🌐 **Федерисани четови** Четујте са осталим omni365 корисницима на њиховим серверима\n* 💻 **Дељење екрана!** Делите свој екран са учесницима позива.\n* 🚀 **Интеграција са осталим omni365 апликацијама** као што су Фајлови, Календар, Статус корисника, Контролна табла, Ток, Мапе, Паметни бирач, Контакти, Шпил и многе друге.\n* 🌉 **Синхронизација са осталим чет решењима** Пошто је [Matterbridge](https://github.com/42wim/matterbridge/) интегрисан у Talk, једноставно можете да синхронизујте велики број осталих чет решења у omni365 Talk и обрнуто.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Наш партнер Struktur AG обезбеђује сервис којим може да се захтева хостовани сервер за сигнализацију. За ово је потребно само да испуните доњи формулар и ваш omni365 ће послати захтев. Једном кад се сервер постави за вас, подаци за пријаву ће се аутоматски попунити. Ово ће да препише постојећа подешавања сервера за сигнализацију.",
    ...
    "URL of this omni365 instance" : "URL ове omni365 инстанце",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Можете да инсталирате Matterbridge да бисте повезали omni365 Talk са неким другим сервисима, посетите њихову {linkstart1}GitHub страницу{linkend} за више детаља. Преузимање и инсталирање апликације може да потраје. У случају да истекне време, молимо вас да је ручно инсталирате из {linkstart2}omni365 продавнице апликација{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Matterbridge бинарни фајл нема исправне дозволе. Молимо вас да обезбедите да је власник Matterbridge бинарног фајла одговарајући корисник и да може да се изврши. Можете га пронаћи у „/…/omni365/apps/talk_matterbridge/bin/”.",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Грешка: системскко време omni365 сервера и сервера позадинског механизма снимања нису синхронизована. Молимо вас да обезбедите везу оба сервера са сервером тачног времена, или ручно ускладите време на њима.",
    ...
    "omni365 base URL" : "omni365 базна URL адреса",
    ...
    "omni365 Talk setup not complete" : "omni365 Talk подешавање није довршено",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Када се користи omni365 Talk са позадинским механизмом високих перформанси, снажно се препоручује да се подеси дистрибуирани кеш.",
    ...
    "Join conversations from remote omni365 servers" : "Приступи разговорима са удаљених omni365 сервера",
    ...
    "Replacement:" : "Замена:",
    "Share from {omni365}" : "Дељење од {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Замућење позадине за omni365 инстанце се може поставити у подешавањима теме",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk је ажуриран, не можете да започнете или да се придружите позиву.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Приступили сте разговору у другом прозору или на другом уређају. omni365 Talk то тренутно не подржава, па је ова сесија затворена.",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 talk је ажуриран.",
    "(edited by you)" : "(ви сте уредили)",
    "(edited by a deleted user)" : "(уредио је обрисани корисник)",
    "(edited by {moderator})" : "(уредио {moderator})",
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Покушавате да приступите разговору док имате активну сесију у другом прозору или на другом уређају. omni365 Talk тренутно то не подржава. Шта желите да урадите?",
