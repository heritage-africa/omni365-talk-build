OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Gość",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Witamy w omni365 Talk!\nW tej rozmowie zostaniesz poinformowany o nowych funkcjach dostępnych w omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Dostępne są teraz webhooki umożliwiające wdrażanie botów. Zobacz dokumentację, aby uzyskać więcej informacji https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Przedstawiamy klienta stacjonarnego omni365 Talk dla systemów Windows, macOS i Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Podsumowuj nagrania rozmów i nieprzeczytane wiadomości na czatach za pomocą Asystenta omni365",
    ...
    "There is already a trial registered for this omni365 instance." : "Jest już zarejestrowany okres testowy dla tej instancji omni365.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** to bezpieczna, samodzielnie hostowana platforma komunikacyjna, która bezproblemowo integruje się z ekosystemem omni365.\n\n#### Główne funkcje omni365 Talk:\n\n* Czat i wiadomości w prywatnych i grupowych czatach\n* Połączenia głosowe i wideo\n* Udostępnianie plików i integracja z innymi aplikacjami omni365\n* Konfigurowalne ustawienia rozmów, moderacja i kontrola prywatności\n* Internet, komputer i urządzenie mobilne (iOS i Android)\n* Prywatna i bezpieczna komunikacja\n\nDowiedz się więcej w [dokumentacji użytkownika](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Witamy w omni365 Talk\n\nomni365 Talk to prywatna i wydajna aplikacja do przesyłania wiadomości, która integruje się z omni365. Rozmawiaj w prywatnych lub grupowych rozmów, współpracuj przez połączenia głosowe i wideo, organizuj webinaria i wydarzenia, dostosowuj swoje rozmowy i nie tylko.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formatuj teksty, aby tworzyć bogate wiadomości\n\nW omni365 Talk możesz używać składni Markdown do formatowania wiadomości. Na przykład zastosuj formatowanie **bold** lub *italic* lub `highlight texts as code`. Możesz nawet tworzyć tabele i dodawać nagłówki do tekstu.\n\nMusisz poprawić literówkę lub zmienić formatowanie? Edytuj wiadomość, klikając \"Edytuj wiadomość\" w menu wiadomości.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Dodaj załączniki i linki\n\nDołącz pliki z omni365 Hub za pomocą przycisku \"+\". Udostępniaj elementy z Plików i różnych aplikacji omni365. Niektóre aplikacje obsługują nawet interaktywne widżety, na przykład aplikacja Tekst.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Zrób więcej dzięki Smart Picker\n\nPo prostu wpisz \"/\" lub przejdź do menu \"+\", aby otworzyć Smart Picker, w którym możesz dołączać różne treści do swoich wiadomości. Możesz skonfigurować Smart Picker, aby móc dodawać elementy z aplikacji omni365, pliki GIF, lokalizacje na mapie, treści generowane przez AI i wiele więcej.",
    ...
    "No High-performance backend configured - Running omni365 Talk without the High-performance backend only scales for very small calls (max. 2-3 participants). Please set up the High-performance backend to ensure calls with multiple participants work seamlessly." : "Brak skonfigurowanego zaplecza o wysokiej wydajności - Uruchomienie omni365 Talk bez zaplecza o wysokiej wydajności jest skalowalne tylko dla bardzo małych połączeń (maks. 2–3 uczestników). Skonfiguruj zaplecze o wysokiej wydajności, aby zapewnić bezproblemową pracę połączeń z wieloma uczestnikami.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Błąd: Czasy systemowe serwera omni365 i serwera zaplecza o wysokiej wydajności są niezsynchronizowane. Upewnij się, że oba serwery są połączone z serwerem czasu lub ręcznie zsynchronizuj ich czas.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Zdecydowanie zaleca się skonfigurowanie pamięci podręcznej w przypadku uruchamiania omni365 Talk z zapleczem o wysokiej wydajności.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Czat, wideokonferencje i audiokonferencje z użyciem WebRTC\n\n* 💬 **Czat** omni365 Talk oferuje prosty czat tekstowy, umożliwiający udostępnianie lub przesyłanie plików z aplikacji Pliki omni365 lub lokalnego urządzenia oraz wspominanie innych uczestników.\n\n* 👥 **Prywatne, grupowe, publiczne i chronione hasłem połączenia!** Zaproś kogoś, całą grupę lub wyślij publiczny link, aby zaprosić do połączenia.\n\n* 🌐 **Federacyjne czaty** Czatuj z innymi użytkownikami omni365 na ich serwerach\n* 💻 **Udostępnianie ekranu!** Udostępnij swój ekran uczestnikom połączenia.\n\n* 🚀 **Integracja z innymi aplikacjami omni365**, takimi jak Pliki, Kalendarz, Status użytkownika, Pulpit nawigacyjny, Przepływ, Mapy, Inteligentny selektor, Kontakty, Tablica i wiele innych.\n* 🌉 **Synchronizacja z innymi rozwiązaniami do czatów** Dzięki integracji [Matterbridge](https://github.com/42wim/matterbridge/) z Talk możesz łatwo zsynchronizować wiele innych rozwiązań do czatów z Talk omni365 i odwrotnie.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Nasz partner Struktur AG zapewnia usługę, na której można zamówić hostowany serwer sygnalizacyjny. W tym celu wystarczy jedynie wypełnić poniższy formularz, a Twoja usługa omni365 zrobi to za Ciebie. Po skonfigurowaniu serwera dane uwierzytelniające zostaną wypełnione automatycznie. Spowoduje to zastąpienie istniejących ustawień serwera sygnalizacyjnego.",
    ...
    "URL of this omni365 instance" : "Adres URL tej instancji omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Możesz zainstalować Matterbridge, aby połączyć omni365 Talk z innymi usługami. Odwiedź {linkstart1}stronę GitHub{linkend}, aby uzyskać więcej informacji. Pobieranie i instalowanie aplikacji może chwilę potrwać. W przypadku przekroczenia limitu czasu, zainstaluj ją ręcznie z {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Plik binarny Matterbridge ma nieprawidłowe uprawnienia. Upewnij się, że plik binarny Matterbridge jest własnością właściwego użytkownika i ma ustawione prawo do wykonania. Znajdziesz go w „/…/omni365/apps/talk_matterbridge/bin/”",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Błąd: Czasy systemowe serwera omni365 i serwera zaplecza \"Nagrywanie\" są niezsynchronizowane. Upewnij się, że oba serwery są połączone z serwerem czasu lub ręcznie zsynchronizuj ich czas.",
    ...
    "omni365 base URL" : "Podstawowy adres URL omni365",
    ...
    "omni365 Talk setup not complete" : "Konfiguracja omni365 Talk nie została ukończona",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Zdecydowanie zaleca się skonfigurowanie rozproszonej pamięci podręcznej w przypadku korzystania z omni365 Talk z zapleczem o wysokiej wydajności.",
    ...
    "Join conversations from remote omni365 servers" : "Dołącz do rozmów ze zdalnych serwerów omni365",
    ...
    "Share from {omni365}" : "Udostępnij z {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Rozmycie tła dla instancji omni365 można dostosować w ustawieniach motywu.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "Usługa omni365 Talk została zaktualizowana. Nie można rozpocząć ani dołączyć do rozmowy.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Dołączyłeś do rozmowy w innym oknie lub urządzeniu. Ta sesja została zamknięta, ponieważ nie jest obecnie obsługiwana przez omni365 Talk.",
    ...
    "omni365 URL" : "Adres URL omni365",
    "omni365 user" : "Użytkownik omni365",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "Zaktualizowano omni365 Talk.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Próbujesz dołączyć do rozmowy, mając aktywną sesję w innym oknie lub urządzeniu. Obecnie ta sesja nie jest jeszcze obsługiwana przez omni365 Talk. Co chcesz zrobić?",
    ...
    "omni365 is in maintenance mode." : "omni365 jest w trybie konserwacji.",
    "omni365 Talk Federation was updated." : "Zaktualizowano omni365 Talk Federation.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Używana przeglądarka nie obsługuje w pełni omni365 Talk. Użyj najnowszej wersji Mozilla Firefox, Microsoft Edge, Google Chrome, Opera lub Apple Safari.",
