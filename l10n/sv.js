OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Gäst",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Välkommen till omni365 Talk!\nI den här konversationen kommer du att informeras om nya funktioner som är tillgängliga i omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhooks finns nu tillgängligt för att implementera bots. Läs dokumentationen för mer information https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Introducerar omni365 Talk skrivbordsklient för Windows, macOS och Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Sammanfatta samtalsinspelningar och olästa meddelanden i chattar med omni365 Assistant",
    ...
    "There is already a trial registered for this omni365 instance." : "Det finns redan en utvärdering registerad för den här Nexcloudinstansen.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** är en säker, egenhostad kommunikationsplattform som integreras sömlöst med omni365s ekosystem.\n\n#### Huvudfunktioner i omni365 Talk:\n\n* Chatt och meddelanden i privata och gruppchattar\n* Röst och videosamtal\n* Fildelning och integration med andra omni365-appar\n* Anpassningsbara konversationsinställningar, moderering och sekretesskontroller\n* Webb, dator och mobil (iOS och Android)\n* Privat och säker kommunikation\n\n Läs mer i [användardokumentationen](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Välkommen till omni365 Talk\n\nomni365 Talk är en privat och kraftfull meddelandeapp som integreras med omni365. Chatta i privata eller gruppkonversationer, samarbeta via röst- och videosamtal, organisera webbinarier och evenemang, anpassa dina konversationer och mycket mer.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formatera texter för att skapa innehållsrika meddelanden\n\nI omni365 Talk kan du använda Markdown-syntax för att formatera dina meddelanden. Till exempel kan du använda **fetstil** eller *kursiv*, eller `markera text som kod`. Du kan till och med skapa tabeller och lägga till rubriker i din text.\n\nBehöver du rätta ett stavfel eller ändra formatering? Redigera ditt meddelande genom att klicka på “Redigera meddelande” i meddelandemenyn.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Lägg till bilagor och länkar\n\nBifoga filer från din omni365 Hub med hjälp av “+”-knappen. Dela objekt från Filer och olika omni365-appar. Vissa appar stödjer till och med interaktiva widgets, till exempel Text-appen.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Gör mer med Smart Picker\n\nSkriv “/” eller gå till “+”-menyn för att öppna Smart Picker, där du kan bifoga olika typer av innehåll till dina meddelanden. Du kan konfigurera Smart Picker för att kunna lägga till objekt från omni365-appar, GIF:ar, platsinformation från kartor, AI-genererat innehåll och mycket mer.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Det rekommenderas starkt att konfigurera en minnescache när du kör omni365 Talk med en High-performance backend.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chatt, video och ljudkonferenser med WebRTC\n\n* 💬 **Chat** omni365 Talk kommer med en enkel textchatt, så att du kan dela eller ladda upp filer från din omni365 Files-app eller lokala enhet och nämna andra deltagare.\n* 👥 **Privata, grupp, publika och lösenordsskyddade samtal!** Bjud in någon, en hel grupp eller skicka en publik länk för att bjuda in till ett samtal.\n* 🌐 **Federerade chattar** Chatta med andra omni365-användare på deras servrar\n* 💻 **Skärmdelning!** Dela din skärm med deltagarna i ditt samtal.\n* 🚀 **Integration med andra omni365-appar** som Filer, Kalender, Användarstatus, Dashboard, Flow, Kartor, Smart picker, Kontakter, Deck och många fler.\n* 🌉 **Synkronisera med andra chattlösningar** Med [Matterbridge](https://github.com/42wim/matterbridge/) integrerad i Talk kan du enkelt synkronisera många andra chattlösningar till omni365 Talk och vice versa.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Vår partner Struktur AG tillhandahåller en tjänst där en hostad signalserver kan begäras. För detta behöver du bara fylla i formuläret nedan och din omni365 kommer sedan att skicka begäran. När servern är konfigurerad kommer användaruppgifterna att fyllas i automatiskt. Detta kommer att skriva över de befintliga signalserverinställningarna.",
    ...
    "URL of this omni365 instance" : "URL till denna omni365-instans",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Du kan installera Matterbridge för att länka omni365 Talk till några andra tjänster, besök deras {linkstart1}GitHub-sida{linkend} för mer information. Att ladda ner och installera appen kan ta ett tag. Vid timeout, installera den manuellt från {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Matterbridge binär har felaktiga behörigheter. Se till att den binära Matterbridge-filen ägs av rätt användare och kan köras. Den finns i \"/.../omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Fel: Systemtiderna för omni365-servern och Recording-backend-servern är osynkroniserade. Se till att båda servrarna är anslutna till en tidsserver eller synkronisera deras tid manuellt.",
    ...
    "omni365 base URL" : "omni365 bas-URL",
    ...
    "omni365 Talk setup not complete" : "omni365 Talk-installationen är inte klar",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Det rekommenderas starkt att sätta upp en distribuerad cache när du använder omni365 Talk med en High-performance backend.",
    ...
    "Join conversations from remote omni365 servers" : "Gå med i konversationer från fjärranslutna omni365-servrar",
    ...
    "Share from {omni365}" : "Dela från {omni365}",
    ...
    "Enable blur background by default for all conversations" : "Aktivera suddig bakgrund som standard för alla konversationer",
    "Do not show the device preview screen before joining a call" : "Visa inte enhetens förhandsgranskningsskärm innan du går med i ett samtal",
    "Preview screen will still be shown if recording consent is required" : "Förhandsgranskningsskärmen visas fortfarande om samtycke till inspelning krävs",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Suddig bakgrund för omni365-instansen kan justeras i temainställningarna.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk har uppdaterats, du kan inte starta eller gå med i ett samtal.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Du gick med i konversationen i ett annat fönster eller en annan enhet. Detta stöds för närvarande inte av omni365 Talk så denna session stängdes.",
    ...
    "omni365 user" : "omni365-användare",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Talk har uppdaterats.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Du försöker gå med i en konversation medan du har en aktiv session i ett annat fönster eller en annan enhet. Detta stöds för närvarande inte av omni365 Talk. Vad vill du göra?",
    ...
    "omni365 is in maintenance mode." : "omni365 är i underhållsläge.",
    "omni365 Talk Federation was updated." : "omni365 Talk Federation har uppdaterats.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Webbläsaren du använder stöds inte fullt ut av omni365 Talk. Använd den senaste versionen av Mozilla Firefox, Microsoft Edge, Google Chrome eller Apple Safari.",
