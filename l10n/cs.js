OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Host",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Vítejte v omni365 Talk!\nV této konverzaci budete informováni o nových funkcích, dostupných v omni365 Talk.",
    ...
    "- Talk can now have commands, send \"/help\" as a chat message to see if your administrator configured some" : "- Talk nově disponuje příkazy pro aplikaci. To, zda správce vašeho omni365 nějaké nastavil zjistíte posláním zprávy s textem \"/help\"",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- webové háčky jsou nyní k dispozici pro implementaci automatů. Podrobnosti viz dokumentace https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Uvádí desktopového klienta omni365 Talk pro Windows, macOS a Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Díky omni365 asistentovi si nechte vytvářet shrnutí obsahu nahrávek hovorů a nepřečtených zpráv v chat konverzacích",
    ...
    "There is already a trial registered for this omni365 instance." : "Pro tuto instanci omni365 už je zaregistrováno zkušební období.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** je bezpečná komunikační platforma, která je plně integrovaná do ekosystému omni365.\n\n#### Klíčové vymoženosti omni365 Talk:\n\n* Chatování v místnostech jeden na jednoho i ve skupinových chatech\n* Umožňuje uskutečňovat hlasové hovory i video hovory \n* Můžete jednoduše posílat soubory a využívat integrace s dalšími aplikacemi omni365\n* Nabízí možnosti přizpůsobení konverzací, jejich moderování a správu soukromí\n* Je možné ho používat na Webu, počítači i mobilu (s operačním systémem iOS nebo Android)\n* Skutečně soukromou a zabezpečenou komunikaci\n\nZjistěte více v [dokumentaci pro uživatele](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Vítejte v omni365 Talk\n\nomni365 Talk je soukromá a vybavená aplikace pro posílání zpráv, napojená na omni365 server. Pište si v soukromých nebo skupinových konverzacích, spolupracujte prostřednictvím hlasových a video hovorů, uspořádávejte webináře a události, přizpůsobujte si své konverzace a mnoho dalšího.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Využívejte možností formátování a vytvářejte líbivé zprávy\n\nV omni365 Talk můžete pro formátování zpráv využívat syntaxu Markdown. Například můžete text **ztučnit**, napsat ho *kurzívou* nebo `ho zvýrazňovat jako programový kód`. Dokonce můžete vytvářet tabulky, nadpisy a záhlaví.\n\nPotřebujete opravit překlep nebo změnit formátování? Upravte zprávu ťuknutím na tlačítko \"Upravit zprávu\" v podmenu zprávy.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Vkládejte přílohy a odkazy\n\nPřipojujte soubory z omni365 Hubu pomocí tlačítka \"+\". Sdílejte soubory a položky z dalších aplikací omni365. Některé aplikace podporují i interaktivní widgety, například aplikace Text.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Buďte rychlejší se Smart Picker\n\nJen napište \"/\" nebo běžte do nabídky \"+\" odkud otevřete Smart Picker díky kterému můžete ke svým zprávám přikládat nepřeberné množství obsahu. Smart Picker také můžete nakonfigurovat tak, aby byl schopný připojovat položky z aplikací omni365, GIFy, umístění na mapách, obsah vygenerovaný AI a mnoho dalšího.",
    ...
    "No High-performance backend configured - Running omni365 Talk without the High-performance backend only scales for very small calls (max. 2-3 participants). Please set up the High-performance backend to ensure calls with multiple participants work seamlessly." : "Není nastavená žádná podpůrná vrstva pro vysoký výkon. Provozování omni365 Talk bez ní škáluje pouze pro velmi malé hovory (nejvýše 2-3 účastníci). Nastavte podpůrnou vrstvu pro vysoký výkon a zajistěte tak, že hovory s vícero účastníky budou hladce fungovat.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Chyba: systémové časy omni365 serveru a serveru s podpůrnou vrstvou pro vysoký výkon se liší. Ověřte, že oba servery jsou napojeny na stejný časový server nebo jejich čas ručně sesynchronizujte.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Pokud je omni365 Talk provozován s podpůrnou vrstvou pro vysoký výkon, je vřele doporučováno nastavit mezipaměť v operační paměti.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chat, video a audio konference využívající WebRTC\n\n* 💬 **Chat** omni365 Talk je vybavený jednoduchým textovým chatem, který Vám umožňuje sdílet nebo nahrávat soubory z omni365 Souborů nebo přímo ze zařízení a zmiňovat ostatní účastníky chatu.\n* 👥 **Soukromé, skupinové i veřejné a heslem chráněné hovory!** Pozvěte někoho, třeba celou skupinu lidí nebo pošlete veřejně přístupný odkaz jako pozvánku pro připojení k hovoru.\n* 🌐 **Federované chaty** Chatujte s ostatními uživateli omni365 na jejich serverech.\n* 💻 **Sdílení obrazovky!** Sdílejte to co vidíte na své obrazovce s ostatními účastníky hovoru.\n* 🚀 **Integrace s dalšími aplikacemi omni365** například se Soubory, Kalendářem, Uživatelským stavem, Nástěnkou, Flow, Mapami, Smart Pickerem, Kontakty, Deck a mnoha dalšími.\n* 🌉 **Synchronizujte s jinými poskytovateli chatu** [Matterbridge](https://github.com/42wim/matterbridge/) je do Talk integrovaný, což znamená že můžete jednoduše synchronizovat mnoho dalších chatovacích řešení do omni365 Talk a naopak.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Náš partner, společnost Struktur AG poskytuje službu, u které je možné si zažádat o hostovaný signalizační server. Stačí pouze vyplnit níže uvedený formulář a vaše instance omni365 provede žádost Jakmile je pro vás vytvořen server, přihlašovací údaje budou vyplněny automaticky. Toto přepíše existující nastavení pro signalizační server.",
    ...
    "URL of this omni365 instance" : "URL adresa této instance omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Pro propojení omni365 Talk s některými ostatními službami je možné nainstalovat Matterbridge, podrobnosti viz {linkstart1}stránka na GitHub{linkend}. Stažení a instalace aplikace může chvíli trvat. V případě překročení časového limitu ji prosím nainstalujte ručně z {linkstart2}omni365 katalogu aplikací{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Spustitelný soubor nemá správná oprávnění. Ověřte, že spustitelný soubor s Matterbridge je vlastněn správným uživatelem a je spustitelný. Je k nalezení v „/…/omni365/apps/talk_matterbridge/bin/“.",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Chyba: systémové časy omni365 serveru a serveru s podpůrnou vrstvou pro pořizování nahrávek se liší. Ověřte, že oba servery jsou napojeny na stejný časový server nebo jejich čas ručně sesynchronizujte.",
    ...
    "omni365 base URL" : "Základ URL omni365",
    ...
    "omni365 Talk setup not complete" : "Nastavení omni365 Talk nedokončeno",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Při používání omni365 Talk ve spojení s podpůrnou vrstvou pro vysoký výkon, je doporučeno nastavit distribuovanou mezipaměť.",
    ...
    "Join conversations from remote omni365 servers" : "Připojte se do konverzací na vzdálených omni365 serverech",
    ...
    "Share from {omni365}" : "Nasdílet z {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Rozmazání pozadí pro instanci omni365 je možné přizpůsobit v nastavení motivu vzhledu.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk bylo aktualizováno – nemůžete zahájit hovor nebo se k němu připojit.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Ke konverzaci jste se přidali z jiného okna nebo zařízení. omni365 zatím nepodporuje souběžná připojení a tak tato relace byla uzavřena.",
    ...
    "omni365 URL" : "URL adresa omni365",
    "omni365 user" : "Uživatel omni365",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Talk bylo aktualizováno.",
    "(edited by you)" : "(upraveno vámi)",
    "(edited by a deleted user)" : "(upraveno smazaným uživatelem)",
    "(edited by {moderator})" : "(upravil(a) {moderator})",
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Pokoušíte se připojit ke konverzaci zatímco máte aktivní relaci v ní v jiném okně nebo zařízení. Toto omni365 Talk zatím nepodporuje. Co chcete udělat?",
    ...
    "omni365 is in maintenance mode." : "omni365 se právě nachází v režimu údržby.",
    "omni365 Talk Federation was updated." : "Federovaní omni365 Talk bylo zaktualizováno.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Webový prohlížeč, který používáte, není omni365 Talk plně podporován. Prosíme použijte nejnovější verzi Mozilla Firefox, Microsoft Edge, Google Chrome, Opera nebo Apple Safari.",
