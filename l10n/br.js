OC.L10N.register(
    ...
    "There is already a trial registered for this omni365 instance." : "Un arnodenn a zo bet goulenet d'an azgoulenn Newtcloud dija.",
    ...
    "URL of this omni365 instance" : "URL an azgoulenn omni365",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Deuet oc'h en diviz dre ur prenestr pe ardivink all. N'eo ket douget evit ar poent gant omni365 Talk neuze eo bet sertet an dalc'h.",
    "Join a conversation or start a new one" : "Mont en un diviz pe kregiñ unan nevez ",
    "User" : "Implijer",
    "Password" : "Ger-tremen",
    "Login" : "Anv arveriad",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Ho klask mont en diviz emaoc'h p'ho peus un dalc'h en ur prenestr pe ardivink all. N'eo ket douget c'hoaz gant omni365 Talk. Petra o peus c'hoant ober ?",
