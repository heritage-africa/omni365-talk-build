OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Gast",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "Welkom bij omni365 Talk!\nIn dit gesprek vertellen we je over de nieuwe functies die beschikbaar zijn in omni365 Talk.",
    ...
    "File shares are currently not supported in federated conversations" : "Bestandsdelen is momenteel niet ondersteund in gesprekken met andere omni365 servers",
    ...
    "There is already a trial registered for this omni365 instance." : "Er is al een proefversie geregistreerd voor deze omni365-instantie.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** is a veilige, zelf-gehost communicatie platform wat volledig integreerd met het omni365 ecosysteem.\n\n#### Belangrijkste mogelijkheden van omni365 Talk:\n\n* Chat and berichtjes in prive en groepsgesprekken\n* Audio en video gesprekken\n* Bestanden delen en integratie met andere omni365 applicaties\n* Aanpasbare gespreksinstellingen, moderatie en privacy instellingen\n* Browser, desktop en mobiele (iOS and Android) toegang\n* Private & veilige communicatie\n\nVind meer informatie in de [gebruikershandleiding](https://docs.omni365.com/server/latest/user_manual/nl/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Welkom bij omni365 Talk\n\nomni365 Talk is een privacy-vriendelijke en geavanceerde chat applicatie die diep met omni365 integreerd. Je kunt prive of in groepen discussieren, samenwerken aan documenten of whiteboards tijdens audio of video gesprekken, webinars en evenementen organiseren, gesprekken modereren en nog veel meer.",
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Doe meer met Smart Picker\n\nTyp eenvoudig \"/\" of ga naar het menu \"+\" om de Smart Picker te openen, waar je verschillende inhoud aan je berichten kunt toevoegen. je kunt de Smart Picker zo configureren dat je items uit omni365-apps, GIF's, kaartlocaties, door AI gegenereerde inhoud en nog veel meer kunt toevoegen.",
    "Andorra" : "Andorra",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Het wordt sterk aanbevolen om een ​​geheugencache te configureren wanneer u omni365 Talk uitvoert met een High-performance backend.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chat, video & audio-conferencing met WebRTC\n\n* 💬 **Chat** omni365 Talk komt met een eenvoudige tekstchat, maakt het mogelijk om bestanden te delen en uploaden vanuit je Netxcloud Bestanden-app of je lokale apparaat en het noemen van andere deelnemers.\n* 👥 **Privé-, groep-, publieke en wachtwoordbeveiligde gesprekken!** Nodig iemand uit, of een hele groep of verstuur een openbare link om mensen uit te nodigen voor een gesprek.\n* 🌐 **Federated chats** Chat met andere gebruikers op hun omni365 servers\n* 💻 **Schermdelen!** Deel je scherm met de deelnemers van je gesprek.\n* 🚀 **Integratie met andere omni365 apps** zoals Bestanden, Agenda, Gebruikersstatus, Dashboard, Flow, Kaarten, Smart Picker, Contacten, Deck en vele andere.\n* 🌉 **Sync met andere chat-oplossingen** Met [Matterbridge](https://github.com/42wim/matterbridge/) geïntegreerd in Talk, kan je eenvoudig veel andere chat-oplossingen met omni365 Tals en vice versa.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Onze partner Struktur AG biedt een service waarbij een gehoste signaleringsserver kan worden aangevraagd. Hiervoor hoef je alleen maar het onderstaande formulier in te vullen en je omni365 zal erom vragen. Zodra de server voor je is ingesteld, worden de inloggegevens automatisch ingevuld. Hierdoor worden de bestaande instellingen van de signaleringsserver overschreven.",
    "URL of this omni365 instance" : "URL van deze omni365 server",
    ...
    "Join conversations from remote omni365 servers" : "Neem deel aan gesprekken van andere Netxcloud servers",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Je nam deel aan het gesprek in een ander venster of apparaat. Dit wordt momenteel niet ondersteund door omni365 Talk, dus deze sessie is gesloten.",
    "Join a conversation or start a new one" : "Doe mee met een discussie, of start een nieuwe",
    "omni365 URL" : "omni365 URL",
    "omni365 user" : "omni365 gebruiker",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Je probeert deel te nemen aan een gesprek terwijl je een actieve sessie hebt in een ander venster of apparaat. Dit wordt momenteel niet ondersteund door omni365 Talk. Wat wil je doen?",
    ...
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "De browser die je gebruikt, wordt niet volledig ondersteund door omni365 Talk. Gebruik alsjeblieft de laatste versie van Mozilla Firefox, Microsoft Edge, Google Chrome, Opera of Apple Safari.",
