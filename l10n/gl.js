OC.L10N.register(
    ...
    "Talk" : "Parladoiro",
    "Guest" : "Convidado",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Dámoslle a benvida a Parladoiro de omni365!\nNesta conversa estará informado sobre as novas funcións dispoñíbeis no Parladoiro de omni365.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Xa están dispoñíbeis os puntos de ancoraxe web para implementar bots. Consulte a documentación para obter máis información en https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Presentación do cliente de escritorio Parladoiro de omni365 para Windows, macOS e Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Resume as gravacións de chamadas e as mensaxes non lidas nas parolas co Asistente de omni365",
    ...
    "There is already a trial registered for this omni365 instance." : "Xa hai unha proba rexistrada para esta instancia de omni365.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**Parladoiro de omni365** é unha plataforma de comunicación segura en aloxamento autónomo que se integra perfectamente co ecosistema omni365.\n\n#### Funcionalidades principais de Parladoiro de omni365:\n\n* Parola e mensaxería en parolas privadas e en grupo\n* Chamadas de vox e vídeo\n* Compartir ficheiros e integración con outras aplicacións omni365\n* Axustes personalizábeis de conversa, moderación e controis de privacidade\n* Web, escritorio e móbil (iOS e Android)\n* Comunicación privada e segura\n\nObteña máis información na [Documentación do usuario](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Dámoslle a benvida a Parladoiro de omni365\n\nParladoiro de omni365 é unha aplicación de mensaxería privada e potente que se integra con omni365. Parole en conversas privadas ou en grupo, participe en chamadas de voz e vídeo, organice seminarios e eventos, personalice as súas conversas e moito máis.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formatar textos para crear mensaxes melloradas\n\nEn Parladoiro de omni365, pode usar a sintaxe Markdown para formatar as súas mensaxes. Por exemplo, aplique o formatado como **grosa** ou *cursiva*, ou `destaque textos como código`. Pode incluso crear táboas e engadir títulos ao seu texto.\n\nNecesita arranxar un erro de escritura ou cambiar o formatado? Edite a mensaxe premendo en «Editar mensaxe» no menú da mensaxe.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Engada anexos e ligazóns\n\nEngada ficheiros do seu omni365 Hub empregando o botón «+». Comparta elementos de ficheiros e varias aplicacións de omni365. Algunhas aplicacións incluso admiten trebellos interactivos, por exemplo, a aplicación de Texto.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Faga máis cousas co Selector intelixente\n\nSó ten que escribir «/» ou ir ao menú «+» para abrir o selector intelixente onde pode achegar diversos contidos ás súas mensaxes. Pode configurar o selector intelixente para poder engadir elementos de aplicacións de omni365, GIF, localizacións de mapas, contido xerado por IA e moito máis.",
    ...
    "No High-performance backend configured - Running omni365 Talk without the High-performance backend only scales for very small calls (max. 2-3 participants). Please set up the High-performance backend to ensure calls with multiple participants work seamlessly." : "A infraestrutura de alto rendemento está sen configurar: a execución de Parladoiro de omni365 sen a infraestrutura de alto rendemento só se adapta a chamadas moi pequenas (máx. 2-3 participantes). Configure a infraestrutura de alto rendemento para garantir que as chamadas con varios participantes funcionen sen problemas.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Erro: a hora do sistema do servidor omni365 e do servidor da infraestrutura de alto rendemento non están sincronizadas. Asegúrese de que ambos os servidores estean conectados a un servidor de hora ou sincronice manualmente a súa hora.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "É moi recomendábel configurar unha memoria tobo cando se executa Parladoiro de omni365 cunha infraestrutura de alto rendemento.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Parolas, conferencias de vídeo e son empregando WebRTC \n\n* 💬 **Parolar** Parladoiro de omni365 inclúe parolas de texto simple, que lle permite compartir ou enviar ficheiros desde a súa aplicación omni365 Ficeiros ou dispositivo local e mencionar a outros participantes.\n* 👥 **Chamadas privadas, grupais, públicas e protexidas por contrasinal!** Convide a alguén, a todo un grupo ou envíe unha ligazón pública para convidar a unha chamada.\n* 🌐 **Parolas federadas** Parole con outros usuarios de omni365 nos seus servidores\n* 💻 **Compartir pantalla!** Comparta a súa pantalla cos participantes na súa chamada.\n* 🚀 **Integración con outras aplicacións de omni365** como Ficheiros, Calendario, Estado do usuario, Taboleiro, Fluxo, Mapas, Selector intelixente, Contactos, Gabeta e moitos máis.\n* 🌉 **Sincronizar con outras solucións de parola** Con [Matterbridge]https://github.com/42wim/matterbridge/) integrado en Parladoiro, pode sincronizar de xeito doado moitas outras solucións de parolas con Parladoiro de omni365 e viceversa.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "O noso socio Struktur AG ofrece un servizo onde se pode solicitar un servidor de sinalización aloxado. Para isto, só ten que cumprimentar o seguinte formulario e o seu omni365 solicitarao. Unha vez que o servidor estea configurado  para Vde., as credenciais encheranse automaticamente. Isto sobrescribirá os axustes do servidor de sinalización existente.",
    ...
    "URL of this omni365 instance" : "URL desta instancia de omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Pode instalar Matterbridge para vincular Parladoiro de omni365 con outros servizos, visite a súa {linkstart1}páxina de GitHub{linkend} para obter máis detalles. A descarga e a instalación da aplicación pode levar un tempo. No caso de que se esgote, instáleo manualmente desde a {linkstart2}tenda de aplicacións de omni365{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "O binario do Matterbridge ten permisos incorrectos. Asegúrese de que o ficheiro binario do Matterbridge é propiedade do usuario correcto e que se pode executar. Pódeo atopar en «/…/omni365/apps/talk_matterbridge/bin/».",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Erro: os tempos do sistema do servidor omni365 e do servidor da infraestrutura de gravación non están sincronizados. Asegúrese de que ambos os servidores estean conectados a un servidor de tempo ou sincronice manualmente a súa hora.",
    ...
    "omni365 Talk setup not complete" : "A configuración de Parladoiro de omni365 non está completa",
    ...
    "omni365 portal" : "Portal de omni365",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "É moi recomendábel configurar unha memoria tobo distribuída cando se use Parladoiro de omni365 xunto cunha infraestrutura de alto rendemento.",
    ...
    "Enabling the lobby will remove non-moderators from the ongoing call." : "Ao activar o ástrago, os que non son moderadores serán retirados da chamada en proceso.",
    ...
    "This will also terminate the ongoing call." : "Isto tamén rematará a chamada en proceso.",
    ...
    "Join conversations from remote omni365 servers" : "Únase a conversas desde servidores remotos de omni365",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "O esvaemento de fondo para a instancia de omni365 pódese axustar na configuración do tema.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "Parladoiro de omni365 foi actualizada, non pode comezar nin unirse a unha chamada.",
    ...
    "Recording" : "Gravando",
    "The call has been running for one hour." : "A chamada leva unha hora en proceso.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Uniuse á conversa noutra xanela ou dispositivo. Isto non é compatíbel actualmente con Parladoiro de omni365 polo que esta sesión pechouse.",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "Parladoiro de omni365 foi actualizada",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Está a tentar unirse a unha conversa mentres ten unha sesión activa noutra xanela ou dispositivo. Isto non é compatíbel  actualmente con Parladoiro de omni365. Que quere facer?",
    ...
    "omni365 is in maintenance mode." : "omni365 está en modo de mantemento.",
    "omni365 Talk Federation was updated." : "Foi actualizada a federación de Parladoiro de omni365",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Parladoiro de omni365 non é totalmente compatíbel co navegador que está a usar. Utilice a versión máis recente de Mozilla Firefox, Microsoft Edge, Google Chrome, Opera ou Apple Safari.",
    ...
    "Could not establish a connection with at least one participant. A TURN server might be needed for your scenario. Please ask your administrator to set one up following {linkstart}this documentation{linkend}." : "Non foi posíbel definir unha conexión con polo menos un participante. Pode ser necesario un servidor TURN para o seu escenario. Pídalle á administración do seu omni365 que configure un segundo {linkstart}esta documentación{linkend}.",
