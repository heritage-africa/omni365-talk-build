OC.L10N.register(
    ...
    "Talk" : "トーク",
    "Guest" : "ゲスト",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "omni365 Talkへようこそ!\nこのチャットでは、omni365 Talkで利用できる新機能について説明します。",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhook を使用してボットを実装できるようになりました。詳細については、ドキュメントを参照してください https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "There is already a trial registered for this omni365 instance." : "このomni365のインスタンスには、すでにトライアルが登録されています。",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "当社のパートナーであるStruktur AGは、ホストされたシグナリングサーバーをリクエストできるサービスを提供しています。以下のフォームに必要事項を入力するだけで、omni365がリクエストを行います。サーバーの設定が完了すると、認証情報が自動的に入力されます。これにより、既存のシグナリングサーバーの設定が上書きされます。",
    "URL of this omni365 instance" : "このomni365インスタンスのURL",
    ...
    "Join conversations from remote omni365 servers" : "リモートomni365サーバーから会話に参加する",
    ...
    "Share from {omni365}" : "{omni365} から共有する",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "omni365 インスタンスの背景のぼかしは、テーマ設定で調整できます。",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "別ウィンドウかデバイスで既に会話に参加済みです。現在、複数接続はomni365 Talkではサポートされていないため、このセッションは閉じられます。",
    "Join a conversation or start a new one" : "会話に参加または開始する",
    "omni365 URL" : "omni365 URL",
    "omni365 user" : "omni365 ユーザー",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "別ウィンドウかデバイスで既に会話に参加済みです。現在、複数接続はomni365 Talkではサポートされていません。どうしますか？",
    ...
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "お使いのブラウザーは、omni365 Talkで完全にはサポートされていません。最新バージョンのMozilla Firefox、Microsoft Edge、Google Chrome、Opera、またはApple Safariを使用してください。",
