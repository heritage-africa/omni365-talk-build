OC.L10N.register(
    ...
    "Talk" : "通话",
    "Guest" : "访客",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## 欢迎来到 omni365 通话！\n此对话将向您介绍omni365通话中的新功能",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- 支持使用 Webhook 接入机器人。详情请参考文档 https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- 引入适用于 Windows、macOS 和 Linux 的 omni365 Talk 桌面客户端：%s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- 使用 omni365 助手总结通话记录和聊天中的未读消息",
    ...
    "There is already a trial registered for this omni365 instance." : "此omni365实例已有一个已注册的trial。",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** 是安全的、自托管的通信平台，与 omni365 生态系统无缝集成。\n\n#### omni365 Talk 的主要特点：\n\n* 私聊和群聊中的聊天和消息\n* 语音和视频通话\n* 文件分享和与其他 omni365 应用的集成\n* 可定制的对话设置、审核和隐私控制\n* 网页、桌面和移动设备（iOS 和 Android）\n* 私密且安全的通信\n\n在[用户文档](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)中了解详情。",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# 欢迎使用 omni365 Talk\n\nomni365 Talk 是与 omni365 集成的私密且功能强大的消息应用。在私人或群组对话中聊天，通过语音和视频通话进行协作，组织网络研讨会和活动，定制您的对话等。",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 设置文本格式以创建丰富的消息\n\n在 omni365 Talk 中，您可以使用 Markdown 语法来格式化您的消息。例如，应用 **加粗** 或 *倾斜* 格式，或 `将文本突出显示为代码`。您甚至可以创建表格，并在文本中添加标题。\n\n需要修正拼写错误或更改格式吗？通过点击消息菜单中的“编辑消息”来编辑您的消息。",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 添加附件和链接\n\n使用“+”按钮从 omni365 Hub 附加文件。分享文件和各种 omni365 应用中的项目。一些应用甚至支持互动式微件，例如文本应用。",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ 使用智能选择器执行更多操作\n\n只需输入“/”或转到“+”菜单即可打开智能选择器，您可以在其中将各种内容附加到您的消息中。您可以配置智能选择器，使其能够从 omni365 应用、GIF、地图位置、AI 生成的内容等添加项目。",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "错误：omni365 服务器和高性能后端服务器的系统时间不同步。请确保两台服务器都连接到时间服务器或手动同步它们的时间。",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "强烈推荐在使用高性能后端运行 omni365 Talk 时配置内存缓存。",
    "Client Push" : "客户端推送",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "使用 WebRTC 进行聊天、视频和音频会议\n\n* 💬 **聊天** omni365 Talk 附带了简单的文本聊天功能，允许您从 omni365 文件应用或本地设备分享或上传文件，并提及其他参与者。\n* 👥 **私人、群组、公开和密码保护的通话！**邀请某人、整个群组或发送公开链接以邀请通话。\n* 🌐 **联合聊天** 与其他 omni365 服务器上的用户聊天\n* 💻 **屏幕共享！** 与通话参与者共享您的屏幕。\n* 🚀 **与其他 omni365 应用集成** 如文件、日历、用户状态、仪表盘、流程、地图、智能选择器、联系人、Deck 等。\n* 🌉 **与其他聊天解决方案同步** 通过将 [Matterbridge](https://github.com/42wim/matterbridge/) 集成到 Talk 中，您可以轻松地将许多其他聊天解决方法同步到 omni365 Talk，反之亦然。",
    "Leave call" : "离开通话",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "我们的合作伙伴 Struktur AG 提供了一种可以请求托管信令服务器的服务。为此，你只需要填写下面的表单，然后omni365就会请求它。一旦为你设置好服务器，凭据将被自动填写。这将覆盖现有的信令服务器设置。",
    ...
    "URL of this omni365 instance" : "此omni365实例的URL",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "您可以安装Matterbridge以将omni365通话应用连接到其他服务，请访问其{linkstart1}GitHub页面{linkend}以获得更多信息。下载并安装应用程序可能需要一段时间。如果超时，请从{linkstart2}omni365应用商店{linkend}手动安装。",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Matterbridge 二进制文件的权限不正确。请确保 Matterbridge 二进制文件由正确的用户拥有并且可以执行。它可以在“/…/omni365/apps/talk_matterbridge/bin/”中找到。",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "错误：omni365 服务器和录制后端服务器的系统时间不同步。请确保两台服务器都连接到时间服务器或手动同步它们的时间。",
    ...
    "omni365 Talk setup not complete" : "omni365 Talk 设置未完成",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "强烈推荐在使用具有高性能后端的 omni365 Talk 时设置分布式缓存。",
    ...
    "Join conversations from remote omni365 servers" : "从远程 omni365 服务器加入对话",
    ...
    "Replacement:" : "接替者：",
    "Share from {omni365}" : "从{omni365}分享",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "omni365 实例的背景模糊可以在主题设置中调整。",
    ...
    "Start call" : "开始通话",
    "End call" : "结束通话",
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk 已更新，您无法开始或加入通话。",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "你在另一个窗口或设备上加入了对话。omni365通话应用目前不支持这么做，所以这个会话被关闭了。",
    ...
    "{actor}:" : "{actor}：",
    "omni365 Talk was updated." : "omni365 Talk 已更新。",
    "(edited by you)" : "（由您编辑）",
    "(edited by a deleted user)" : "（由已删除的用户编辑）",
    "(edited by {moderator})" : "（由 {moderator} 编辑）",
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "您正在尝试加入对话，但同时在另一个窗口或设备中有活动会话。omni365通话应用目前不支持这么做。您想做什么？",
    ...
    "omni365 is in maintenance mode." : "omni365 处于维护模式。",
    "omni365 Talk Federation was updated." : "omni365 Talk Federation 已更新。",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "omni365通话应用并不完全支持你使用的浏览器。请使用最新版本的 Mozilla Firefox、Microsoft Edge、Google Chrome、Opera 或 Apple Safari 浏览器。",
