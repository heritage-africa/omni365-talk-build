OC.L10N.register(
    ...
    "There is already a trial registered for this omni365 instance." : "Ya hay un registro de prueba para esta instancia de omni365.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Nuestro socio Struktur AG ofrece un servicio donde se puede solicitar un servidor de señalización alojado. Para ello, solo necesitas completar el siguiente formulario y tu omni365 lo solicitará. Una vez que se configure el servidor para ti, las credenciales se llenarán automáticamente. Esto sobrescribirá la configuración actual del servidor de señalización.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Te uniste a la conversación en otra ventana o dispositivo. Actualmente, omni365 Talk no admite esto, por lo que esta sesión se cerró.",
    ...
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "El navegador que estás utilizando no es completamente compatible con omni365 Talk. Utiliza la última versión de Mozilla Firefox, Microsoft Edge, Google Chrome, Opera o Apple Safari.",
