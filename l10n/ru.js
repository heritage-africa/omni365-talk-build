OC.L10N.register(
    ...
    "Talk" : "Конференции",
    "Guest" : "Гость",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Добро пожаловать в приложение Конференции для omni365!\nВ этом обсуждении приведена информация о новых функциях приложения.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Теперь доступны веб-хуки для внедрения ботов. Дополнительную информацию смотрите в документации https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- «omni365 Talk» клиент для настольных ПК доступен для Windows, macOS и Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Резюме записанных вызовов и непрочитанных сообщений в чате с помощью «omni365 Assistant»",
    ...
    "There is already a trial registered for this omni365 instance." : "Для этого сервера уже предоставлен пробный период использования.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** - это безопасная коммуникационная платформа на собственном хостинге, которая легко интегрируется в экосистему omni365.\n\n#### Ключевые особенности omni365 Talk:\n\n* Чат и обмен сообщениями в личных и групповых чатах.\n* Голосовые и видео-вызовы\n* Обмен файлами и интеграция с другими приложениями omni365.\n* Настраиваемые параметры обсуждений, модерация и контроль конфиденциальности.\n* Веб-клиент, клиенты для настольных ПК и мобильных устройств (iOS и Android)\n* Частное и безопасное общение\n\nУзнайте больше в [пользовательской документации](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Добро пожаловать в omni365 Talk\n\nomni365 Talk - это приватный и мощный  мессенджер, интегрированный с omni365. Общайтесь в частных или групповых обсуждениях, сотрудничайте с помощью голосовых и видео-вызовов, организуйте вебинары и мероприятия, настраивайте свои обсуждения и многое другое.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Форматирование текста для создания ярких сообщений\n\nВ omni365 Talk вы можете использовать синтаксис Markdown для форматирования сообщений. Например, применить форматирование **жирным шрифтом** или *курсивом* или `выделить текст как код`. Вы даже можете создавать таблицы и добавлять заголовки в текст.\n\nНужно исправить опечатку или изменить форматирование? Отредактируйте свое сообщение, нажав «Редактировать сообщение» в меню сообщения.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Добавление вложений и ссылок\n\nПрикрепляйте файлы из omni365 Hub с помощью кнопки «+». Делитесь элементами из «Файлов» и других приложений omni365. Некоторые приложения даже поддерживают интерактивные виджеты, например, «Текст».",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Делайте больше с помощью Smart Picker\n\nПросто наберите «/» или перейдите в меню «+», чтобы открыть Smart Picker, где вы можете прикреплять к сообщениям различный контент. Вы можете настроить Smart Picker на добавление элементов из приложений omni365, GIF-файлов, местоположения на карте, контента, сгенерированного ИИ, и многого другого.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Ошибка: Системное время сервера omni365 и Высокопроизводительного сервера не синхронизировано. Убедитесь, что оба сервера подключены к серверу времени, или вручную синхронизируйте их время.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Настойчиво рекомендуется настроить распределенный кэш для использования omni365 Talk совместно с Высокопроизводительным сервером.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Мессенджер, видео- и аудио-конференции с использованием WebRTC\n\n* 💬 **Мессенджер** omni365 Talk предлагает простой чат для обмена сообщениями, позволяя делиться или загружать файлы из вашего приложения omni365 Files или устройства и упоминать других участников.\n* 👥 **Персональные, групповые, публичные и защищенные паролем звонки!** Пригласите человека, целую группу или отправьте публичную ссылку чтобы пригласить в вызов.\n* 🌐 **Федеративные обсуждения** Обменивайтесь сообщениями с другими пользователями omni365 на удаленном сервере\n* 💻 **Демонстрация экрана!** Делитесь своим экраном с участниками вызова.\n* 🚀 **Интеграция с другими приложениями omni365** как Файлы, Календарь, Состояние, Виджеты, Обработка файлов, Карты, Умный выбор, Контакты, Карточки, и другие.\n* 🌉 **Синхронизация с другими мессенджерами** С помощью [Matterbridge](https://github.com/42wim/matterbridge/) интегрированного в Talk, вы легко можете синхронизировать множество других мессенджеров и решений с omni365 Talk и наоборот.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Struktur AG, партнёр omni365, предоставляет возможность запросить запросить использование размещаемого сигнального сервера. Для получения доступа требуется заполнить приведённую ниже форму. После настройки сервера данные для подключения будут заполнены автоматически. Внимание: это действие перезапишет существующие параметры сигнального сервера.",
    ...
    "URL of this omni365 instance" : "URL данного сервера omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Вы можете установить Matterbridge, чтобы связать omni365 Talk с некоторыми другими сервисами. Подробную информацию можно найти на их {linkstart1}странице GitHub{linkend}. Загрузка и установка приложения может занять некоторое время. Если время ожидания истекло, установите его вручную из {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Исполняемому файлу Matterbridge назначены неверные права доступа. Убедитесь, что файлу назначен верный владелец и права на исполнение. Файл расположен в каталоге «/…/omni365/apps/talk_matterbridge/bin/».",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Ошибка: Системное время сервера omni365 и сервера записи вызовов не синхронизировано. Убедитесь, что оба сервера подключены к серверу времени, или вручную синхронизируйте их время.",
    ...
    "omni365 base URL" : "Адрес сервера omni365 (base URL)",
    ...
    "omni365 Talk setup not complete" : "Конфигурация omni365 Talk не завершена",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Настойчиво рекомендуется настроить распределенный кэш для использования omni365 Talk совместно с Высокопроизводительным сервером.",
    ...
    "Join conversations from remote omni365 servers" : "Присоединитесь к беседам на удалённых серверах omni365",
    ...
    "Replacement:" : "Замена:",
    "Share from {omni365}" : "Опубликовать из {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Размытие фона для экземпляра omni365 можно настроить в настройках темы.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk был обновлен, вы не можете начать или присоединиться к вызову.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Вы подключены к обсуждению в другом окне или устройстве. Данная возможность не поддерживается omni365 Talk в настоящее время, поэтому данная сессия будет закрыта.",
    ...
    "omni365 URL" : "Адрес сервера omni365",
    "omni365 user" : "Имя пользователя omni365",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Talk был обновлен.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Вы пытаетесь присоединиться к обсуждению, в котором уже есть активные сессии из другого окна или устройства. В данный момент данная возможность не поддерживается сервером omni365 Talk. Что вы хотите сделать?",
