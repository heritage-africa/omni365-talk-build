OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Mgeni",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Karibu kwenye omni365 Talk!\nKatika mazungumzo haya utaarifiwa kuhusu vipengele vipya vinavyopatikana katika omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhooks sasa zinapatikana kutekeleza roboti. Tazama hati kwa habari zaidi https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Tunakuletea mteja wa eneo-kazi la omni365 Talk kwa Windows, macOS na Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Fanya muhtasari wa rekodi za simu na ujumbe ambao haujasomwa kwenye gumzo na Msaidizi wa omni365",
    ...
    "There is already a trial registered for this omni365 instance." : "Tayari kuna jaribio lililosajiliwa kwa mfano huu wa omni365.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** ni jukwaa salama la mawasiliano linalojiendesha lenyewe linalounganishwa kwa urahisi na mfumo ikolojia wa omni365.\n\n#### Sifa Muhimu za omni365 Talk:\n\n* Ongea na kutuma ujumbe katika mazungumzo ya kibinafsi na ya kikundi\n* Simu za sauti na video\n* Kushiriki faili na kuunganishwa na programu zingine za omni365\n* Mipangilio ya mazungumzo inayoweza kubinafsishwa, udhibiti na udhibiti wa faragha\n* Wavuti, kompyuta ya mezani na rununu (iOS na Android)\n* Mawasiliano ya kibinafsi na salama\n\nPata maelezo zaidi katika [hati za mtumiaji](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Karibu kwenye omni365 Talk\n\nomni365 Talk ni programu ya kibinafsi na yenye nguvu ya kutuma ujumbe inayounganishwa na omni365. Piga gumzo katika mazungumzo ya faragha au ya kikundi, shirikiana kupitia simu za sauti na video, panga simu za wavuti na matukio, badilisha mazungumzo yako yakufae na mengine mengi.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Badilisha muundo wa maandishi ili kuunda ujumbe mzuri\n\nKatika omni365 Talk, unaweza kutumia sintaksia ya Markdown kuunda ujumbe wako. Kwa mfano, tumia umbizo la **bold** au *italiki*, au `angazia maandishi kama msimbo`. Unaweza kuunda majedwali na kuongeza vichwa kwenye maandishi yako.\n\nJe, unahitaji kurekebisha kosa la kuandika au kubadilisha umbizo? Hariri ujumbe wako kwa kubofya \"Hariri ujumbe\" kwenye menyu ya ujumbe.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Ongeza viambatisho na viungo\n\nAmbatisha faili kutoka kwa omni365 Hub yako kwa kutumia kitufe cha \"+\". Shiriki vipengee kutoka kwa Faili na programu mbalimbali za omni365. Baadhi ya programu hata hutumia wijeti zinazoingiliana, kwa mfano, programu ya Maandishi.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Hitilafu: Saa za mfumo za seva ya omni365 na seva ya nyuma ya utendakazi wa hali ya juu hazijasawazishwa. Tafadhali hakikisha kuwa seva zote mbili zimeunganishwa kwa seva ya saa au kusawazisha wakati wao wenyewe.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Inapendekezwa sana kusanidi akiba ya kumbukumbu wakati wa kuendesha omni365 Talk yenye utendakazi wa hali ya juu.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Piga gumzo, video na mikutano ya sauti kwa kutumia WebRTC\n\n* 💬 **Chat** omni365 Talk inakuja na soga rahisi ya maandishi, inayokuruhusu kushiriki au kupakia faili kutoka kwenye programu yako ya omni365 Files au kifaa cha karibu nawe na kutaja washiriki wengine.\n* 👥 **Simu za faragha, za kikundi, za umma na zilizolindwa na nenosiri!** Alika mtu, kikundi kizima au tuma kiungo cha umma ili kualika kwenye simu.\n* 🌐 **Mazungumzo ya Shirikisho** Piga gumzo na watumiaji wengine wa omni365 kwenye seva zao\n* 💻 **Kushiriki skrini!** Shiriki skrini yako na washiriki wa simu yako.\n* 🚀 **Muunganisho na programu zingine za omni365** kama vile Faili, Kalenda, Hali ya Mtumiaji, Dashibodi, Mtiririko, Ramani, Kiteua Mahiri, Anwani, Staha na mengine mengi.\n* 🌉 **Sawazisha na masuluhisho mengine ya gumzo** Huku [Matterbridge](https://github.com/42wim/matterbridge/) ikiunganishwa katika Talk, unaweza kusawazisha kwa urahisi masuluhisho mengine mengi ya gumzo kwenye omni365 Talk na kinyume chake.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Mshirika wetu Struktur AG hutoa huduma ambapo seva mwenyeji inaweza kuombwa. Kwa hili unahitaji tu kujaza fomu iliyo hapa chini na omni365 yako itaomba. Mara baada ya seva kusanidiwa kwa ajili yako vitambulisho vitajazwa kiotomatiki. Hii itafuta mipangilio iliyopo ya seva ya kuashiria.",
    ...
    "URL of this omni365 instance" : "URL ya mfano huu wa omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Unaweza kusakinisha Matterbridge ili kuunganisha omni365 Talk kwa huduma zingine, tembelea {linkstart1}ukurasa wao wa GitHub{linkend} kwa maelezo zaidi. Kupakua na kusakinisha programu kunaweza kuchukua muda. Ikiisha, tafadhali isakinishe wewe mwenyewe kutoka kwa {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Matterbridge binary ina ruhusa zisizo sahihi. Tafadhali hakikisha kuwa faili ya jozi ya Matterbridge inamilikiwa na mtumiaji sahihi na inaweza kutekelezwa. Inaweza kupatikana katika \"/…/omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Hitilafu: Saa za mfumo za seva ya omni365 na seva ya nyuma ya Kurekodi hazijasawazishwa. Tafadhali hakikisha kuwa seva zote mbili zimeunganishwa kwa seva ya saa au kusawazisha wakati wao wenyewe.",
    ...
    "omni365 base URL" : " URL ya omni365 base",
    ...
    "omni365 Talk setup not complete" : "Usanidi wa omni365 Talk haujakamilika",
    ...
    "omni365 portal" : "Lango la omni365",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Inapendekezwa sana kusanidi akiba iliyosambazwa unapotumia omni365 Talk yenye utendakazi wa hali ya juu.",
    ...
    "Join conversations from remote omni365 servers" : "Jiunge na mazungumzo kutoka kwa seva za mbali za omni365",
    ...
    "Share from {omni365}" : "Shirikisha kutoka {omni365}",
    ...
    "Enable blur background by default for all conversations" : "Washa mandharinyuma kwa chaguo-msingi kwa mazungumzo yote",
    "Do not show the device preview screen before joining a call" : "Usionyeshe skrini ya kukagua kifaa kabla ya kujiunga na simu",
    "Preview screen will still be shown if recording consent is required" : "Onyesho la kukagua skrini bado litaonyeshwa ikiwa kibali cha kurekodi kinahitajika ",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Ukungu wa mandharinyuma kwa mfano wa omni365 unaweza kubadilishwa katika mipangilio ya mandhari.",
    ...
    "End call" : "Kata simu",
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk ilisasishwa, huwezi kuanzisha au kujiunga na simu.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Ulijiunga kwenye mazungumzo kwenye dirisha au kifaa kingine. Hii kwa sasa haitumiki na omni365 Talk kwa hivyo kipindi hiki kilifungwa.",
    ...
    "omni365 URL" : "URL ya omni365 ",
    "omni365 user" : "Mtumiaji wa omni365 ",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Talk imesasishwa.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Unajaribu kujiunga na mazungumzo huku kipindi kinachoendelea kwenye dirisha au kifaa kingine. Hii kwa sasa haitumiki na omni365 Talk. Unataka kufanya nini?",
    ...
    "omni365 is in maintenance mode." : "omni365 iko katika hali ya matengenezo.",
    "omni365 Talk Federation was updated." : "omni365 Talk Federation imesasishwa.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Kivinjari unachotumia hakitumiki kikamilifu na omni365 Talk. Tafadhali tumia toleo jipya zaidi la Mozilla Firefox, Microsoft Edge, Google Chrome, Opera au Apple Safari.",
