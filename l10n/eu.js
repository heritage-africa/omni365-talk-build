OC.L10N.register(
    ...
    "Talk" : "Hizketaldia",
    "Guest" : "Gonbidatua",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Ongi etorri omni365 Talk-era!\nElkarrizketa honetan ezaugarri berrien berri emango zaizu.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhook-ak eskuragarri daude orain bot-ak ezartzeko. Ikusi dokumentazioa informazio gehiagorako https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "There is already a trial registered for this omni365 instance." : "Dagoeneko badago proba bat erregistratuta omni365 instantzia honetatik.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Gure kide Struktur AG-ek eskaintzen duen zerbitzuaren baitan, ostataturiko seinalizazio zerbitzaria eska daiteke. Horretarako, beheko inprimakia betetzea besterik ez duzu eta zure omni365ak eskaera egingo du. Zerbitzaria konfiguratzen denean kredentzialak automatikoki beteko dira. Honek uneko seinalizazio zerbitzariaren ezarpenak gainidatziko ditu.",
    "URL of this omni365 instance" : "omni365 instantzia honen URLa",
    ...
    "Share from {omni365}" : "Partekatu {omni365} bidez",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Nextloud instantziako atzeko planoaren lausotzea gai ezarpenetan doitu daiteke.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Elkarrizketara batu zara beste leiho edo gailu batean. omni365 Talkek ez du hau onartzen une honetan, beraz saioa itxi egin da.",
    "Join a conversation or start a new one" : "Batu elkarrizketa batera edo hasi berri bat",
    "omni365 URL" : "omni365 URLa",
    "omni365 user" : "omni365 erabiltzailea",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Elkarrizketa batera batu nahi duzu aldi berean saioa aktibaturik beste leiho edo gailu batean. omni365 Talkek ez du hau onartzen une honetan. Zer egin nahi duzu?",
    ...
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "omni365 Talkek ez dauka erabateko euskarria erabiltzen ari zaren nabigatzailearentzat. Erabili Mozilla Firefox, Microsoft Edge, Google Chrome, Opera edo Apple Safari nabigatzaileen bertsio berriena.",
