OC.L10N.register(
    ...
    "Talk" : "پاراڭ",
    "Guest" : "مېھمان",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## omni365 سۆھبىتىگە خۇش كەپسىز!\nبۇ سۆھبەتتە سىزگە omni365 Talk دىكى يېڭى ئىقتىدارلار ھەققىدە ئۇچۇر بېرىلىدۇ.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhooks ھازىر bots نى يولغا قويالايدۇ. تېخىمۇ كۆپ ئۇچۇرغا ئېرىشمەكچى بولسىڭىز https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "There is already a trial registered for this omni365 instance." : "بۇ omni365 مىسالى ئۈچۈن ئاللىبۇرۇن سىناق قىلىنغان.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "omni365 Talk نى يۇقىرى ئىقتىدارلىق ئارقا سۇپىدا ئىجرا قىلغاندا ئىچكى ساقلىغۇچنى تەڭشەش تەۋسىيە قىلىنىدۇ.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "WebRTC ئارقىلىق پاراڭلىشىش ، سىن ۋە ئاۋازلىق يىغىن\n\n.\n* 👥 ** شەخسىي ، گۇرۇپپا ، ئاممىۋى ۋە مەخپىي نومۇر قوغدىلىدىغان تېلېفونلار! ** باشقىلارنى ، پۈتۈن گۇرۇپپىنى تەكلىپ قىلىڭ ياكى ئاممىۋى ئۇلىنىش ئەۋەتىپ تېلېفون قىلىڭ.\n* 🌐 ** فېدېراتسىيە پاراڭلىرى ** مۇلازىمېتىردىكى omni365 ئىشلەتكۈچىلىرى بىلەن پاراڭلىشىڭ\n* 💻 ** ئېكران ھەمبەھىرلەش! ** تېلېفونىڭىزنى قاتناشقۇچىلار بىلەن ئورتاقلىشىڭ.\n* 🚀 ** باشقا omni365 ئەپلىرى بىلەن بىرلەشتۈرۈش ** ھۆججەتلەر ، كالېندار ، ئىشلەتكۈچى ھالىتى ، باش تاختا ، ئاقما ، خەرىتە ، ئەقلىي ئىقتىدارلىق تاللىغۇچ ، ئالاقىلىشىش ، پالۋان ۋە باشقىلار.\n* 🌉 ** باشقا پاراڭلىشىش ھەل قىلىش ئۇسۇللىرى بىلەن ماسقەدەملەڭ ** [Matterbridge] (https://github.com/42wim/matterbridge/) بىلەن سۆھبەتكە بىرلەشتۈرۈلگەندىن كېيىن ، omni365 Talk ۋە باشقا نۇرغۇن پاراڭلىشىش ھەل قىلىش ئۇسۇللىرىنى ئاسانلا ماسقەدەملىيەلەيسىز. ئەكسىچە.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "بىزنىڭ ھەمراھىمىز Struktur AG ساھىبخانلىق سىگنال مۇلازىمىتى تەلەپ قىلىدىغان مۇلازىمەت بىلەن تەمىنلەيدۇ. بۇنىڭ ئۈچۈن پەقەت تۆۋەندىكى جەدۋەلنى تولدۇرۇشىڭىز كېرەك ، omni365 تەلەپ قىلىدۇ. مۇلازىمېتىر سىزگە تەڭشەلگەندىن كېيىن كىنىشكا ئاپتوماتىك تولدۇرۇلىدۇ. بۇ مەۋجۇت سىگنال مۇلازىمېتىر تەڭشىكىنى قاپلىۋېتىدۇ.",
    "URL of this omni365 instance" : "بۇ omni365 مىسالىنىڭ URL",
    ...
    "Join conversations from remote omni365 servers" : "يىراقتىكى omni365 مۇلازىمېتىرلىرىدىكى سۆھبەتكە قاتنىشىڭ",
    ...
    "Share from {omni365}" : "{omni365} from دىن ئورتاقلىشىش",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "omni365 مىسالىنىڭ ئارقا سۇپىسىنى باشتېما تەڭشىكىدە تەڭشىگىلى بولىدۇ.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "سىز باشقا كۆزنەك ياكى ئۈسكۈنىدە سۆھبەتكە قاتناشتىڭىز. بۇنى omni365 Talk قوللىمايدۇ ، شۇڭا بۇ يىغىن يېپىلدى.",
    ...
    "omni365 user" : "omni365 ئىشلەتكۈچى",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "سىز باشقا كۆزنەك ياكى ئۈسكۈنىدە ئاكتىپ يىغىن ئاچقاندا سۆھبەتكە قاتناشماقچى بولۇۋاتىسىز. بۇنى omni365 Talk قوللىمايدۇ. نېمە قىلماقچى؟",
