OC.L10N.register(
    ...
    "Talk" : "Converses",
    "Guest" : "Convidat",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "Benvingut a omni365 Parla!\n\nEn aquesta conversa se us informarà sobre les noves característiques a Parla.",
    ...
    "- With projects you can create quick links between conversations, files and other items" : "- Amb els projectes podeu crear ràpidament enllaços entre converses, fitxers i altres elements a omni365",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Ara hi ha webhooks disponibles per implementar bots. Consulteu la documentació per obtenir més informació https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Presentació del client d'escriptori omni365 Converses per a Windows, macOS i Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Resumiu els enregistraments de trucades i missatges no llegits als xats amb l'Assistent de omni365",
    ...
    "There is already a trial registered for this omni365 instance." : "Ja hi ha una prova registrada per a aquesta instància omni365.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Converses** és una plataforma de comunicació segura i autoallotjada que s'integra perfectament amb l'ecosistema omni365.\n\n#### Característiques clau de omni365 Converses:\n\n* Xateja i missatgeria en xats privats i de grup\n* Trucades de veu i videotrucades\n* Compartició de fitxers i integració amb altres aplicacions de omni365\n* Configuració de conversa personalitzable, moderació i controls de privadesa\n* Web, escriptori i mòbil (iOS i Android)\n* Comunicació privada i segura\n\n Més informació a la [documentació de l'usuari](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Benvingut a omni365 Converses\n\nomni365 Converses és una aplicació de missatgeria privada i potent que s'integra amb omni365. Xateja en converses privades o en grup, col·labora mitjançant trucades de veu i videotrucades, organitza seminaris web i esdeveniments, personalitza les teves converses i molt més.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formateu textos per crear missatges rics\n\nA omni365 Converses, podeu utilitzar la sintaxi de Markdown per formatar els vostres missatges. Per exemple, apliqueu el format **negreta** o *cursiva*, o bé \"ressalteu textos com a codi\". Fins i tot podeu crear taules i afegir encapçalaments al vostre text.\n\nNecessites corregir una errada ortogràfica o canviar el format? Editeu el vostre missatge fent clic a \"Edita missatge\" al menú de missatges.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Afegeix fitxers adjunts i enllaços\n\nAdjunteu fitxers del vostre omni365 Hub mitjançant el botó \"+\". Comparteix elements de Files i de diverses aplicacions de omni365. Algunes aplicacions fins i tot admeten ginys interactius, per exemple, l'aplicació Text.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Fes més amb Smart Picker\n\nSimplement escriviu \"/\" o aneu al menú \"+\" per obrir el selector intel·ligent on podeu adjuntar diversos continguts als vostres missatges. Podeu configurar el selector intel·ligent per poder afegir elements d'aplicacions omni365, GIF, ubicacions de mapes, contingut generat per IA i molt més.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "És molt recomanable configurar una memòria cau quan executeu omni365 Converses amb un rerefons d'alt rendiment.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Xat, vídeo i àudio-conferència mitjançant WebRTC\n\n* 💬 **Xat** omni365 Converses inclou un xat de text senzill, que us permet compartir o carregar fitxers des de la vostra aplicació omni365 Fitxers o dispositiu local i esmentar altres participants.\n* 👥 **Trucades privades, de grup, públiques i protegides amb contrasenya!** Convida algú, un grup sencer o envia un enllaç públic per convidar a una trucada.\n* 🌐 **Xats federats** Xateja amb altres usuaris de omni365 als seus servidors\n* 💻 **Compartició de pantalla!** Comparteix la teva pantalla amb els participants de la trucada.\n* 🚀 **Integració amb altres aplicacions de omni365** com Fitxers, Calendari, Estat de l'usuari, Tauler, Flow, Maps, Selector intel·ligent, Contactes, Targetes i molts més.\n* 🌉 **Sincronització amb altres solucions de xat** Amb [Matterbridge](https://github.com/42wim/matterbridge/) integrat a Converses, podeu sincronitzar fàcilment moltes altres solucions de xat amb omni365 Converses i viceversa.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "El nostre soci Struktur AG ofereix un servei on es pot sol·licitar un servidor de senyalització allotjat. Per a això només has d'omplir el següent formulari i el teu omni365 ho sol·licitarà. Un cop configurat el servidor, les credencials s'ompliran automàticament. Això sobreescriurà els paràmetres del servidor de senyalització existent.",
    "URL of this omni365 instance" : "URL d'aquesta instància de omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Podeu instal·lar Matterbridge per enllaçar omni365 Talk amb altres serveis, visiteu la seva {linkstart1}pàgina de GitHub{linkend} per obtenir més informació. Descarregar i instal·lar l'aplicació pot trigar una estona. En cas que s'acabi, instal·leu-lo manualment des de la {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "El binari de Matterbridge té permisos incorrectes. Assegureu-vos que el fitxer binari Matterbridge és propietat de l'usuari correcte i es pot executar. Es pot trobar a \"/.../omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Error: els temps del sistema del servidor omni365 i el servidor de fons de gravació no estan sincronitzats. Assegureu-vos que tots dos servidors estiguin connectats a un servidor d'hora o sincronitzeu manualment la seva hora.",
    ...
    "omni365 Talk setup not complete" : "La configuració de omni365 Converses no s'ha completat",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "És molt recomanable configurar una memòria cau distribuïda quan utilitzeu omni365 Talk amb un rerefons d'alt rendiment.",
    ...
    "Join conversations from remote omni365 servers" : "Uniu-vos a converses des de servidors remots de omni365",
    ...
    "Share from {omni365}" : "Comparteix des de {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "El desenfocament de fons per a la instància de omni365 es pot ajustar a la configuració de la temàtica.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Converses s'ha actualitzat, no pots iniciar ni unir-te a una trucada.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "S’ha unit a la conversa en una altra finestra o dispositiu. Actualment no és compatible amb omni365 Talk, de manera que aquesta sessió s'ha tancat.",
    ...
    "omni365 URL" : "omni365 URL",
    "omni365 user" : "Usuari omni365",
    ...
    "omni365 Talk was updated." : "omni365 Talk s'ha actualitzat.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Esteu intentant unir-vos a una conversa mentre teniu una sessió activa en una altra finestra o dispositiu. Això actualment no és compatible amb omni365 Talk. Què voleu fer?",
    ...
    "omni365 is in maintenance mode." : "omni365 està en mode de manteniment.",
    "omni365 Talk Federation was updated." : "omni365 Converses Federació s'ha actualitzat.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "El navegador que utilitzeu no és totalment compatible amb omni365 Talk. Feu servir la darrera versió de Mozilla Firefox, Microsoft Edge, Google Chrome, Opera o Apple Safari.",
