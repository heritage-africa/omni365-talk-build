OC.L10N.register(
    ...
    "There is already a trial registered for this omni365 instance." : "Вече има регистрирано изпробване за този екземпляр на omni365.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Нашият партньор Struktur AG предоставя услуга, при която може да бъде заявен хостван сървър за сигнализация. За това трябва само да попълните формуляра по-долу и вашият omni365 ще го заяви След като сървърът е настроен за вас, вашите идентификационни данни ще бъдат попълнени автоматично. Това ще презапише съществуващите настройки на сървъра за сигнализация.",
    "URL of this omni365 instance" : "URL на този екземпляр на omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Можете да инсталирате Matterbridge, за да свържете omni365 Talk с някои други услуги, посетете тяхната {linkstart1}страница на GitHub{linkend} за повече подробности. Изтеглянето и инсталирането на приложението може да отнеме известно време. В случай, че то изтече, моля, инсталирайте го ръчно от {linkstart2}omni365 App Store{linkend}.",
    ...
    "Share from {omni365}" : "Споделяне от {omni365}",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Присъединихте се към разговора в друг прозорец или устройство. Това в момента не се поддържа от omni365 Talk, така че тази сесия беше затворена.",
    "Join a conversation or start a new one" : "Присъединяване към разговор или започване на нов",
    "omni365 URL" : "URL адрес на omni365",
    "omni365 user" : "Потребител на omni365",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Опитвате се да се присъедините към разговор, докато имате активна сесия в друг прозорец или устройство. Това в момента не се поддържа от omni365 Talk. Какво искате да направите?",
