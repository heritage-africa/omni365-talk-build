OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Госць",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Вітаем у omni365 Talk!\nУ гэтай размове вы даведаецеся пра новыя функцыі, даступныя ў omni365 Talk.",
    ...
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Вітаем у omni365 Talk\n\nomni365 Talk — гэта прыватны і магутны месенджар, які інтэгруецца з omni365. Удзельнічайце ў прыватных або супольных размовах, супрацоўнічайце праз галасавыя і відэазванкі, арганізуйце вэбінары і мерапрыемствы, наладжвайце свае размовы і многае іншае.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Чат, відэа- і аўдыяканферэнцыі з выкарыстаннем WebRTC\n\n* 💬 **Чат** omni365 Talk - гэта просты тэкставы чат, які дазваляе вам абагульваць або запампоўваць файлы з праграмы Файлы omni365 або лакальнай прылады і згадваць іншых удзельнікаў..\n* 👥 **Прыватныя, супольныя, публічныя і абароненыя паролем выклікі!** Запрашайце каго-небудзь, усю групу або адпраўляйце публічную спасылку, каб запрасіць на выклік.\n* 🌐 **Федэратыўныя чаты** Чат з іншымі карыстальнікамі omni365 на іх серверах\n* 💻 **Абагульванне экрана!** Паказвайце свой экран удзельнікам выкліку.\n* 🚀 **Інтэграцыя з іншымі праграмамі omni365**, такімі як Файлы, Каляндар, Статус карыстальніка, Панэль кіравання, Flow, Карты, Smart picker, Кантакты, Карткі, і многімі іншымі.\n* 🌉 **Сінхранізацыя з іншымі месенджарамі** Дзякуючы інтэграцыі [Matterbridge](https://github.com/42wim/matterbridge/) у Talk, вы можаце лёгка сінхранізаваць мноства іншых месенджараў з omni365 Talk і наадварот.",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Вы можаце ўсталяваць Matterbridge, каб звязаць omni365 Talk з некаторымі іншымі сэрвісамі. Наведайце іх {linkstart1}старонку на GitHub{linkend} для больш падрабязнай інфармацыі. Загрузка і ўсталяванне праграмы можа заняць некаторы час. У выпадку перавышэння часу чакання усталюйце яго ўручную з {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Бінарны файл Matterbridge мае няправільныя правы доступу. Пераканайцеся, што бінарны файл Matterbridge належыць патрэбнаму карыстальніку і можа быць выкананы. Яго можна знайсці ў \"/…/omni365/apps/talk_matterbridge/bin/\".",
    ...
    "omni365 Talk setup not complete" : "Наладка omni365 Talk не завершана",
    "omni365 portal" : "Партал omni365",
    ...
    "Join conversations from remote omni365 servers" : "Далучайцеся да размоў з аддаленых сервераў omni365",
    ...
    "Replacement:" : "Замена:",
    "Share from {omni365}" : "Абагульванне з {omni365}",
    ...
    "Preview screen will still be shown if recording consent is required" : "Экран перадпрагляду будзе паказвацца, нават калі патрабуецца згода на запіс",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Размытасць фону для экзэмпляра omni365 можна дапасаваць у наладах тэмы.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk абноўлена, вы не можаце пачаць або далучыцца да выкліку.",
    ...
    "omni365 URL" : "URL-адрас omni365",
    "omni365 user" : "Карыстальнік omni365",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Talk была абноўлена.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Вы спрабуеце далучыцца да размовы, маючы актыўны сеанс у іншым акне або на іншай прыладзе. omni365 Talk пакуль што не падтрымлівае такі сцэнарый. Што вы хочаце зрабіць?",
