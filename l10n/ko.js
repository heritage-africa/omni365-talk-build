OC.L10N.register(
    ...
    "Talk" : "토크",
    "Guest" : "손님",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## omni365 토크에 오신 것을 환영합니다.\n이 대화에서  omni365 토크에서 사용 가능한 새 기능들에 대해 알아볼 수 있습니다.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- 웹훅을 통해 봇을 사용할 수 있습니다. 자세한 정보는 문서를 참조하십시오. https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "There is already a trial registered for this omni365 instance." : "이 omni365 인스턴스에 대한 평가판이 이미 등록되어 있습니다.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "당사의 파트너 Struktur AG는 호스팅된 시그널링 서버를 요청할 수 있는 서비스를 제공합니다. 이 경우 아래 양식만 작성하면 omni365에서 요청하게 됩니다. 서버가 설정되면 인증 정보가 자동으로 채워집니다. 기존 신호 시그널링 설정을 덮어씁니다.",
    "URL of this omni365 instance" : "이 omni365 인스턴스의 URL",
    ...
    "Share from {omni365}" : "{omni365}에서 공유",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "다른 창이나 기기에서 대화에 참가했습니다. 이 기능은 현재 omni365 토크에서 지원되지 않으며, 현재 세션은 종료됩니다.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "다른 창이나 기기에서 세션이 작동 중일 때 대화에 참가하려고 합니다. 이 기능은 현재 omni365 토크에서 지원되지 않습니다. 어떻게 할까요?",
    ...
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "사용 중인 브라우저는 omni365 토크에서 완전히 지원되지 않습니다. 최신 버전의 Mozilla Firefox, Microsoft Edge, Google Chrome, Opera 또는 Apple Safari를 사용하세요.",
    ...
    "The configured signaling server needs to be updated to be compatible with this version of Talk. Please contact your administration." : "시그널링 서버가 이 버전의 omni365와 호환되도록 업데이트 해야 합니다. 관리자에게 연락해주세요.",
