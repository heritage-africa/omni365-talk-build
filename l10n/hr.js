OC.L10N.register(
    ...
    "There is already a trial registered for this omni365 instance." : "Za ovu instancu omni365a već postoji registriran probni račun.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Naš partner Struktur AG pruža uslugu putem koje možete zatražiti signalni poslužitelj. Trebate ispuniti obrazac u nastavku i vaš će omni365 zatražiti signalni poslužitelj. Vjerodajnice se automatski popunjavaju nakon postavljanja poslužitelja. Time ćete prebrisati postavke postojećeg signalnog poslužitelja.",
    "URL of this omni365 instance" : "URL ove instance omni365a",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Pridružili ste se razgovoru u drugom prozoru ili na drugom uređaju. omni365 Talk trenutačno ne podržava tu radnju pa je ova sesija zatvorena.",
    "Join a conversation or start a new one" : "Pridružite se razgovoru ili započnite novi",
    "omni365 URL" : "omni365 URL",
    "omni365 user" : "omni365 korisnik",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Pokušavate se pridružiti razgovoru dok imate otvorenu sesiju u drugom prozoru ili na drugom uređaju. omni365 Talk trenutačno ne podržava tu radnju. Što želite učiniti?",
