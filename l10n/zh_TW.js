OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "訪客",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## 歡迎使用 omni365 Talk！\n在此對話中，您將了解關於 omni365 Talk 中提供的新功能。 ",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- 引入適用於 Windows、macOS 與 Linux 的 omni365 Talk 桌面客戶端：%s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- 使用 omni365 小幫手總結通話錄音與聊天中的未讀訊息",
    ...
    "There is already a trial registered for this omni365 instance." : "此 omni365 站台已有一個試用註冊。",
    ...
    "Your web server is not properly set up to deliver `.wasm` files. This is typically an issue with the Nginx configuration. For background blur it needs an adjustment to also deliver `.wasm` files. Compare your Nginx configuration to the recommended configuration in our documentation." : "您的伺服器並未正確的設定，因此無法傳遞 `.wasm` 的檔案。這通常是因為 Nginx 的設定問題所導致。對於背景模糊來說，需要一些調整才能一併傳遞 `.wasm` 的檔案。請檢查您的 Nginx 設定，和 omni365 說明文件中提到的建議設定。",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "錯誤：omni365 伺服器與高效能後端伺服器的系統時間不同步。請確保兩個伺服器都連線到校時伺服器，或手動同步它們的時間。",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "使用 WebRTC 的聊天、視訊語音訊會議\n\n* 💬 **聊天** omni365 Talk 包含簡單的文字聊天，讓您可以從 omni365 檔案應用程式或本機裝置分享或上傳檔案，並提及其他參與者。\n* 👥 **私人、群組、公開與密碼保護通話！** 邀請某人、整個群組或是傳送公開連結來邀請通話\n* 🌐 **聯盟式通話** 與其他伺服器上的 omni365 使用者聊天\n* 💻 **畫面分享！** 與您通話的參與者分享畫面。\n* 🚀 **與其他 omni365 應用程式整合** 如檔案、日曆、使用者狀態、儀表板、流程、地圖、智慧型挑選程式、通訊錄、Deck 與更多其他應用程式。\n* 🌉 **與其他聊天解決方案同步** 使用整合到 Talk 中的 [Matterbridge](https://github.com/42wim/matterbridge/)，您可以輕鬆地將其他許多聊天解決方案同步到 omni365 Talk，反之亦然。",
    "Leave call" : "離開通話",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "我們的合作夥伴 Struktur AG 提供訊號伺服器的託管服務。您只需要填寫下面的表單，您的 omni365 就會為您申請該服務。為您設定伺服器後，將自動填寫憑證。這將覆蓋現有的訊號伺服器設定。",
    ...
    "URL of this omni365 instance" : "此 omni365 站台的 URL",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "您可以安裝 Matterbridge 以將 omni365 Talk 連結至其他服務，請造訪其 {linkstart1}GitHub 頁面{linkend}以取得更多資訊。下載並安裝應用程式可能需要一段時間。若逾時，請從 {linkstart2}omni365 應用程式商店{linkend}手動安裝。",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Matterbridge 可執行檔的權限不正確。請確保 Matterbridge 可執行檔為正確的使用者所擁有且可執行。可以在「/…/omni365/apps/talk_matterbridge/bin/」中找到。",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "錯誤：omni365 伺服器與 Recording 後端伺服器的系統時間不同步。請確保兩個伺服器都連線到校時伺服器，或手動同步它們的時間。",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "omni365 站台的背景模糊可以在佈景主題設定中調整。",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "您在其他視窗或裝置上加入了對話。omni365 Talk 目前不支援這麼做，因此此工作階段被關閉了。",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "您正在嘗試加入對話，但在其他視窗或裝置中有作用中的工作階段。omni365 Talk 目前不支援這麼做。您想要做什麼？",
    ...
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "omni365 Talk 不完全支援您使用的瀏覽器。請使用最新版本的 Mozilla Firefox、Microsoft Edge、Google Chrome、Opera 或 Apple Safari。",
