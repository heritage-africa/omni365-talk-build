OC.L10N.register(
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhooks agora estão disponíveis para implementar bots. Consulte a documentação para obter mais informações https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Apresentando o cliente de desktop omni365 Talk para Windows, macOS e Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Resuma gravações de chamadas e mensagens não lidas em bate-papos com o Assistente omni365",
    ...
    "{actor} unlocked the conversation" : "{actor} destrancou a conversa",
    "You unlocked the conversation" : "Você destrancou a conversa",
    "An administrator unlocked the conversation" : "Um administrador destrancou a conversa",
    "{actor} locked the conversation" : "{actor} trancou a conversa",
    "You locked the conversation" : "Você trancou a conversa",
    "An administrator locked the conversation" : "Um administrador trancou a conversa",
    ...
    "{actor} created thread {title}" : "{actor} criou o fio {title}",
    "You created thread {title}" : "Você criou o fio {title}",
    "{actor} renamed thread {title}" : "{actor} renomeou o fio {title}",
    "You renamed thread {title}" : "Você renomeou o fio {title}",
    ...
    "There is already a trial registered for this omni365 instance." : "Já existe uma avaliação registrada para esta instância do omni365.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** é uma plataforma de comunicação segura e auto-hospedada que se integra perfeitamente ao ecossistema omni365.\n\n#### Principais Recursos do omni365 Talk:\n\n* Bate-papo e mensagens em bate-papos privados e em grupo\n* Chamadas de voz e vídeo\n* Compartilhamento de arquivos e integração com outros aplicativos omni365\n* Configurações de conversa personalizáveis, moderação e controles de privacidade\n* Web, desktop e celular (iOS e Android)\n* Comunicação privada & segura\n\nSaiba mais na [documentação do usuário](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Bem-vindo ao omni365 Talk\n\nomni365 Talk é um aplicativo de mensagens privado e poderoso que se integra ao omni365. Converse em conversas privadas ou em grupo, colabore em chamadas de voz e vídeo, organize webinars e eventos, personalize suas conversas e muito mais.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formatar textos para criar mensagens ricas\n\nNo omni365 Talk, você pode usar a sintaxe Markdown para formatar suas mensagens. Por exemplo, aplique a formatação **negrito** ou *itálico*, ou `destaque textos como código`. Você pode até mesmo criar tabelas e adicionar cabeçalhos ao seu texto.\n\nPrecisa corrigir um erro de digitação ou alterar a formatação? Edite sua mensagem clicando em \"Editar mensagem\" no menu de mensagens.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Adicionar anexos e links\n\nAnexe arquivos do seu omni365 Hub usando o botão \"+\". Compartilhe itens de Arquivos e de vários aplicativos do omni365. Alguns aplicativos até suportam widgets interativos, por exemplo, o aplicativo Texto.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Faça mais com o Seletor Inteligente\n\nBasta digitar \"/\" ou acessar o menu \"+\" para abrir o Seletor Inteligente, onde você pode anexar vários conteúdos às suas mensagens. Você pode configurar o Seletor Inteligente para poder adicionar itens de aplicativos omni365, GIFs, localizações de mapas, conteúdo gerado por IA e muito mais.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "É altamente recomendável configurar um cache de memória ao executar omni365 Talk com back-end de alto desempenho.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Bate-papo, vídeo & audioconferência usando WebRTC\n\n* 💬 **Bate-papo** omni365 Talk vem com um bate-papo de texto simples, permitindo que você compartilhe ou carregue arquivos de seu aplicativo omni365 Arquivos ou dispositivo local e mencione outros participantes.\n* 👥 **Chamadas privadas, em grupo, públicas e protegidas por senha!** Convide alguém, um grupo inteiro ou envie um link público para convidar para uma chamada.\n* 🌐 **Bate-papos federados** Converse com outros usuários do omni365 nos servidores deles\n* 💻 **Compartilhamento de tela!** Compartilhe sua tela com os participantes da sua chamada.\n* 🚀 **Integração com outros aplicativos omni365** como Arquivos, Calendário, Status do usuário, Painel, Fluxo, Mapas, Seletor Inteligente, Contatos, Deck e muitos mais.\n* 🌉 **Sincronização com outras soluções de bate-papo** Com a integração do [Matterbridge](https://github.com/42wim/matterbridge/) no Talk, você pode sincronizar facilmente muitas outras soluções de bate-papo com o omni365 Talk e vice-versa.",
    "Leave call" : "Sair da chamada",
    "Navigating away from the page will leave the call in {conversation}" : "Se você sair da página, sairá da ligação com {conversation}",
    ...
    "Locked for moderators" : "Trancado para moderadores",
    "Enabled" : "Ativado",
    "Disabled" : "Desativado",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Nosso parceiro Struktur AG fornece um serviço no qual um servidor de sinalização hospedado pode ser solicitado. Para isso, você só precisa preencher o formulário abaixo e seu omni365 solicitará. Depois que o servidor estiver configurado para você, as credenciais serão preenchidas automaticamente. Isso substituirá as configurações existentes do servidor de sinalização.",
    "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly." : "Se sua conta do back-end de alto desempenho incluir a funcionalidade STUN e/ou TURN, as configurações serão atualizadas de acordo.",
    "URL of this omni365 instance" : "URL desta instância omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Você pode instalar o Matterbridge para vincular o omni365 Talk a alguns outros serviços, visite a {linkstart1}página do GitHub{linkend} para obter mais detalhes. Baixar e instalar o aplicativo pode demorar um pouco. Caso expire, instale-o manualmente a partir da {linkstart2}Loja de Aplicativos do omni365{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "O binário do Matterbridge tem permissões incorretas. Verifique se o arquivo binário do Matterbridge é de propriedade do usuário correto e se pode ser executado. Ele pode ser encontrado em \"/.../omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Erro: Os horários do sistema do servidor omni365 e do servidor de back-end de gravação estão fora de sincronia. Por favor, certifique-se de que ambos os servidores estejam conectados a um servidor de horário ou sincronize manualmente o horário deles.",
    ...
    "Do not show SIP Dial-out caller number" : "Não mostrar o número de discagem SIP",
    "Anonymous number should appear as \"unknown\" or \"withheld number\" to call recipient" : "O número anônimo deve aparecer como \"desconhecido\" ou \"número restrito\" para o destinatário da chamada.",
    "Dial-out number" : "Número de discagem",
    "E164 formatted number used as a fallback caller number for outgoing calls" : "Número no formato E164 usado como número de retorno de chamada para chamadas efetuadas",
    "Dial-out prefix" : "Prefixo de discagem",
    "Prefix to configured user number for outgoing calls (default is `+`)" : "Prefixo para o número de usuário configurado para chamadas efetuadas (o padrão é `+`)",
    ...
    "omni365 base URL" : "URL base do omni365",
    ...
    "omni365 Talk setup not complete" : "A configuração do omni365 Talk não foi concluída",
    ...
    "omni365 portal" : "Portal do omni365",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "É altamente recomendável configurar um cache distribuído ao usar o omni365 Talk com um back-end de alto desempenho.",
    ...
    "Done" : "Concluído",
    "Enable live transcription" : "Ativar transcrição ao vivo",
    "Disable live transcription" : "Desativar transcrição ao vivo",
    ...
    "Error when trying to load the available live transcription languages" : "Erro ao carregar os idiomas disponíveis para transcrição ao vivo",
    "Failed to enable live transcription" : "Erro ao ativar a transcrição ao vivo",
    ...
    "Select a video device" : "Selecione um dispositivo de vídeo",
    ...
    "Set language spoken in calls" : "Definir idioma falado nas chamadas",
    "Languages could not be loaded" : "Não foi possível carregar os idiomas",
    "Loading languages …" : "Carregando idiomas …",
    "Invalid language" : "Idioma inválido",
    "Default language (English)" : "Idioma padrão (inglês)",
    "Default live transcription language set" : "Idioma padrão definido para transcrição ao vivo",
    "Live transcription language set: {languageName}" : "Idioma definido para transcrição ao vivo: {languageName}",
    "Error when trying to set live transcription language" : "Erro ao definir o idioma para transcrição ao vivo",
    ...
    "Error occurred when locking the conversation" : "Ocorreu um erro ao trancar a conversa",
    "Error occurred when unlocking the conversation" : "Ocorreu um erro ao destrancar a conversa",
    "Lock conversation" : "Trancar conversa",
    "This will also terminate the ongoing call." : "Isso também encerrará a chamada em andamento. ",
    "Lock the conversation to prevent anyone to post messages or start calls" : "Tranque a conversa para impedir que alguém poste mensagens ou inicie chamadas",
    "Edit" : "Editar",
    ...
    "Schedule meetings" : "Agendar reuniões",
    "You don't have any upcoming meetings" : "Você não tem nenhuma reunião em breve.",
    "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here" : "Agende uma reunião a partir do seu calendário. Uma conversa no Talk precisa ser definida como local para aparecer aqui.",
    "Open calendar" : "Abrir calendário",
    "Unread mentions" : "Menções não lidas",
    "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name" : "As mensagens em que você foi mencionado aparecerão aqui. Você pode mencionar pessoas digitando @ seguido do nome delas.",
    "Upcoming reminders" : "Próximos lembretes",
    "Message reminders" : "Lembretes de mensagens",
    "Set a reminder on a message to be notified" : "Defina um lembrete em uma mensagem para ser notificado",
    ...
    "Join conversations from remote omni365 servers" : "Entre em conversas de servidores omni365 remotos",
    "From {user} at {remoteServer}" : "De {user} em {remoteServer}",
    ...
    "Mentions" : "Menções",
    "Meetings" : "Reuniões",
    "No followed threads" : "Sem fios seguidos",
    ...
    "Subscribe to an existing thread or start your own." : "Assine um fio já existente ou inicie o seu próprio.",
    ...
    "Notify all participants about this call" : "Notificar todos os participantes sobre esta chamada",
    ...
    "Share from {omni365}" : "Compartilhar de {omni365}",
    ...
    "Thread notifications" : "Notificações de fios",
    ...
    "Display name (required)" : "Nome de exibição (obrigatório)",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "O desfoque de fundo para a instância omni365 pode ser ajustado nas configurações do tema.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "O omni365 Talk foi atualizado, você não pode iniciar ou entrar em uma chamada.",
    ...
    "Select virtual background" : "Selecionar fundo virtual",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Você ingressou na conversa em outra janela ou dispositivo. No momento, isso não é suportado pelo omni365 Talk e portanto esta sessão foi encerrada.",
    ...
    "omni365 URL" : "URL omni365",
    "omni365 user" : "Usuário omni365",
    ...
    "Default" : "Padrão",
    "Follow conversation settings" : "Seguir as configurações da conversa",
    "Group" : "Grupo",
    "Team" : "Equipe",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "O omni365 Talk foi atualizado.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Você está tentando ingressar em uma conversa enquanto realiza uma sessão ativa em outra janela ou dispositivo. No momento, isso não é suportado pelo omni365 Talk. O que você deseja fazer?",
    ...
    "omni365 is in maintenance mode." : "O omni365 está em modo de manutenção.",
    "omni365 Talk Federation was updated." : "O omni365 Talk Federation foi atualizado.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "O navegador que você está usando não possui suporte completo pelo omni365 Talk. Use a última versão do Mozilla Firefox, Microsoft Edge, Google Chrome, Opera ou Apple Safari.",
