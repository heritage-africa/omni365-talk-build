OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Ospite",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Benvenuti in omni365 Talk!\nIn questa conversazione sarai informato sulle nuove funzionalità disponibili in omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhooks sono ora disponibili per implementare bot. Consulta la documentazione per ulteriori informazioni https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Presentiamo il client desktop omni365 Talk per Windows, macOS e Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Riassumi le registrazioni delle chiamate e i messaggi non letti nelle chat con omni365 Assistant",
    ...
    "There is already a trial registered for this omni365 instance." : "Esiste già una versione di prova registrata per questa istanza di omni365.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** è una piattaforma di comunicazione sicura e self-hosted che si integra perfettamente con l'ecosistema omni365.\n\n#### Caratteristiche principali di omni365 Talk:\n\n* Chat e messaggistica in chat private e di gruppo\n* Chiamate vocali e videochiamate\n* Condivisione di file e integrazione con altre app omni365\n* Impostazioni di conversazione personalizzabili, moderazione e controlli sulla privacy\n* Web, desktop e mobile (iOS e Android)\n* Comunicazione privata e sicura\n\nPer saperne di più, consulta la [documentazione utente](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Benvenuto su omni365 Talk\n\nomni365 Talk è un'app di messaggistica privata e potente che si integra con omni365. Chatta in conversazioni private o di gruppo, collabora tramite chiamate vocali e videochiamate, organizza webinar ed eventi, personalizza le tue conversazioni e molto altro ancora.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formatta i testi per creare messaggi ricchi\n\nIn omni365 Talk, puoi utilizzare la sintassi Markdown per formattare i tuoi messaggi. Ad esempio, puoi applicare la formattazione **grassetto** o *corsivo*, oppure `evidenziare il testo come codice`. Puoi anche creare tabelle e aggiungere intestazioni al tuo testo.\n\nHai bisogno di correggere un errore di battitura o modificare la formattazione? Modifica il tuo messaggio cliccando su “Modifica messaggio” nel menu del messaggio.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Aggiungi allegati e link\n\nAllega file dal tuo omni365 Hub utilizzando il pulsante “+”. Condividi elementi da File e varie app omni365. Alcune app supportano anche widget interattivi, ad esempio l'app Testo.",
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in the conversation by using %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 🔗 Aggiungi allegati e link\n\nAllega file dal tuo omni365 Hub utilizzando il pulsante %s. Condividi elementi da File e varie app omni365. Alcune app supportano anche widget interattivi, ad esempio l'app Testo.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Fai di più con Smart Picker\n\nBasta digitare “/” o andare al menu “+” per aprire Smart Picker, dove puoi allegare vari contenuti ai tuoi messaggi. Puoi configurare Smart Picker per poter aggiungere elementi dalle app omni365, GIF, posizioni sulla mappa, contenuti generati dall'intelligenza artificiale e molto altro ancora.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Errore: gli orari di sistema del server omni365 e del server backend ad alte prestazioni non sono sincronizzati. Assicurati che entrambi i server siano collegati a un server di riferimento orario o sincronizza manualmente l'ora.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Si consiglia vivamente di configurare una cache di memoria quando si esegue omni365 Talk con un backend ad alte prestazioni.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chat, videoconferenze e audioconferenze tramite WebRTC\n\n* 💬 **Chat** omni365 Talk include una semplice chat di testo che consente di condividere o caricare file dall'app omni365 Files o dal dispositivo locale e menzionare altri partecipanti.\n* 👥 **Chiamate private, di gruppo, pubbliche e protette da password!** Invita una persona, un intero gruppo o invia un link pubblico per invitare qualcuno a una chiamata.\n* 🌐 **Chat federate** Chatta con altri utenti omni365 sui loro server\n* 💻 **Condivisione dello schermo!** Condividi il tuo schermo con i partecipanti alla tua chiamata.\n* 🚀 **Integrazione con altre app omni365** come Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck e molte altre.\n* 🌉 **Sincronizzazione con altre soluzioni di chat** Con [Matterbridge](https://github.com/42wim/matterbridge/) integrato in Talk, puoi sincronizzare facilmente molte altre soluzioni di chat con omni365 Talk e viceversa.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Il nostro partner Struktur AG fornisce un servizio in cui è possibile richiedere un server di segnalazione ospitato. Per questo è sufficiente compilare il modulo sottostante e omni365 lo richiederà. Una volta impostato il server, le credenziali saranno riempite automaticamente. Ciò sovrascriverà le impostazioni esistenti del server di segnalazione.",
    ...
    "URL of this omni365 instance" : "URL di questa istanza omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "È possibile installare Matterbridge per collegare omni365 Talk ad altri servizi. Per ulteriori dettagli, visitare la {linkstart1}pagina GitHub{linkend}. Il download e l'installazione dell'app potrebbero richiedere un po' di tempo. In caso di timeout, installarla manualmente dall'{linkstart2}App Store di omni365{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Il file binario Matterbridge ha autorizzazioni errate. Assicurati che il file binario Matterbridge sia di proprietà dell'utente corretto e che possa essere eseguito. Si trova in “/…/omni365/apps/talk_matterbridge/bin/”.",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Errore: gli orari di sistema del server omni365 e del server di backend di registrazione non sono sincronizzati. Assicurati che entrambi i server siano collegati a un server di sincronizzazione oraria o sincronizza manualmente l'ora.",
    ...
    "omni365 base URL" : "URL base di omni365",
    ...
    "omni365 Talk setup not complete" : "Configurazione di omni365 Talk non completata",
    ...
    "omni365 portal" : "Portale di omni365",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Si consiglia vivamente di configurare una cache distribuita quando si utilizza omni365 Talk con un backend ad alte prestazioni.",
    ...
    "Join conversations from remote omni365 servers" : "Partecipa alle conversazioni dai server omni365 remoti",
    ...
    "Share from {omni365}" : "Condividi da {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "La sfocatura dello sfondo per l'istanza omni365 può essere regolata nelle impostazioni del tema.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk è stato aggiornato, non è possibile avviare o partecipare a una chiamata.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Ti sei unito alla conversazione in un'altra finestra o dispositivo. Questo non è attualmente supportato da omni365 Talk, quindi questa sessione è stata chiusa.",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Talk è stato aggiornato.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Stai tentando di partecipare a una conversazione mentre hai una sessione attiva in un'altra finestra o dispositivo. Questo non è attualmente supportato da omni365 Talk. Che cosa vuoi fare?",
    ...
    "omni365 is in maintenance mode." : "omni365 è in modalità manutenzione.",
    "omni365 Talk Federation was updated." : "omni365 Talk Federation è stato aggiornato.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Il browser che stai utilizzando non è completamente supportato da omni365 Talk. Usa l'ultima versione di Mozilla Firefox, Microsoft Edge, Google Chrome, Opera o Apple Safari.",
