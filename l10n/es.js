OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Invitado",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## ¡Le damos la bienvenida a omni365 Talk!\nEn esta convesación se le informará sobre las nuevas características disponibles en omni365 Talk.",
    ...
    "- You can now blur your background in the newly designed call view" : "- Ahora puede desenfocar su fondo usando el nuevo diseño de la vista de llamada",
    ...
    "- In the sidebar you can now find an overview of the latest shared items" : "- En la barra lateral ahora podrá encontrar una vista general de los últimos artículos compartidos",
    "- Use a poll to collect the opinions of others or settle on a date" : "- Utilice una encuesta para recolectar las opiniones o para acordar una fecha",
    "- Configure an expiration time for chat messages" : "- Configure un tiempo de expiración para los mensajes de chat",
    "- Start calls without notifying others in big conversations. You can send individual call notifications once the call has started." : "- Inicie llamadas sin notificar a otros en conversaciones numerosas. Puede enviar notificaciones de llamada individuales una vez que la llamada ha iniciado.",
    ...
    "- Calls can now be recorded (requires the High-performance backend)" : "- Las llamadas ahora pueden ser grabadas (requiere el motor de alto rendimiento)",
    "- Conversations can now have an avatar or emoji as icon" : "- Ahora, las conversaciones pueden tener como icono un avatar o emoji",
    "- Virtual backgrounds are now available in addition to the blurred background in video calls" : "- Están disponibles ahora los fondos virtuales, además de los fondos desenfocados en las llamadas de video",
    "- Reactions are now available during calls" : "- Las reacciones están ahora disponibles durante las llamadas",
    "- Typing indicators show which users are currently typing a message" : "- Los indicadores de escritura muestran que usuarios están escribiendo un mensaje",
    "- Groups can now be mentioned in chats" : "- Los grupos ahora pueden ser mencionados en los chats",
    ...
    "- **Markdown** can now be used in _chat_ messages" : "- Ahora se puede usar **Markdown** en mensajes de _chat_",
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Ya se encuentran disponibles Webhooks para implementar bots. Vea la documentación para más información https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Unsent message drafts are now saved in your browser" : "- Los borradores de mensajes no enviados se guardan ahora en su navegador",
    ...
    "- Moderators can now ban accounts and guests to prevent them from rejoining a conversation" : "- Los moderadores ahora pueden bloquear tanto a cuentas como a invitados de volver a unirse a una conversación",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Presentando el cliente de escritorio omni365 Talk para Windows, macOS y Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Resuma grabaciones de llamadas y mensajes de chat no leídos con el Asistente omni365",
    "- Improved meetings with recognizing guests invited via their email address, import of participant lists, drafts for polls and downloading call participant lists" : "- Reuniones mejoradas con reconocimiento de invitados a través de su dirección de correo, importación de listas de participantes, borradores para encuestas y la posibilidad de descargar la lista de participantes de las llamadas",
    "- Archive conversations to stay focused" : "- Archive conversaciones para mantenerse enfocado",
    "- Schedule a meeting into your calendar from within a conversation" : "- Agendar reuniones dentro de su calendario directamente desde una conversación",
    "- Search for messages of the current conversation directly in the right sidebar" : "- Buscar mensajes de la conversación actual directamente en la barra lateral derecha",
    "- See more conversations on a first glance with the new compact list (enable in the Talk settings)" : "- Vea más conversaciones de un vistazo con la nueva lista compacta (habilitar en los ajustes de Talk)",
    "- Meeting conversations now sync the title and description from the calendar and are hidden with a search filter until they are close to the start" : "- Las conversaciones de las Reuniones ahora sincronizan el título y la descripción desde el calendario y están ocultas con un filtro de búsqueda hasta que están por comenzar",
    "- Mark conversations as sensitive in the notification settings, to hide the message content from the conversation list and notifications" : "- Maque las conversaciones como sensibles en los ajustes de notificaciones, de manera de esconder el contenido del mensaje de la lista de conversaciones y las notificaciones",
    "- To receive push notifications during \"Do not disturb\", mark conversations as important" : "- Para recibir notificaciones push durante el estado \"No molestar\", marque las conversaciones como importantes",
    "- Add other participants to a one-to-one call to create a new group call on the fly" : "- Añada a otros participantes en una llamada uno a uno para crear una nueva llamada grupal al vuelo",
    "- Use threads to keep your chat and discussions organized" : "- Use hilos para mantener sus chats y discusiones organizadas",
    "- Live transcriptions now available during the call (requires the live-transcription ExApp and the High-performance backend)" : "- Las transcripciones en vivo están ahora disponibles durante la llamada (requiere la ExApp de transcripción en vivo y el backend de alto rendimiento)",
    ...
    "Outgoing silent call" : "Llamada saliente silenciosa",
    "{actor} started a silent call" : "{actor} inició una llamada silenciosa",
    "Incoming silent call" : "Llamada entrante silenciosa",
    ...
    "{actor} opened the conversation to registered users and users created with the Guests app" : "{actor} abrió la conversación a usuarios registrados y para aquellos usuarios creados con la aplicación de Invitados",
    "You opened the conversation to registered users and users created with the Guests app" : "Ha abierto la conversación a usuarios registrados y para aquellos usuarios creados con la aplicación de Invitados",
    "An administrator opened the conversation to registered users and users created with the Guests app" : "Un administrador ha abierto la conversación a usuarios registrados y para aquellos usuarios creados con la aplicación de Invitados",
    ...
    "You removed {federated_user}" : "Ha eliminado a {federated_user}",
    "You declined the invitation" : "Ud. declinó la invitación",
    ...
    "You removed group {group}" : "Ud. ha eliminado el grupo {group}",
    ...
    "{actor} created thread {title}" : "{actor} creó el hilo {title}",
    "You created thread {title}" : "Ud. creó el hilo {title}",
    "{actor} renamed thread {title}" : "{actor} renombró el hilo {title}",
    "You renamed thread {title}" : "Ud. renombró el hilo {title}",
    ...
    "You deleted a reaction" : "Ud. ha borrado una reacción",
    "_You set the message expiration to %n week_::_You set the message expiration to %n weeks_" : ["Ud. ha cambiado la caducidad del mensaje a %n semana","Ud. ha cambiado la caducidad del mensaje a %n semanas","Ud. ha cambiado la caducidad del mensaje a %n semanas"],
    "_You set the message expiration to %n day_::_You set the message expiration to %n days_" : ["Ud. ha cambiado la caducidad del mensaje a %n día","Ud. ha cambiado la caducidad del mensaje a %n días","Ud. ha cambiado la caducidad del mensaje a %n días"],
    "_You set the message expiration to %n hour_::_You set the message expiration to %n hours_" : ["Ud. ha cambiado la caducidad del mensaje a %n hora","Ud. ha cambiado la caducidad del mensaje a %n horas","Ud. ha cambiado la caducidad del mensaje a %n horas"],
    "_You set the message expiration to %n minute_::_You set the message expiration to %n minutes_" : ["Ud. ha cambiado la caducidad del mensaje a %n minuto","Ud. ha cambiado la caducidad del mensaje a %n minutos","Ud. ha cambiado la caducidad del mensaje a %n minutos"],
    ...
    "You disabled message expiration" : "Ud. ha desactivado la caducidad de mensajes",
    "{actor} cleared the history of the conversation" : "{actor} ha vaciado el historial de la conversación",
    "You cleared the history of the conversation" : "Ud. ha vaciado el historial de la conversación",
    "{actor} set the conversation picture" : "{actor} ha establecido la foto de la conversación",
    "You set the conversation picture" : "Ud. ha establecido la foto de la conversación",
    "{actor} removed the conversation picture" : "{actor} ha eliminado la imagen de la conversación",
    "You removed the conversation picture" : "Ud. ha eliminado la imagen de la conversación",
    "{actor} ended the poll {poll}" : "{actor} finalizó la encuesta {poll}",
    "You ended the poll {poll}" : "Ud. ha finalizado la encuesta {poll}",
    "{actor} started the video recording" : "{actor} inició la grabación de video",
    "You started the video recording" : "Ud. ha iniciado la grabación de video",
    "{actor} stopped the video recording" : "{actor} detuvo la grabación de video",
    "You stopped the video recording" : "Ud. ha detenido la grabación de video",
    "{actor} started the audio recording" : "{actor} ha iniciado la grabación de audio",
    "You started the audio recording" : "Ud. ha iniciado la grabación de audio",
    "{actor} stopped the audio recording" : "{actor} detuvo la grabación de audio",
    "You stopped the audio recording" : "Ud. ha detenido la grabación de audio",
    ...
    "Unanswered call" : "Llamada sin contestar",
    ...
    "%1$s invited you to conversation \"%2$s\"." : "%1$s le ha invitado a la conversación  \"%2$s\".",
    "You were invited to conversation \"%s\"." : "Ud. fue invitado a la conversación \"%s\".",
    ...
    "Your PIN" : "Tu PIN",
    "Click the button below to join the lobby now." : "Haga clic en el botón a continuación para unirse a la sala de espera",
    "Click the link below to join the lobby now." : "Haga clic en el botón a continuación para unirse a la sala de espera",
    "Join lobby for \"%s\"" : "Unirse a la sala de espera para \"%s\"",
    "Click the button below to join the conversation now." : "Haga clic en el botón a continuación para unirse a la conversación ahora.",
    "Click the link below to join the conversation now." : "Haga clic en el enlace a continuación para unirse a la conversación ahora.",
    "Join \"%s\"" : "Unirse a \"%s\"",
    ...
    "Failed to upload call recording" : "Fallo al subir la grabación de la llamada",
    "The recording server failed to upload recording of call {call}. Please reach out to the administration." : "El servidor de grabación falló al subir la grabación de la llamada {call}. Por favor, comuníquelo a la administración.",
    "Share to chat" : "Compartir al chat",
    "Dismiss notification" : "Descartar notificación",
    "Call recording now available" : "La grabación está disponible",
    "The recording for the call in {call} was uploaded to {file}." : "La grabación para llamada en {call} se ha subido a {file}.",
    "Transcript now available" : "La transcripción está disponible",
    ...
    "The server failed to transcript the recording at {file} for the call in {call}. Please reach out to the administration." : "El servidor falló al transcribir la grabación en {file} para la llamada {call}. Por favor, comuníquelo a la administración.",
    "Call summary now available" : "El resumen de la llamada está disponible",
    "The summary for the call in {call} was uploaded to {file}." : "El resumen de la llamada de {call} se subió a {file}.",
    "Failed to summarize call recording" : "Error al resumir la grabación de la llamada",
    "The server failed to summarize the recording at {file} for the call in {call}. Please reach out to the administration." : "El servidor ha fallado al resumir la grabación en {file} de la llamada {call}. Por favor, comuníquelo a la administración.",
    ...
    "Someone reacted" : "Alguien reaccionó",
    "New message" : "Nuevo mensaje",
    "Reminder" : "Recordatorio",
    "Someone mentioned you" : "Alguien te mencionó",
    "Notification" : "Notificación",
    "Someone reacted in a private conversation" : "Alguien reaccionó en una conversación privada",
    "You received a message in a private conversation" : "Recibiste un mensaje en una conversación privada",
    "Reminder in a private conversation" : "Recordatorio en una conversación privada",
    "Someone mentioned you in a private conversation" : "Alguien te mencionó en una conversación privada",
    "Notification in a private conversation" : "Notificación en una conversación privada",
    ...
    "{guest} (guest) reacted with {reaction} to your message in conversation {call}" : "{guest} (invitado) reaccionó con {reaction} a su mensaje en la conversación {call}",
    ...
    "{user} mentioned team {team} in conversation {call}" : "{user} mencionó al equipo {team} en la conversación {call}",
    "{user} mentioned everyone in conversation {call}" : "el usuario {user} mencionó a todos en la conversación {call}",
    ...
    "A deleted user mentioned team {team} in conversation {call}" : "Un usuario eliminado mencionó al equipo {team} en la conversación {call}",
    ...
    "{guest} (guest) mentioned team {team} in conversation {call}" : "{guest}(Invitado) mencionó al equipo {team} en la conversación {call}",
    ...
    "A guest mentioned team {team} in conversation {call}" : "Un invitado mencionó al equipo {team}en la conversación {call}",
    ...
    "Incoming phone call from {call}" : "Llamada telefónica de {call}",
    "You missed a phone call from {call}" : "Ud. tiene una llamada perdida de {call}",
    ...
    "Contact via Talk" : "Contactar vía Talk",
    ...
    "One-to-one rooms always need to show the other users avatar" : "Las salas uno a uno siempre necesitan mostrar los avatars del otro usuario",
    ...
    "There is already a trial registered for this omni365 instance." : "Ya se ha registrado una prueba para esta instancia de omni365.",
    ...
    "Transcript is AI generated and may contain mistakes" : "La transcripción se genera mediante IA y puede contener errores",
    "Summary is AI generated and may contain mistakes" : "El resumen se genera mediante IA y puede contener errores",
    "Let's get started!" : "¡Comencemos!",
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** es una plataforma de comunicación segura y auto-hospedada que se integra completamente de manera transparente con el ecosistema omni365.\n\n#### Características principales de omni365 Talk\n\n* Mensajes privados y chats grupales\n* Llamadas y videollamadas\n* Archivos compartidos e integración con otras aplicaciones omni365\n* Ajustes de conversación, moderación y privacidad personalizables\n* Web, escritorio y móvil (iOS y Android)\n* Comunicación privada y segura\n\nDescubra más información en la [documentación de usuario](https://docs.omni365.com/server/latest/user_manual/es/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Bienvenido/a a omni365 Talk\n\nomni365 Talk es una aplicación de mensajería privada y potente que se integra con omni365. Chatee en privado o en conversaciones grupales, colabore en llamadas de voz y video, organice seminarios web y eventos, personalice sus conversaciones y más.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 De formato al texto para crear mensajes complejos\n\nEn omni365 Talk, puede utilizar Markdown para dar formato a sus mensajes. Por ejemplo, puede usar **negrita** o *cursiva*, y también `formato de código`. Incluso puede crear tablas o añadir encabezados a su texto.\n\n¿Quiere corregir un error o cambiar el formato? Edite su mensaje con el botón \"Editar mensaje\" en el menú de mensajes.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Añada archivos adjuntos y enlaces\n\nAdjunte archivos desde omni365 Hub mediante el botón \"+\". Comparta recursos desde Archivos y varias apps de omni365. Algunas apps le permiten crear widgets interactivos, como por ejemplo, la aplicación Texto.",
    "## 💭 Let the conversations flow: mention users, react to messages and more\n\nYou can mention everybody in the conversation by using %s or mention specific participants by typing \"@\" and picking their name from the list." : "## 💭 Deje que las conversaciones fluyan: mencione usuarios, reaccione a mensajes y más\n\nPuede mencionar a todos en la conversación utilizando %s o a participantes específicos escribiendo \"@\" y seleccionando su nombre de la lista.",
    "You can reply to messages, forward them to other chats and people, or copy message content." : "Puede responder a mensajes, reenviarlos a otras conversaciones y personas, ó, copiar el contenido del mensaje.",
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Haga más con el Selector Inteligente\n\nSimplemente escriba \"/\" o vaya al menú \"+\" para abrir el Selector Inteligente, donde podrá adjuntar distintos tipos de contenido a sus mensajes. Puede configurar el Selector Inteligente para que pueda insertar recursos de tus apps de omni365, GIFs, ubicaciones, texto generado por IA y mucho más.",
    ...
    "Zambia" : "Zambia",
    "Zimbabwe" : "Zimbabue",
    "Background blur" : "Desenfocar fondo",
    "Could not check for WASM loading support. Please check manually if your web server serves `.wasm` files." : "No se ha podido comprobar el soporte para cargar WASM. Por favor, compruebe manualmente si su servidor web sirve archivos '.wasm'.",
    ...
    "Talk configuration values" : "Valores de configuración de Talk",
    "Forcing a call duration is only supported with system cron. Please enable system cron or remove the `max_call_duration` configuration." : "Limitar la duración de las llamadas solo está soportado con el cron del sistema. Por favor, habilite el cron de sistema o elimine la configuración `max_call_duration`.",
    ...
    "The stored public key for used algorithm %1$s does not match the stored private key. Run %2$s to fix the issue." : "La llave pública almacenada para el algoritmo %1$s no coincide con la llave privada almacenada. Ejecute %2$s para corregir el problema.",
    "High-performance backend not configured correctly. Run %s for details." : "El backend de alto rendimiento no ha sido configurado correctamente. Ejecute %s para ver los detalles.",
    ...
    "Warning: Running version: {version}; Server does not support all features of this Talk version, missing features: {features}" : "Advertencia: Versión en ejecución: {version}; El servidor no soporta todas las características de esta versión de Talk, características que faltan: {features}",
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Es altamente recomendado que se configure un caché de memoria cuando se ejecuta omni365 Talk con un backend de alto rendimiento.",
    "Client Push" : "Client Push",
    "Client Push is installed, this improves the performance of desktop clients." : "Client Push se encuentra instalado, esto mejorará el rendimiento de los clientes de escritorio.",
    "{notify_push} is not installed, this might lead to performance issues when using desktop clients." : "{notify_push}no se encuentra instalado, esto podría conllevar a problemas de rendimiento cuando se utilizan clientes de escritorio.",
    "Recording backend" : "Backend de grabación",
    "Using the recording backend requires a High-performance backend." : "Usar el backend de grabación requiere un backend de alto rendimiento.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chat, video & audio conferencias usando WebRTC\n\n* 💬 **Chat** omni365 Talk viene con un chat de texto simple, permitiéndole compartir o subir archivos desde la app de Archivos de omni365, o, desde su dispositivo local y mencionar a otros participantes.\n* 👥 **¡Llamadas privadas, grupales, públicas y protegidas por contraseña!** Invite a alguien, a un grupo o envíe un enlace público para invitar a una llamada.\n* 🌐 **Chats federados** Chatee con otros usuarios de omni365 en sus servidores\n* 💻 **¡Compartir pantalla!** Comparta su pantalla con los participantes de su llamada.\n* 🚀 **Integración con otras apps de omni365** como Archivos, Calendario, estados de usuario, Tablero, Flujos, Mapas, Seleccionador inteligente, Contactos, Tarjetas, y muchas mas.\n* 🌉 **Sincronización con otras soluciones de mensajería** Estando [Matterbridge](https://github.com/42wim/matterbridge/) integrado en Talk, puede fácilmente sincronizar un sinnúmero de otras soluciones de chat con Talk de omni365 y viceversa.",
    ...
    "Error occurred when getting the conversation information" : "Ocurrió un error al obtener la información de la conversación",
    ...
    "Total errors count" : "Recuento total de errores",
    ...
    "End-to-end encrypted calls" : "Llamadas cifradas de extremo a extremo",
    "Enable encryption" : "Habilitar cifrado",
    "End-to-end encrypted calls with a configured SIP bridge require a newer version of the High-performance backend and SIP bridge." : "Las llamadas cifradas de extremo a extremo con un puente SIP configurado necesitan una nueva versión del backend de alto rendimiento y del puente SIP.",
    "Mobile clients do not support end-to-end encrypted calls at the moment." : "Los clientes móviles no soportan las llamadas cfiradas de extremo a extremo en el momento.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Nuestro asociado Struktur AG ofrece un servicio en el que puedes solicitar un servidor de señalización gestionado. Para ello, solo tienes que rellenar el formulario a continuación y tu omni365 enviará la solicitud. Cuando el servidor esté configurado, las credenciales se rellenarán automáticamente. Esto sobrescribirá los ajustes actuales del servidor de señalización.",
    "If your high-performance backend account includes STUN and/or TURN functionality, the settings will be updated accordingly." : "Si su backend de alto rendimiento incluye funcionalidad STUN y/o TURN, los ajustes serán adecuadamente actualizados ",
    "URL of this omni365 instance" : "URL de esta instancia de omni365",
    ...
    "Limits" : "Límites",
    "STUN included" : "STUN incluido",
    "Yes" : "Sí",
    "No" : "No",
    "TURN included" : "TURN incluido",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Puede instalar Matterbridge para enlazar omni365 Talk con algunos otros servicios, visite su {linkstart1}página de GitHub{linkend} para más detalles. La descarga e instalación de la aplicación puede llevar un tiempo. En caso de que falle por tiempo de espera, haga la instalación manualmente desde la {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "El archivo binario de Matterbridge tiene permisos incorrectos. Por favor, asegúrese de que el archivo binario de Matterbridge pertenece al usuario correcto y se puede ejecutar. Este puede encontrarse en \"/…/omni365/apps/talk_matterbridge/bin/\".",
    ...
    "An error occurred while installing the Talk Matterbridge. Please install it manually" : "Ocurrió un error mientras se instalaba Matterbridge para Talk. Por favor, instale el mismo manualmente",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Error: los relojes de los servidores omni365 y el backend de grabación están desincronizados. Por favor, asegúrese de que ambos servidores están conectados a un servidor de sincronización de hora o sincronice sus relojes manualmente.",
    ...
    "Configurable on conversation level by moderators" : "Configurable a nivel de conversación por los moderadores",
    ...
    "Do not show SIP Dial-out caller number" : "No mostrar el número telefónico en llamadas SIP salientes",
    "Anonymous number should appear as \"unknown\" or \"withheld number\" to call recipient" : "El número anónimo debe aparecer como \"desconocido\" o \"número privado\" al recipiente de la llamada",
    "Dial-out number" : "Número de llamada saliente",
    "E164 formatted number used as a fallback caller number for outgoing calls" : "Número en formato E164 utilizado como número alternativo para llamadas salientes",
    "Dial-out prefix" : "Prefijo para llamadas salientes",
    "Prefix to configured user number for outgoing calls (default is `+`)" : "Prefijo para el número configurado del usuario para llamadas salientes (el predeterminado es `+`)",
    ...
    "omni365 base URL" : "URL base de omni365",
    "Talk Backend URL" : "URL del backend Talk",
    "WebSocket URL" : "URL de WebSocket",
    "Available features" : "Características disponibles",
    "Error: Websocket connection failed" : "Error: La conexión Websocket falló",
    "Error code" : "Código de error",
    "Error message" : "Mensaje de error",
    "Error: Websocket connection failed. Check browser console" : "Error: la conexión Websocket ha fallado. Compruebe la consola del navegador",
    "High-performance backend URL" : "URL del motor de alto rendimiento",
    "Missing High-performance backend warning hidden" : "La advertencia de falta de backend de alto rendimiento está oculta",
    "High-performance backend settings saved" : "Se guardaron las configuraciones del backend de alto rendimiento",
    "omni365 Talk setup not complete" : "La configuración de omni365 Talk no está completa",
    "Please note that in calls with more than 2 participants without the High-performance backend, participants will most likely experience connectivity issues and cause high load on participating devices." : "Por favor, tenga en cuenta que en llamadas con más de 2 participantes sin el backend de alto rendimiento, los participantes podrían experimentar problemas de conectividad y causará una carga de trabajo alta en los dispositivos participantes.",
    "Install the High-performance backend to ensure calls with multiple participants work seamlessly." : "Instale el backend de alto rendimiento para asegurarse de que las llamadas con múltiples participantes funcionen sin interrupciones.",
    "omni365 portal" : "Portal omni365",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Es altamente recomendable configurar una caché distribuida al utilizar omni365 Talk con un backend de alto rendimiento.",
    ...
    "Invalid start time selected" : "Se seleccionó una hora de inicio inválida",
    "Invalid end time selected" : "Se seleccionó una hora de finalización inválida",
    "Unknown error occurred" : "Ha ocurrido un error desconocido",
    "Sending no invitations" : "No se enviarán invitaciones",
    ...
    "Invite {user}" : "Invitar a {user}",
    "Invite all users and emails in this conversation" : "Invitar a todos los usuarios y correos electrónicos en esta conversación",
    ...
    "No other participants to send invitations to." : "No hay otros participantes a los cuales enviar invitaciones.",
    "Add attendees" : "Añadir asistentes",
    "Save" : "Guardar",
    "Search participants" : "Buscar participantes",
    "No results" : "Sin resultados",
    "Done" : "Listo",
    "Enable live transcription" : "Habilitar transcripción en vivo",
    "Disable live transcription" : "Deshabilitar transcripción en vivo",
    ...
    "Error when trying to load the available live transcription languages" : "Error al intentar cargar los lenguajes de transcripción disponibles",
    "Failed to enable live transcription" : "Fallo al habilitar la transcripción en vivo",
    ...
    "Lobby is still active and you're not a moderator" : "La sala de espera sigue activa y Ud. no es un moderador",
    ...
    "Select a speaker" : "Seleccione un parlante",
    ...
    "Select a video device" : "Seleccione un dispositivo de video",
    ...
    "Connection was lost and could not be re-established …" : "Se ha perdido la conexión y no se pudo re-establecer …",
    "Connection could not be established. Trying again …" : "No se pudo establecer la conexión. Intentándolo de nuevo …",
    "Connection lost. Trying to reconnect …" : "Se ha perdido la conexión. Intentando reconectar …",
    ...
    "Unban" : "Desbloquear",
    "You can change the title and the description in {linkstart}Calendar ↗{linkend}." : "Puede cambiar el título y la descripción en {linkstart} Calendario ↗{linkend}.",
    ...
    "Could not modify default permissions for {conversationName}" : "No se pudieron modificar los permisos por defecto para {conversationName}",
    ...
    "Every time permissions are modified in this section, custom permissions previously assigned to individual participants will be lost." : "Cada vez que se modifiquen los permisos en esta sección, los permisos personalizados asignados previamente a participantes individuales serán perdidos.",
    ...
    "Message expiration" : "Expiración de mensajes",
    ...
    "You opened the conversation to both registered users and users created with the Guests app" : "Ha abierto la conversación tanto a participantes registrados como a usuarios creados con la app Guests",
    ...
    "Set language spoken in calls" : "Establecer el lenguaje hablado en las llamadas",
    "Languages could not be loaded" : "Los lenguajes no pudieron ser cargados",
    "Loading languages …" : "Cargando lenguajes …",
    "Invalid language" : "Idioma inválido",
    "Default language (English)" : "Lenguaje predeterminado (Inglés)",
    "Default live transcription language set" : "Se ha establecido el lenguaje predeterminado para la transcripción en vivo",
    "Live transcription language set: {languageName}" : "Lenguaje de transcripción en vivo establecido: {languageName}",
    "Error when trying to set live transcription language" : "Error al intentar establecer el idioma predeterminado de transcripción en vivo",
    ...
    "Import email participants" : "Importar participantes por correo electrónico",
    "You can import a list of email participants from a CSV file." : "Puede importar una lista de participantes por correo electrónico desde un archivo CSV.",
    "Poll drafts" : "Borradores de encuestas",
    "Browse poll drafts" : "Explorar borradores de encuestas",
    ...
    "Mentioning @all has been limited to moderators." : "La mención a @all ha sido limitada a los moderadores.",
    ...
    "Notify about calls in this conversation" : "Notificar llamadas en esta conversación",
    "Important conversation" : "Conversación importante",
    "\"Do not disturb\" user status is ignored for important conversations" : "El estado \"No molestar\" se ignorará para las conversaciones importantes",
    "Sensitive conversation" : "Conversación sensible",
    "Message preview will be disabled in conversation list and notifications" : "La vista previa de los mensajes será deshabilitada en la lista de conversaciones y en las notificaciones",
    ...
    "_%n person accepted_::_%n people accepted_" : ["%n persona aceptó","%n personas aceptaron","%n personas aceptaron"],
    "_%n person declined_::_%n people declined_" : ["%n persona rechazó","%n personas rechazaron","%n personas rechazaron"],
    "_and %n other attachment_::_and %n other attachments_" : ["y %n otro adjunto","y otros %n adjuntos","y otros %n adjuntos"],
    ...
    "View event on Calendar" : "Ver evento en Calendar",
    ...
    "Scroll forward" : "Desplazarse hacia adelante",
    "Schedule meetings" : "Programar reuniones",
    "You don't have any upcoming meetings" : "No tiene próximas reuniones",
    "Schedule a meeting from your calendar. A Talk conversation needs to be set as location to show up here" : "Programe una reunión desde su calendario. Una conversación de Talk deberá ser puesta como ubicación para que sea mostrada aquí",
    "Open calendar" : "Abrir calendario",
    "Unread mentions" : "Menciones sin leer",
    "Messages where you were mentioned will show up here. You can mention people by typing @ followed by their name" : "Los mensajes donde fue mencionado aparecerán aquí. Puede mencionar a las personas escribiendo @ seguido de su nombre",
    "Upcoming reminders" : "Próximos recordatorios",
    "Message reminders" : "Recordatorios de mensajes",
    "Set a reminder on a message to be notified" : "Establezca un recordatorio en un mensaje para ser notificado",
    ...
    "Do you already have an account?" : "¿Ya tiene una cuenta?",
    "Log in" : "Iniciar sesión",
    "Error while verifying uploaded file" : "Error al verificar el archivo cargado",
    "Uploaded file is verified" : "El archivo subido ha sido verificado",
    "Content format is comma-separated values (CSV):<br/>- Header line is required and must match <samp>\"name\",\"email\"</samp> or just <samp>\"email\"</samp><br/>- One entry per line (e.g. <samp>\"John Doe\",\"john@example.tld\"</samp>)" : "El formato del contenido está separado por comas (CSV):<br/>- Se requiere una línea de cabecera y debe coincidir con <samp>\"name\",\"email\"</samp> o solamente <samp>\"email\"</samp><br/>- Una entrada por línea (p.ej. <samp>\"John Doe\",\"john@example.tld\"</samp>)",
    "Participants added successfully" : "Se añadieron los participantes exitosamente",
    ...
    "This might take a moment" : "Esto puede tomar un momento",
    "Send invitations" : "Enviar invitaciones",
    "_%n invalid email_::_%n invalid emails_" : ["%n correo inválido","%n correos inválidos","%n correos inválidos"],
    ...
    "_%n invitation can be sent_::_%n invitations can be sent_" : ["%n invitación puede ser enviada","%n invitaciones pueden ser enviadas","%n invitaciones pueden ser enviadas"],
    ...
    "Ignore \"Do not disturb\"" : "Ignorar el estado \"No molestar\"",
    ...
    "Hide message text" : "Esconder texto del mensaje",
    "Pending invitations" : "Invitaciones pendientes",
    "Join conversations from remote omni365 servers" : "Unirse a conversaciones de servidores omni365 remotos",
    ...
    "Mentions" : "Menciones",
    "Meetings" : "Reuniones",
    "No followed threads" : "Sin hilos seguidos",
    ...
    "Subscribe to an existing thread or start your own." : "Suscríbase a un hilo existente o inicie uno propio.",
    ...
    "Select speaker" : "Seleccionar orador",
    "No speaker available" : "No hay oradores disponibles",
    ...
    "The call might be recorded." : "La llamada podría ser grabada.",
    "The recording might include your voice, video from camera, and screen share. Your consent is required before joining the call." : "La grabación podría incluir su voz, vídeo de su cámara y la pantalla compartida. Es necesario que dé su consentimiento antes de unirse a la llamada.",
    "Give consent to the recording of this call" : "Dar mi consentimiento a la grabación de esta llamada",
    "Show more info" : "Mostrar más información",
    "Audio is not available" : "El audio no está disponible",
    "Video is not available" : "El vídeo no está disponible",
    "Start recording immediately with the call" : "Iniciar la grabación inmediatamente con la llamada",
    "Notify all participants about this call" : "Notificar a todos los participantes de esta llamada",
    ...
    "Error while uploading the file" : "Ocurrió un error mientras se subía el archivo",
    "Select a file" : "Selecciona un archivo",
    "Invalid path selected" : "Ruta de archivo seleccionada no válida.",
    "Select virtual background from file {fileName}" : "Seleccione el fondo virtual desde el archivo {fileName}",
    "Blur" : "Desenfoque",
    "Upload" : "Subir",
    "Files" : "Archivos",
    "(editing)" : "(editando)",
    ...
    "Go to thread" : "Ir al hilo",
    "Edit thread details" : "Editar detalles del hilo",
    ...
    "Open poll • You voted already" : "Encuesta abierta ・ Ya ha votado",
    "Open poll • Click to vote" : "Encuesta abierta ・ Haga clic para votar",
    ...
    "Poll" : "Encuesta",
    "Edit poll draft" : "Editar borrador de encuesta",
    ...
    "Create a thread silently" : "Crear un hilo de manera silenciosa",
    "Create a thread" : "Crear un hilo",
    ...
    "Thread title is required" : "Se requiere un título para el hilo",
    "Message text is required" : "El texto del mensaje es requerido",
    ...
    "Share from {omni365}" : "Compartir desde {omni365}",
    ...
    "Summary is AI generated and might contain mistakes" : "El resumen se genera mediante IA y puede contener errores",
    ...
    "Skip the lobby" : "Saltarse la sala de espera",
    ...
    "There is no poll drafts yet saved for this conversation" : "No hay borradores de encuestas guardados todavía para esta conversación",
    ...
    "Delete poll option" : "Borrar opción de la encuesta",
    ...
    "Change your vote" : "Cambiar su voto",
    ...
    "The text must be less than or equal to {maxLength} characters long. Your current text is {charactersCount} characters long." : "El texto debe ser menor o igual a {maxLength} caracteres. Su texto actual tiene {charactersCount} caracteres.",
    "Remove group and members" : "Eliminar grupo y miembros",
    "Remove team and members" : "Eliminar equipo y miembros",
    "Remove participant" : "Eliminar participante",
    "Do you really want to remove group \"{displayName}\" and its members from this conversation?" : "¿Realmente desea eliminar el grupo \"{displayName}\" y a todos sus miembros de esta conversación?",
    "Do you really want to remove team \"{displayName}\" and its members from this conversation?" : "¿Realmente desea eliminar el equipo \"{displayName}\" y a todos sus miembros de esta conversación?",
    "Do you really want to remove {displayName} from this conversation?" : "¿Realmente desea eliminar a {displayName} de esta conversación?",
    ...
    "Permissions set to default for {displayName}" : "Se establecieron los permisos predeterminados para {displayName}",
    ...
    "in the lobby" : "en la sala de espera",
    "Dial out phone" : "Teléfono para llamadas salientes",
    "Hang up phone" : "Colgar el teléfono",
    "Move back to lobby" : "Regresar a la sala de espera",
    ...
    "Dial out phone number" : "Número de teléfono de llamadas salientes",
    ...
    "Remove all permissions" : "Revocar todos los permisos",
    "Also ban from this conversation" : "También bloquear de esta conversación",
    ...
    "A new group conversation with selected participant will be created" : "Se creará una nueva conversación grupal con el participante seleccionado",
    ...
    "Thread notifications" : "Notificaciones para hilos",
    ...
    "Edit display name" : "Editar nombre mostrado",
    "Display name (required)" : "Nombre a mostrar (requerido)",
    ...
    "Error while setting personal setting" : "Error al guardar sus ajustes personales",
    ...
    "Enable blur background by default for all conversations" : "Habilitar el desenfoque de fondo de manera predeterminada para todas las conversaciones",
    "Do not show the device preview screen before joining a call" : "No mostrar la pantalla de previsualización del dispositivo antes de unirse a una llamada",
    "Preview screen will still be shown if recording consent is required" : "La pantalla de previsualización será mostrada aún si se requiere del consentimiento de grabación",
    ...
    "Blur background image in the call (may increase GPU load)" : "Desenfocar imagen de fondo en la llamada (podría incrementar la carga del GPU)",
    "Background blur for omni365 instance can be adjusted in the theming settings." : "El desenfoque del fondo para la instancia de omni365 puede ajustarse en los ajustes de tema.",
    ...
    "Zoom-in / zoom-out a screen share" : "Acercar / Alejar una pantalla compartida",
    "Talk version: {version}" : "Versión de Talk: {version}",
    "More actions" : "Más acciones",
    "Start call silently" : "Iniciar llamada en silencio",
    "Start call" : "Comenzar llamada",
    "End call" : "Finalizar llamada",
    "omni365 Talk was updated, you cannot start or join a call." : "Se ha actualizado omni365 Talk, no puede iniciar o unirse a una llamada.",
    "This call has just ended" : "Esta llamada acaba de finalizar",
    ...
    "Cancel recording start" : "Cancelar el inicio de la grabación",
    "Stop recording" : "Detener grabación",
    "Send a reaction" : "Enviar una reacción",
    "React with {reaction}" : "Reaccionar con {reaction}",
    "All tasks done!" : "¡Todas las tareas han sido completadas!",
    ...
    "Your internet connection or computer are busy and other participants might be unable to see your screen. To improve the situation try to disable the background blur or your video while doing a screen share." : "Su conexión a internet o su ordenador están saturados y puede que otros participantes no vean su pantalla. Para mejorar la situación, intente desactivar el desenfoque del fondo o su vídeo mientras esté compartiendo su pantalla.",
    "Disable background blur" : "Deshabilitar el desenfoque del fondo",
    "Your internet connection or computer are busy and other participants might be unable to see your screen. To improve the situation try to disable your video while doing a screenshare." : "Su conexión a internet o su ordenador están saturados y puede que otros participantes no vean su pantalla. Para mejorar la situación, intente desactivar su vídeo mientras esté compartiendo su pantalla.",
    ...
    "Select virtual background" : "Seleccione fondo virtual",
    ...
    "Would you like to delete this conversation?" : "¿Desea eliminar esta conversación?",
    "This conversation will be automatically deleted for everyone {expirationDurationFormatted} of no activity." : "Esta conversación se eliminará automáticamente para todos tras {expirationDurationFormatted} días sin actividad.",
    "Are you sure you want to delete this conversation?" : "¿Está seguro que quiere eliminar esta conversación?",
    ...
    "You do not have permissions to access this conversation." : "No tiene permiso para acceder a esta conversación.",
    "Join a different conversation or start a new one." : "Únase a otra conversación o inicie una nueva.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Te has unido a la conversación en otra ventana o dispositivo. omni365 Talk no soporta esto en la actualidad, por lo que se ha cerrado esta sesión.",
    ...
    "omni365 URL" : "URL de omni365",
    "omni365 user" : "Usuario de omni365",
    ...
    "Show all deck cards" : "Mostrar todas las tarjetas deck",
    ...
    "{actor} reconnected to the call" : "{actor} se ha re-conectado a la llamada",
    ...
    "You demoted {user0} and {user1} from moderators" : "Ud. degradó a {user0} y a {user1} de su estatus de moderadores",
    "_You demoted {user0}, {user1} and %n more participant from moderators_::_You demoted {user0}, {user1} and %n more participants from moderators_" : ["Ud. degradó a {user0}, {user1} y a %n participante de su estatus de moderadores","Ud. degradó a {user0}, {user1} y a %n participantes más de su estatus de moderadores","Ud. degradó a {user0}, {user1} y a %n participantes más de su estatus de moderadores"],
    "An administrator demoted you and {user0} from moderators" : "Un administrador lo ha degradado a Ud. y a {user0} de su estatus de moderadores",
    "{actor} demoted you and {user0} from moderators" : "{actor} lo ha degradado a Ud. y a {user0} de su estatus de moderadores",
    "_An administrator demoted you, {user0} and %n more participant from moderators_::_An administrator demoted you, {user0} and %n more participants from moderators_" : ["Un administrador lo ha degradado a Ud., {user0} y %n participante más de su estatus de moderadores","Un administrador lo ha degradado a Ud., {user0} y %n participantes más de su estatus de moderadores","Un administrador lo ha degradado a Ud., {user0} y %n participantes más de su estatus de moderadores"],
    "_{actor} demoted you, {user0} and %n more participant from moderators_::_{actor} demoted you, {user0} and %n more participants from moderators_" : ["{actor} lo ha degradado a Ud., {user0} y a %n participante de su estatus de moderadores","{actor} lo ha degradado a Ud., {user0} y a %n participantes más de su estatus de moderadores","{actor} lo ha degradado a Ud., {user0} y a %n participantes más de su estatus de moderadores"],
    "An administrator demoted {user0} and {user1} from moderators" : "Un administrador degradó a {user0} y a {user1} de su estatus de moderadores",
    "{actor} demoted {user0} and {user1} from moderators" : "{actor} degradó a {user0} y a {user1} de su estatus de moderadores",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "Se ha actualizado omni365 Talk.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Estás intentando unirte a una conversación mientras tienes activa una sesión en otra ventana o dispositivo. omni365 Talk no admite esto en la actualidad. ¿Qué prefieres hacer?",
    "Leave this page" : "Abandonar esta página",
    "Join here" : "Unirte aquí",
    "Deck card has been posted to {conversation}" : "La tarjeta Deck del tablero ha sido publicada a {conversation}",
    ...
    "The recording failed. Please contact your administrator." : "La grabación falló. Por favor, contacte a su administrador.",
    ...
    "Call recording stopped while starting." : "La grabación de la llamada se detuvo mientras comenzaba.",
    ...
    "Could not remove the automatic expiration" : "No se pudo borrar la expiración automática",
    ...
    "Participant is banned successfully" : "El participante fue bloqueado exitosamente",
    ...
    "An error occurred while resetting the request for assistance" : "Ocurrió un error mientras se restablecía la solicitud de asistencia",
    "An error occurred while joining breakout room" : "Ha ocurrido un error al unirse a la sala de grupos",
    "Failed to rename the thread" : "Fallo al renombrar el hilo",
    "Error fetching upcoming events" : "Error al obtener los próximos eventos",
    "Error fetching upcoming reminders" : "Error al obtener las próximas notificaciones",
    ...
    "An error occurred while ending the poll" : "Ocurrió un error mientras se finalizaba la encuesta",
    "An error occurred while deleting the poll draft" : "Ha ocurrido un error mientras se eliminaba el borrador de la encuesta",
    "Poll \"{name}\" was created by {user}. Click to vote" : "La encuesta \"{name}\" fue creada por {user}. Haga clic para votar",
    "Failed to add reaction" : "Fallo al añadir reacción",
    "Failed to remove reaction" : "Fallo al quitar la reacción",
    "omni365 is in maintenance mode." : "omni365 está en modo mantenimiento.",
    "omni365 Talk Federation was updated." : "Se ha actualizado la federación de omni365 Talk.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Este navegador no es completamente compatible con omni365 Talk. Por favor, usa la última versión de Mozilla Firefox, Microsoft Edge, Google Chrome, Opera o Apple Safari.",
    ...
    "We have detected multiple invalid password attempts from your IP. Therefore your next attempt is throttled up to 30 seconds." : "Hemos detectado múltiples intentos fallidos de inicio de sesión desde su IP. Por lo tanto, su siguiente inicio de sesión se podría retrasar hasta 30 segundos. ",
    ...
    "Webhook Demo" : "Demostración de Webhooks",
