OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Gost",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Dobrodošli v program omni365 Talk!\nTa pogovor je namenjen obvestilom in podrobnostim o novih zmožnosti programa.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Na voljo so spletne kljuke za dodajanje botov. Več podrobnosti je zapisanih v dokumentaciji https://omni365-talk.readthedocs.io/en/latest/bot-list/.",
    ...
    "There is already a trial registered for this omni365 instance." : "Preizkusni strežnik način za to namestitev je že vpisan.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Partnersko podjetje Struktur AG ponuja storitev, pri kateri je mogoče zahtevati dostop do gostujočega signalnega strežnika. Izpolniti je treba le spodnji obrazec in zahteva bo poslana. Ko je strežnik nastavljen za uporabo bodo vaša poverila samodejno posodobljena, kar prepiše obstoječe nastavitve.",
    "URL of this omni365 instance" : "Naslov URL te namestitve omni365",
    ...
    "Share from {omni365}" : "Pošlji iz {omni365}",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Pogovoru ste se pridružili v novem oknu brskalnika, ali na drugi napravi. omni365 Talk te možnosti trenutno ne omogoča, zato je bila druga seja preklicana.",
    "Join a conversation or start a new one" : "Pridružite se pogovoru, ali pa začnite novega.",
    "Error while joining the conversation" : "Prišlo je do napake med pridruževanjem k pogovoru",
    "omni365 URL" : "Naslov URL omni365",
    "omni365 user" : "Uporabnik omni365",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Pogovoru ste se pridružili v novem oknu brskalnika, ali na drugi napravi. omni365 Talk te možnosti trenutno ne omogoča. Kako želite nadaljevati?",
