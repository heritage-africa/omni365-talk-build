OC.L10N.register(
    ...
    "Talk" : "Caint",
    "Guest" : "Aoi",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "##Fáilte go omni365 Talk!\nSa chomhrá seo cuirfear ar an eolas thú faoi ghnéithe nua atá ar fáil in omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Tá webooks ar fáil anois chun róbónna a chur i bhfeidhm. Féach an doiciméadú le haghaidh tuilleadh eolais https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Cliant deisce omni365 Talk do Windows, macOS agus Linux a thabhairt isteach: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Déan achoimre ar thaifeadtaí glaonna agus teachtaireachtaí neamhléite i gcomhráite leis an omni365 Assistant",
    ...
    "There is already a trial registered for this omni365 instance." : "Tá triail cláraithe cheana féin don ásc omni365 seo.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "Is ardán cumarsáide slán féin-óstach é **omni365 Talk** a chomhtháthaíonn gan uaim le héiceachóras omni365.\n\n#### Príomhghnéithe de omni365 Talk:\n\n* Comhrá agus teachtaireachtaí i gcomhráite príobháideacha agus grúpa\n* Glaonna gutha agus físe\n* Comhroinnt agus comhtháthú le haipeanna eile omni365\n* Socruithe comhrá saincheaptha, modhnóireacht agus rialuithe príobháideachais\n* Gréasán, deasc agus soghluaiste (iOS agus Android)\n* Cumarsáid phríobháideach agus shlán\n\nFaigh tuilleadh eolais sa [dhoiciméadú úsáideora](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Fáilte go omni365 Talk\n\nIs aip teachtaireachtaí príobháideach agus cumhachtach é omni365 Talk a chomhtháthaíonn le omni365. Déan comhrá i gcomhráite príobháideacha nó grúpa, comhoibrigh thar ghlaonna gutha agus físe, eagraigh seimineáir agus imeachtaí, saincheap do chomhráite agus go leor eile.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Formáidigh téacsanna chun teachtaireachtaí saibhir a chruthú\n\nIn omni365 Talk, is féidir leat comhréir Markdown a úsáid chun do theachtaireachtaí a fhormáidiú. Mar shampla, cuir formáidiú **trom** nó *iodálach* i bhfeidhm, nó 'béim ar théacsanna mar chód`. Is féidir leat fiú táblaí a chruthú agus ceannteidil a chur le do théacs.\n\nAn gá clóscríobh a shocrú nó formáidiú a athrú? Cuir do theachtaireacht in eagar trí \"Cuir teachtaireacht in eagar\" a chliceáil sa roghchlár teachtaireachta.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Cuir ceangaltáin agus naisc leis\n\nCeangail comhaid ó do Mhol omni365 ag baint úsáide as an gcnaipe \"+\". Comhroinn míreanna ó Chomhaid agus aipeanna éagsúla omni365. Tacaíonn roinnt apps fiú le giuirléidí idirghníomhacha, mar shampla, an app Téacs.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Déan níos mó le Smart Picker\n\nNíl ort ach clóscríobh \"/\" nó téigh go dtí an roghchlár \"+\" chun an Piocálaí Cliste a oscailt áit ar féidir leat ábhar éagsúla a cheangal le do theachtaireachtaí. Is féidir leat an Roghnóir Cliste a chumrú le bheith in ann míreanna a chur leis ó aipeanna omni365, GIFs, láithreacha léarscáileanna, ábhar a ghintear le AI agus go leor eile.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Earráid: Níl amanna córais fhreastalaí omni365 agus freastalaí Inneall Ardfheidhmíochta as sioncronú. Cinntigh le do thoil go bhfuil an dá fhreastalaí ceangailte le freastalaí ama nó sioncrónaigh a gcuid ama de láimh.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Moltar go mór taisce cuimhne a chumrú agus omni365 Talk á rith le hInneall Ardfheidhmíochta.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Comhrá, físchomhdháil & closchomhdháil ag úsáid WebRTC\n\n* 💬 **Comhrá** Tagann omni365 Talk le comhrá téacs simplí, a ligeann duit comhaid a roinnt nó a uaslódáil ó d’aip nó do ghléas áitiúil omni365 Files agus rannpháirtithe eile a lua.\n* 👥 **Glaonna príobháideacha, grúpa, poiblí agus cosanta ag pasfhocal!** Tabhair cuireadh do dhuine éigin, do ghrúpa iomlán nó seol nasc poiblí chun cuireadh a thabhairt do ghlao.\n* 🌐 **Comhráite Cónaidhme** Déan comhrá le húsáideoirí eile omni365 ar a bhfreastalaithe\n* 💻 **Scáileán a roinnt!** Roinn do scáileán le rannpháirtithe do ghlao.\n* 🚀 ** Comhtháthú le haipeanna omni365 eile** cosúil le Comhaid, Féilire, Stádas Úsáideora, Painéal na nIonstraimí, Sreabhadh, Léarscáileanna, Roghnóir Cliste, Teagmhálacha, Deic, agus go leor eile.\n* 🌉 **Sioncronaigh le réitigh chomhrá eile** Agus [Matterbridge](https://github.com/42wim/matterbridge/) á chomhtháthú in Talk, is féidir leat go leor réitigh comhrá eile a shioncronú go héasca le omni365 Talk agus vice- versa.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Soláthraíonn ár gcomhpháirtí Struktur AG seirbhís inar féidir freastalaí comharthaíochta óstáilte a iarraidh. Chuige seo ní gá duit ach an fhoirm thíos a líonadh agus iarrfaidh do omni365 í. Nuair a bheidh an freastalaí socraithe duit líonfar na dintiúir go huathoibríoch. Forscríobhfaidh sé seo na socruithe freastalaí comharthaíochta atá ann cheana féin.",
    ...
    "URL of this omni365 instance" : "URL an ásc omni365 seo",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Is féidir leat an Matterbridge a shuiteáil chun omni365 Talk a nascadh le roinnt seirbhísí eile, tabhair cuairt ar a {linkstart1}leathanach GitHub{linkend} le haghaidh tuilleadh sonraí. Is féidir go dtógfaidh sé tamall an aip a íoslódáil agus a shuiteáil. Ar eagla go mbeidh teorainn leis, suiteáil de láimh é ón {linkstart2}omni365 Siopa Aip{linkend} le do thoil.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Tá ceadanna míchearta ag dénártha Matterbridge. Cinntigh le do thoil gur leis an úsáideoir ceart an comhad dénártha Matterbridge agus gur féidir é a fhorghníomhú. Is féidir é a fháil in \"/…/omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Earráid: Níl amanna córais fhreastalaí omni365 agus freastalaí Inneall Taifeadta as sioncronú. Cinntigh le do thoil go bhfuil an dá fhreastalaí ceangailte le freastalaí ama nó sioncrónaigh a gcuid ama de láimh.",
    ...
    "omni365 base URL" : "URL bonn omni365",
    ...
    "omni365 Talk setup not complete" : "Níl socrú omni365 Talk críochnaithe",
    ...
    "omni365 portal" : "Tairseach omni365",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Moltar go mór taisce dáilte a chur ar bun agus omni365 Talk ag baint úsáide as inneall ardfheidhmíochta.",
    ...
    "Join conversations from remote omni365 servers" : "Glac páirt i gcomhráite ó fhreastalaithe cianda omni365",
    ...
    "Share from {omni365}" : "Roinn ó {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Is féidir geamhú an chúlra do shampla omni365 a choigeartú sna socruithe téamaí.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "Nuashonraíodh omni365 Talk, ní féidir leat glao a thosú nó páirt a ghlacadh ann.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Chuaigh tú isteach sa chomhrá i bhfuinneog nó gléas eile. Ní thacaíonn omni365 Talk leis seo faoi láthair mar sin dúnadh an seisiún seo.",
    ...
    "omni365 user" : "Úsáideoir omni365",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "Nuashonraíodh omni365 Talk.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Tá tú ag iarraidh páirt a ghlacadh i gcomhrá agus seisiún gníomhach agat i bhfuinneog nó gléas eile. Ní thacaíonn omni365 Talk leis seo faoi láthair. Cad ba mhaith leat a dhéanamh?",
