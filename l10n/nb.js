OC.L10N.register(
    ...
    "Talk" : "Samtale",
    "Guest" : "Gjest",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Velkommen til omni365 Talk!\nI denne samtalen vil du bli informert om nye funksjoner som er tilgjengelige i omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Webhooks er nå tilgjengelige for å implementere roboter. Se dokumentasjonen for mer informasjon https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "There is already a trial registered for this omni365 instance." : "Det er allerede registrert en prøveversjon for denne omni365-forekomsten.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chat, video og lydkonferanser ved hjelp av WebRTC\n\n* 💬 **Chat** omni365 Talk leveres med en enkel tekstchat, slik at du kan dele eller laste opp filer fra omni365 Filer-appen eller den lokale enheten og nevne andre deltakere.\n* 👥 **Private, gruppe, offentlige og passordbeskyttede samtaler!** Inviter noen, en hel gruppe eller send en offentlig kobling for å invitere til en samtale.\n* 🌐 **Samlede chatter** Chat med andre omni365-brukere på deres servere\n* 💻 **Skjermdeling!** Del skjermen din med deltakerne i samtalen.\n* 🚀 **Integrasjon med andre omni365-apper** som Filer, Kalender, Brukerstatus, Dashboard, Flyt, Kart, Smart picker, Kontakter, Deck, og mange flere.\n* 🌉 **Synkroniser med andre chat-løsninger** Med [Matterbridge](https://github.com/42wim/matterbridge/) blir integrert i Talk,  du kan enkelt synkronisere mange andre chat-løsninger til omni365 Talk og omvendt.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Vår partner Struktur AG leverer en tjeneste der en vertsbasert signalserver kan forespørres. For dette trenger du bare å fylle ut skjemaet nedenfor og din omni365 vil be om det. Når serveren er satt opp for deg, fylles legitimasjonen automatisk. Dette vil overskrive de eksisterende signalserverinnstillingene.",
    "URL of this omni365 instance" : "Nettadressen til denne omni365-forekomsten",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Du kan installere Matterbridge for å koble omni365 Talk til noen andre tjenester, besøk deres {linkstart1}GitHub-side{linkend} for mer informasjon. Det kan ta litt tid å laste ned og installere appen. I tilfelle det blir tidsavbrutt, kan du installere det manuelt fra {linkstart2}omni365 App Store {linkend}.",
    ...
    "Join conversations from remote omni365 servers" : "Bli med i samtaler fra eksterne omni365-servere",
    ...
    "Share from {omni365}" : "Del fra {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Bakgrunnsuskarphet for omni365-forekomst kan justeres i temainnstillingene.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Du ble med i samtalen i et annet vindu eller på en annen enhet. Dette støttes for øyeblikket ikke av omni365 Talk, så denne økten ble lukket.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Du prøver å bli med i en samtale mens du har en aktiv økt i et annet vindu eller en annen enhet. Dette støttes for øyeblikket ikke av omni365 Talk. Hva vil du gjøre?",
