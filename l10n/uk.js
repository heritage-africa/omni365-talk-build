OC.L10N.register(
    ...
    "Talk" : "Розмови",
    "Guest" : "Гість",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Ласкаво просимо до omni365 Talk!\nУ цій розмові ви дізнаєтесь про нові функції, доступні в omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Для реалізації ботів тепер доступні веб-хуки. Дивіться документацію для отримання додаткової інформації https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Представляємо десктопний клієнт omni365 Talk для Windows, macOS та Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Підсумовуйте записи дзвінків і непрочитані повідомлення в чатах за допомогою omni365 Assistant",
    ...
    "There is already a trial registered for this omni365 instance." : "Для цього примірника серверу хмари omni365 вже зареєстровано пробне використання.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** — це безпечна, самостійно розміщена комунікаційна платформа, яка безперешкодно інтегрується в екосистему omni365.\n\n#### Основні функції omni365 Talk:\n\n* Чат і обмін повідомленнями в приватних і групових чатах\n* Голосові та відеодзвінки\n* Обмін файлами та інтеграція з іншими додатками omni365\n* Налаштовувані параметри розмов, модерація та контроль конфіденційності\n* Веб, настільні та мобільні пристрої (iOS та Android)\n* Приватне та безпечне спілкування\n\nДізнайтеся більше в [документації для користувачів](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Ласкаво просимо до omni365 Talk\n\nomni365 Talk — це приватний і потужний месенджер, інтегрований із omni365. Чатуйте в приватних або групових розмовах, співпрацюйте за допомогою голосових і відеодзвінків, організовуйте вебінари та події, налаштовуйте свої розмови та багато іншого.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Форматування тексту для створення багатоформатних повідомлень\n\nУ omni365 Talk ви можете використовувати синтаксис Markdown для форматування своїх повідомлень. Наприклад, застосовувати **жирний** або *курсивний* шрифт, або `виділяти текст як код`. Ви навіть можете створювати таблиці та додавати заголовки до свого тексту.\n\nПотрібно виправити помилку або змінити форматування? Відредагуйте своє повідомлення, натиснувши «Редагувати повідомлення» в меню повідомлення.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Додавання вкладень та посилань\n\nДодавайте файли з omni365 Hub за допомогою кнопки «+». Діліться елементами з Files та різних додатків omni365. Деякі додатки навіть підтримують інтерактивні віджети, наприклад, додаток Text.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Робіть більше з Smart Picker\n\nПросто введіть «/» або перейдіть до меню «+», щоб відкрити Smart Picker, де ви можете додавати різний контент до своїх повідомлень. Ви можете налаштувати Smart Picker, щоб додавати елементи з додатків omni365, GIF-файли, місця на карті, контент, створений штучним інтелектом, та багато іншого.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Наполегливо рекомендується налаштувати кеш пам'яті під час запуску omni365 Talk з високопродуктивним бекендом.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Чат, відео- та аудіоконференції за допомогою WebRTC\n\n* 💬 **Чат** omni365 Talk має простий текстовий чат, що дозволяє ділитися або завантажувати файли з програми omni365 Files або локального пристрою та згадувати інших учасників.\n* 👥 **Приватні, групові, публічні та захищені паролем дзвінки!** Запросіть когось, цілу групу або надішліть публічне посилання, щоб запросити на дзвінок.\n* 🌐 **Федеративні чати** Чатуйте з іншими користувачами omni365 на їхніх серверах\n* 💻 **Спільний доступ до екрана!** Діліться своїм екраном з учасниками дзвінка.\n* 🚀 **Інтеграція з іншими додатками omni365**, такими як Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck та багатьма іншими.\n* 🌉 **Синхронізація з іншими чат-рішеннями** Завдяки інтеграції [Matterbridge](https://github.com/42wim/matterbridge/) у Talk ви можете легко синхронізувати багато інших чат-рішень із omni365 Talk і навпаки.",
    "Leave call" : "Вийти",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Наш партнер Struktur AG надає послугу, за допомогою якої можна замовити розміщення сервера сигналізації. Для цього вам потрібно лише заповнити форму нижче, і ваш omni365 надішле запит. Щойно сервер буде налаштовано для вас, облікові дані будуть заповнені автоматично. При цьому будуть перезаписані існуючі налаштування сервера сигналізації.",
    ...
    "URL of this omni365 instance" : "URL-адреса цього серверу хмари omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Ви можете встановити застосунок Matterbridge, щоб зв'язати omni365 Talk з деякими іншими сервісами, відвідайте їхню {linkstart1}GitHub-сторінку{linkend} для отримання додаткової інформації. Завантаження та встановлення застосунку може зайняти деякий час. Якщо час очікування минув, встановіть його вручну з {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Бінарний файл Matterbridge має неправильні дозволи. Переконайтеся, що бінарний файл Matterbridge належить правильному користувачеві і може бути виконаний. Його можна знайти в «/…/omni365/apps/talk_matterbridge/bin/».",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Помилка: Системний час сервера omni365 та сервера запису не синхронізований. Переконайтеся, що обидва сервери підключені до сервера часу, або вручну синхронізуйте їх час.",
    ...
    "omni365 base URL" : "URL-адреса бази omni365",
    ...
    "omni365 Talk setup not complete" : "NextНалаштування хмарної розмови не завершено",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Наполегливо рекомендується налаштувати розподілений кеш, якщо ви використовуєте omni365 Talk з високопродуктивним бекендом.",
    ...
    "Join conversations from remote omni365 servers" : "Приєднуйтесь до розмов з віддалених серверів omni365",
    ...
    "Replacement:" : "Заміна:",
    "Share from {omni365}" : "Поділіться з {omni365}",
    ...
    "Enable blur background by default for all conversations" : "Увімкнути розмиття фону за замовчуванням для всіх розмов",
    "Do not show the device preview screen before joining a call" : "Не показувати екран попереднього перегляду пристрою перед приєднанням до виклику",
    "Preview screen will still be shown if recording consent is required" : "Екран попереднього перегляду все одно буде показано, якщо потрібна згода на запис",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Розмиття фону для екземпляра omni365 можна налаштувати в налаштуваннях теми.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk оновлено, ви не можете розпочати або приєднатися до виклику.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Ви приєдналися до розмови в іншому вікні або на іншому пристрої. Наразі omni365 Talk не підтримує таку функцію, тому ця сесія була закрита.",
    ...
    "omni365 URL" : "URL-адреса наступної хмари",
    "omni365 user" : "Користувач omni365",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "Оновлений omni365 Talk.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Ви намагаєтеся приєднатися до розмови, маючи активну сесію в іншому вікні або на іншому пристрої. Наразі це не підтримується omni365 Talk. Що ви хочете зробити?",
    ...
    "omni365 is in maintenance mode." : "omni365 знаходиться в режимі технічного обслуговування.",
    "omni365 Talk Federation was updated." : "Оновлена omni365 Talk Federation.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Браузер, який ви використовуєте, не повністю підтримується omni365 Talk. Будь ласка, використовуйте останню версію Mozilla Firefox, Microsoft Edge, Google Chrome, Opera або Apple Safari.",
