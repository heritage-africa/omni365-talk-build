OC.L10N.register(
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chat, video & audio-konference ved anvendelse af WebRTC\n\n* 💬 **Chat** omni365 Snak kommer med en simpel tekst chat, der giver dig mulighed for at dele eller uploade filer fra din omni365 filer app eller lokale apparatog nævne andre deltagere.\n* 👥 **Privat, gruppe, offentlig og adgangskodebeskyttede opkald!** Inviter nogen, en hel gruppe eller send et offentligt link for at invitere til et opkald.\n* 🌐 **Sammenkoblede chats** Chat med andre omni365 brugere på deres servere\n* 💻 **Skærmdeling!** Del din skærm med deltagerne i dit opkald.\n* 🚀 **Integration med andre omni365 apps** såsom filer, kalender, Brugerstatus, Opslagstavle, Flow, Kort, Smart vælger, Kontakter, Opslag, og meget mere.\n* 🌉 **Synk med andre chatløsninger** Med [Matterbridge](https://github.com/42wim/matterbridge/) integreret i Snak, kan du let synkronisere mange andre chat løsninger med omni365 Snak og vice-versa.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Snak blev opdateret, du kan ikke starte eller deltage i et opkald.",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Snak blev opdateret.",
    ...
    "omni365 is in maintenance mode." : "omni365 er i vedligeholdelsestilstand.",
    "omni365 Talk Federation was updated." : "omni365 Snak Sammenkobling blev opdateret.",
