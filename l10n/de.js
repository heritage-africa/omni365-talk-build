OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Gast",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Willkommen bei omni365 Talk!\nDiese Unterhaltung informiert über neue Funktionen in omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "– Zur Implementierung von Bots stehen jetzt Webhooks zur Verfügung. Weitere Informationen findest du in der Dokumentation: https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Mehr tun mit Smart Picker\n\nGib einfach \"/\" ein oder wähle das Menü \"+\", um den Smart Picker zu öffnen, mit dem du verschiedene Inhalte an deine Nachrichten anhängen kannst. Du kannst den Smart Picker so konfigurieren, dass du Elemente aus omni365-Apps, GIFs, Kartenpositionen, KI-generierte Inhalte und vieles mehr hinzufügen kannst.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Fehler: Die Systemzeiten des omni365-Servers und des Hochleistungs-Backend-Servers sind nicht synchron. Bitte stelle sicher, dass beide Server mit einem Zeitserver verbunden sind oder synchronisiere ihre Zeit manuell.",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Fehler: Die Systemzeiten des omni365-Servers und des Aufnahme-Backend-Servers sind nicht synchron. Bitte sicherstellen, dass beide Server mit einem Zeitserver verbunden sind oder synchronisiere die Zeit manuell.",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Es wird dringend empfohlen, einen verteilten Cache einzurichten, wenn du omni365 Talk mit einem Hochleistungs-Backend verwendest.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk wurde aktualisiert. Du kannst keinen Anruf starten oder beitreten.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Du bist der Unterhaltung in einem anderen Fenster oder Gerät beigetreten. Dies wird derzeit von omni365 Talk nicht unterstützt, daher wurde diese Sitzung geschlossen.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Du versuchst, an einer Unterhaltung teilzunehmen, während du in einem anderen Fenster oder Gerät eine aktive Sitzung hast. Dies wird derzeit von omni365 Talk nicht unterstützt. Was möchtest du tun?",
