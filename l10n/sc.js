OC.L10N.register(
    ...
    "There is already a trial registered for this omni365 instance." : "B'at giai una versione de proa registrada pro custa istàntzia de omni365.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Su partner nostru Struktur AG frunit unu servìtziu in ue si podet pedire unu serbidore de signalatzione retzidu. Bastat a compilare su mòdulu a suta e omni365 dd'at a pedire pro tue. Una borta chi su serbidore est cunfiguradu, is credentziales s'ant a compilare de manera automàtica. Custu at a subriscrìere sa cunfiguratzione esistente de su serbidore de signalatzione.",
    "URL of this omni365 instance" : "URL de custa istàntzia omni365",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "As fatu s'atzessu in sa resonada in un'àtera ventana o dispositivu. In custu momentu cust'atzione no est suportada dae omni365 Talk tando sa sessione est istada serrada.",
    "Join a conversation or start a new one" : "Intra in una resonada o cumintza•nde una noa",
    "omni365 URL" : "URL de omni365",
    "omni365 user" : "Utente de omni365",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Ses proende a intrare in una resonada cun una sessione ativa in un'àtera ventana o dispositivu. In custu momentu cust'atzione no est suportada dae omni365 Talk. Ite boles fàghere?",
