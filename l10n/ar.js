OC.L10N.register(
    ...
    "Talk" : "التحدث",
    "Guest" : "ضيف",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## مرحبًا بك في تطبيق \"المحادثة\" Talk من نكست كلاود! \nفي هذه المحادثة، سيتم إخطارك بالميزات الجديدة المتوفرة في التطبيق.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- خطافات الويب Webhooks متاحة الآن لتطبيق الروبوتات bot. لمزيد المعلومات، أنظر التوثيق في: https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- تقديم تطبيق نكست كلاود للمحادثة على سطح المكتب لنظم وندوز، و ماك، و لينكس: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- تلخيص تسجيلات المكالمات والرسائل غير المقروءة في الدردشات باستخدام \"مساعد\" نكست كلاود.",
    ...
    "There is already a trial registered for this omni365 instance." : "توجد بالفعل نسخة تجريبية مسجلة لمثيل نكست كلاود هذا.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ افعل المزيد باستخدام \"اللاقط الذكي\" Smart Picker \n\nما عليك سوى كتابة \"/\" أو الانتقال إلى قائمة \"+\" لفتح \"اللاقط الذكي\"؛ حيث يمكنك إرفاق محتوىً متنوع مع رسائلك. يمكنك تهيئة اللاقط الذكي لتتمكن من إضافة عناصر من تطبيقات نكست كلاود وصور GIF ومواقع الخرائط والمحتوى الذي تم إنشاؤه بواسطة الذكاء الاصطناعي وغير ذلك كثير.",
    ...
    "Could not check for WASM loading support. Please check manually if your web server serves `.wasm` files." : "تعذر التحقُّق من دعم تحميل WASM. يرجى التحقق يدويًا مما إذا كان خادوم الويب لديك يتعامل مع ملفات `.wasm`.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "يوصى بشدة بتهيئة ذاكرة تخزين مؤقت cache عند تشغيل تطبيق \"المحادثة\" Talk في نكست كلاود بواجهة خلفية عالية الأداء .",
    ...
    "{notify_push} is not installed, this might lead to performance issues when using desktop clients." : "{notify_push} غير مُثبَّت. هذا قد يتسبب في مشاكل في الأداء عند استعمال عملاء سطح المكتب.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "يوفر شريكنا Struktur AG خدمة حيث يمكن طلب خادم التشوير المستضاف. لهذا ما عليك سوى ملء النموذج أدناه وسيطلبه نكست كلاود الخاص بك. وبمجرد تعيين الخادم لك، سيتم ملء بيانات الاعتماد تلقائيًا. سيؤدي هذا إلى الكتابة فوق إعدادات خادم التشوير الحالي.",
    "URL of this omni365 instance" : "الرابط لهذا الخادم السحابي نكست كلاود",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "يمكنك تثبيت Matterbridge لربط omni365 Talk ببعض الخدمات الأخرى ، قم بزيارة {linkstart1} صفحة جيت هب {linkend} الخاصة بهم لمزيد من التفاصيل. قد يستغرق تنزيل التطبيق وتثبيته بعض الوقت. في حالة انتهاء المهلة، يرجى تثبيته يدويًا من {linkstart2} متجر تطبيقات نكست كلود {linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "كود \"ماتر بريدج\" Matterbridge binary لايملك الأذونات الصحيحة المطلوبة. رجاءً، تأكد من أن المستخدِم مالك ملف كود \"ماتر بريدج\" Matterbridge binary يحمل الصلاحيات اللازمة بحيث يمكن تنفيذه. يمكن إيجاده في: \"/…/omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "خطأ: أوقات النظام لخادوم نكست كلاود وخادوم التسجيل الصوتي للمكالمات في الخلفية غير متزامنة. يرجى التأكد من أن كلا الخادومين متصلان بخادوم توقيت موحد أو قم  بمزامنة وقتيهما يدوياً.",
    ...
    "omni365 base URL" : "عنوان URL الأساسي لنكست كلاود",
    ...
    "Error: Websocket connection failed. Check browser console" : "خطأ: فشل الاتصال عن طريق \"مقبس الوب\" WebSocket. أنظُر طَرَفِيّة المُتصَفِّح browser console",
    ...
    "omni365 Talk setup not complete" : "تهيئة \"المحادثة\" Talk من نكست كلاود لم تكتمل بعدُ.",
    ...
    "omni365 portal" : "بوابة نكست كلاود",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "يوصى بشدة بإعداد ذاكرة تخزين مؤقتة موزعة distriburted cache عند استخدام \"المحادثة\" Talk من نكست كلاود مع خلفية للأداء العالي.",
    ...
    "Important conversation" : "محادثة مهمة",
    ...
    "Browse" : "تصفُّح",
    "Verifying uploaded file …" : "التحقُّق من الملفات المرفوعة جارٍ ...",
    ...
    "Join conversations from remote omni365 servers" : "الانضمام إلى المحادثة من خوادم بعيدة لنكست كلاود",
    ...
    "Generate summary" : "توليد مُلخَّص",
    ...
    "Poll" : "استبيان",
    "Edit poll draft" : "تحرير مُسوَّدة التصويت",
    ...
    "Replacement:" : "البديل:",
    "Share from {omni365}" : "مشاركة من {omni365}",
    ...
    "Summary is AI generated and might contain mistakes" : "المُلخَّص يتم توليده بالذكاء الاصطناعي و يمكن أن يحتوي على أخطاء",
    "Error occurred during a summary generation" : "حدث خطأ أثناء توليد المُلخَّص",
    "New file" : "ملف جديد",
    "Blank" : "فارغ",
    ...
    "Calls without High-performance backend can cause connectivity issues and high load on devices. {linkstart}Learn more{linkend}" : " المكالمات بدون استعمال خلفية للأداء العالي تتسبب في إشكاليات في الاتصال و حمل زائد على الأجهزة. {linkstart}تعلَّم المزيد {linkend}",
    ...
    "Turn off camera and microphone by default when joining a call" : "عطِّل عمل الكاميرات و لاقط الصوت بشكل تلقائي كلما انضممت إلى مكالمة",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "تضبيب الخلفية في نكست كلاود يمكن ضبطه من خلال إعدادات السمات",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "تمّ تحديث \"المحادثة\" من نكست كلاود. لايمكنك البدء في أو الانضمام إلى محادثة.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "انضممت لمحادثة آخرى في نافذة او جهاز آخر. هذه الخاصية غير مدعومة سيتم اغلاق هذه الجلسة من قبل نكست كلاود التحدث.",
    ...
    "omni365 URL" : "رابط الخادم السحابي نكست كلاود",
    "omni365 user" : "عضو نكست كلاود",
    ...
    "omni365 Talk was updated." : "تمّ تحديث \"المحادثة\" من نكست كلاود.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "انضممت لمحادثة آخرى في نافذة او جهاز آخر. هذه الخاصية غير مدعومة سيتم اغلاق هذه الجلسة من قبل نكست كلاود التحدث. ماذا تريد ان تفعل؟",
    ...
    "omni365 is in maintenance mode." : "نكست كلاود في وضعية الصيانة.",
    "omni365 Talk Federation was updated." : "تمّ تحديث \"المحادثة الاتحادية\" Talk Federation من نكست كلاود.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "تستخدم متصفح غير مدعوم بالكامل من قبل نكست كلاود التحدث. استخدم اخر اصدار من فايرفوكس، مايكروسوفت ادج، قوقل كروم أو ابل سفاري.",
