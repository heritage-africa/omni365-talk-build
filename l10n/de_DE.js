OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Gast",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Willkommen zu omni365 Talk!\nIn dieser Unterhaltung werden Sie über neue Funktionen in omni365 Talk informiert.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "– Zur Implementierung von Bots stehen jetzt Webhooks zur Verfügung. Weitere Informationen finden Sie in der Dokumentation: https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Wir stellen den omni365 Talk Desktop-Client für Windows, macOS und Linux vor: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Zusammenfassung von Anrufaufzeichnungen und ungelesenen Nachrichten in Chats mit dem omni365 Assistant",
    ...
    "There is already a trial registered for this omni365 instance." : "Für diese omni365-Instanz ist bereits eine Trial-Testversion registriert.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Talk** ist eine sichere, selbst gehostete Kommunikationsplattform, die sich nahtlos in das omni365-Ökosystem integriert.\n\n#### Hauptmerkmale von omni365 Talk:\n\n* Chat und Messaging in privaten und Gruppenchats\n* Sprach- und Videoanrufe\n* Dateifreigabe und Integration mit anderen omni365-Apps\n* Anpassbare Gesprächseinstellungen, Moderation und Datenschutzkontrollen\n* Web, Desktop und Mobile (iOS und Android)\n* Private & sichere Kommunikation\n\n Erfahren Sie mehr in der [Benutzerdokumentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Willkommen bei omni365 Talk\n\nomni365 Talk ist eine private und leistungsstarke Messaging-App, die mit omni365 integriert ist. Chatten Sie in privaten oder Gruppenunterhaltungen, arbeiten Sie über Sprach- und Videoanrufe zusammen, organisieren Sie Webinare und Veranstaltungen, passen Sie Ihre Unterhaltungen an und vieles mehr.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Texte formatieren, um aussagekräftige Nachrichten zu erstellen\n\nIn omni365 Talk können Sie die Markdown-Syntax verwenden, um Ihre Nachrichten zu formatieren. Sie können zum Beispiel **fett** oder *kursiv* formatieren oder `Texte als Code hervorheben`. Sie können sogar Tabellen erstellen und Überschriften zu Ihrem Text hinzufügen.\n\nMöchten Sie einen Tippfehler korrigieren oder die Formatierung ändern? Bearbeiten Sie Ihre Nachricht, indem Sie im Nachrichtenmenü auf \"Nachricht bearbeiten\" klicken.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Anhänge und Links hinzufügen\n\nFügen Sie Dateien aus Ihrem omni365 Hub über die Schaltfläche \"+\" hinzu. Teilen Sie Elemente aus Dateien und verschiedenen omni365-Apps. Einige Apps unterstützen sogar interaktive Widgets, z. B. die Text-App.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Mehr tun mit Smart Picker\n\nGeben Sie einfach \"/\" ein oder wählen Sie das Menü \"+\", um den Smart Picker zu öffnen, mit dem Sie verschiedene Inhalte an Ihre Nachrichten anhängen können. Sie können den Smart Picker so konfigurieren, dass Sie Elemente aus omni365-Apps, GIFs, Kartenpositionen, KI-generierte Inhalte und vieles mehr hinzufügen können.",
    ...
    "Error: System times of omni365 server and High-performance backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Fehler: Die Systemzeiten des omni365-Servers und des Hochleistungs-Backend-Servers sind nicht synchron. Bitte stellen Sie sicher, dass beide Server mit einem Zeitserver verbunden sind oder synchronisieren Sie ihre Zeit manuell.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Es wird dringend empfohlen, einen Speichercache zu konfigurieren, wenn omni365 Talk mit einem Hochleistungs-Backend ausgeführt wird.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Chat, Video- und Audiokonferenzen mit WebRTC\n\n* 💬 **Chat** omni365 Talk verfügt über einen einfachen Text-Chat, in dem Sie Dateien über Ihre omni365 Dateien-App oder Ihr lokales Gerät teilen oder hochladen und andere Teilnehmer erwähnen können.\n* 👥 **Private, Gruppen-, öffentliche und passwortgeschützte Anrufe!** Laden Sie jemanden oder eine ganze Gruppe ein oder senden Sie einen öffentlichen Link, um zu einem Anruf einzuladen.\n* 🌐 **Federated-Chats** Chatten Sie mit anderen omni365-Benutzern über deren Server\n* 💻 **Bildschirmfreigabe!** Teilen Sie Ihren Bildschirm mit den Teilnehmern Ihrer Unterhaltung.\n* 🚀 **Integration mit anderen omni365-Apps** wie Dateien, Kalender, Benutzerstatus, Dashboard, Flow, Karten, Smart Picker, Kontakte, Deck und viele mehr.\n* 🌉 **Mit anderen Chat-Lösungen synchronisieren** Durch die Integration von [Matterbridge](https://github.com/42wim/matterbridge/) in Talk können Sie viele andere Chat-Lösungen ganz einfach mit omni365 Talk und umgekehrt synchronisieren.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Unser Partner Struktur AG bietet einen Dienst an, bei dem ein gehosteter Signalisierungsserver angefordert werden kann. Dazu brauchen Sie nur das untenstehende Formular auszufüllen und Ihre omni365 wird ihn anfordern. Sobald der Server für Sie eingerichtet ist, werden die Anmeldedaten automatisch ausgefüllt. Dadurch werden die bestehenden Einstellungen des Signalisierungsservers überschrieben.",
    ...
    "URL of this omni365 instance" : "URL dieser omni365-Installation",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Sie können Matterbridge installieren, um omni365 Talk mit einigen anderen Diensten zu verlinken. Besuchen Sie deren {linkstart1}GitHub-Seite{linkend} für weitere Details. Das Herunterladen und Installieren der App kann eine Weile dauern. Falls die Zeit überschritten wird, installieren Sie sie bitte manuell über den {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Die Matterbridge-Binärdatei hat falsche Berechtigungen. Bitte sicher stellen, dass die Matterbridge-Binärdatei dem richtigen Benutzer gehört und ausgeführt werden kann. Sie befindet sich unter \"/.../omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Fehler: Die Systemzeiten des omni365-Servers und des Aufzeichnungs-Backend-Servers sind nicht synchron. Bitte stellen Sie sicher, dass beide Server mit einem Zeitserver verbunden sind oder synchronisieren Sie ihre Zeit manuell.",
    ...
    "omni365 base URL" : "omni365-Basis-URL",
    ...
    "omni365 Talk setup not complete" : "Einrichtung von omni365 Talk nicht abgeschlossen",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Es wird dringend empfohlen, einen verteilten Cache einzurichten, wenn Sie omni365 Talk mit einem Hochleistungs-Backend verwenden.",
    ...
    "Join conversations from remote omni365 servers" : "Unterhaltungen von entfernten omni365-Servern beitreten",
    ...
    "Replacement:" : "Ersatz:",
    "Share from {omni365}" : "Von {omni365} teilen",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Die Hintergrundunschärfe für die omni365-Instanz kann in den Designeinstellungen angepasst werden.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Talk wurde aktualisiert. Sie können keinen Anruf starten oder beitreten.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Sie sind der Unterhaltung in einem anderen Fenster oder Gerät beigetreten. Dies wird derzeit von omni365 Talk nicht unterstützt, daher wurde diese Sitzung geschlossen.",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Talk wurde aktualisiert.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Sie versuchen, an einer Unterhaltung teilzunehmen, während Sie in einem anderen Fenster oder Gerät eine aktive Sitzung haben. Dies wird derzeit von omni365 Talk nicht unterstützt. Was möchten Sie tun?",
    ...
    "omni365 is in maintenance mode." : "omni365 befindet sich im Wartungsmodus.",
    "omni365 Talk Federation was updated." : "omni365 Talk Federation wurde aktualisiert.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Der von Ihnen verwendete Browser wird von omni365 Talk nicht vollständig unterstützt. Bitte verwenden Sie die neueste Version von Mozilla Firefox, Microsoft Edge, Google Chrome, Opera oder Apple Safari.",
