OC.L10N.register(
    ...
    "Talk" : "Konuş",
    "Guest" : "Konuk",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## omni365 Konuş uygulamasına hoş geldiniz!\nBu görüşmede yeni omni365 Konuş özellikleri hakkında bilgilendirileceksiniz.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- İnternet kancaları artık botları uygulamak için kullanılabilir. Ayrıntılı bilgi almak için https://omni365-talk.readthedocs.io/en/latest/bot-list/ adresine bakabilirsiniz",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Windows, macOS ve Linux için omni365 Konuş bilgisayar istemcisini sunarız: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- omni365 Yardımcı ile sohbetlerdeki çağrı kayıtlarını ve okunmamış iletileri özetleyin",
    ...
    "There is already a trial registered for this omni365 instance." : "Bu omni365 kopyası için zaten bir deneme kaydı var.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**omni365 Konuş**, omni365 ekosistemiyle sorunsuz bir şekilde bütünleşen güvenli, özel barındırılan bir iletişim platformudur.\n\n#### omni365 Konuş Temel Özellikleri:\n\n* Özel ve grup sohbetlerinde sohbet etme ve ileti gönderme\n* Sesli ve görüntülü aramalar\n* Diğer omni365 uygulamalarıyla dosya paylaşımı ve bütünleştirme\n* Özelleştirilebilir görüşme ayarları, yönetim ve gizlilik denetimleri\n* İnternet, bilgisayar ve mobil (iOS ve Android)\n* Gizli ve güvenli iletişim\n\nAyrıntılı bilgi almak için [kullanıcı belgelerine](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html) bakın.",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# omni365 Konuş Uygulamasına Hoş Geldiniz\n\nomni365 Konuş, omni365 ile bütünleşik gizli ve güçlü bir iletişim uygulamasıdır. Kişisel veya grup görüşmelerinde sohbet edin, sesli ve görüntülü görüşmelerde işbirliği yapın, internet toplantıları ve etkinlikler düzenleyin, görüşmelerinizi gizli tutun ve diğer şeyleri yapın.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Zengin iletiler oluşturmak için yazıları biçimlendirin\n\nomni365 Konuş uygulamasında iletilerinizi biçimlendirmek için Markdown sözdizimini kullanabilirsiniz. Örneğin, **koyu** veya *yatık* biçimlendirme uygulayın veya `yazıları kod olarak vurgulayın`. Hatta yazınızda tablolar oluşturabilir ve başlıklar ekleyebilirsiniz.\n\nBir yazım yanlışını düzeltmeniz veya biçimlendirmeyi değiştirmeniz mi gerekiyor? İleti menüsünde \"İletiyi düzenle\" üzerine tıklayarak iletinizi düzenleyin.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Dosyalar ve bağlantılar ekleyin\n\n\"+\" düğmesini kullanarak omni365 Merkez üzerinden dosyalar ekleyin. Dosyalar ve çeşitli omni365 uygulamalarından ögeler paylaşın. Bazı uygulamalar, örneğin Yazı uygulaması, etkileşimli pano bileşenlerini bile destekler.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "omni365 Konuş yüksek başarımlı bir arka yüzde çalıştırılırken, bir bellek ön belleği yapılandırmanız önemle önerilir.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "WebRTC ile sohbet, görüntülü ve sesli görüşme\n\n* 💬 **Sohbet** omni365 Konuş üzerinde, omni365 Dosyalar uygulamanızdan veya yerel aygıtınızdan dosya paylaşmanızı veya yüklemenizi ve diğer katılımcıları anmanızı sağlayan basit bir yazı sohbeti uygulaması bulunur.\n* 👥 **Özel, gruba, herkese açık ve şifre korumalı çağrılar!** Bir kişiyi ya da tüm grubu davet edin veya bir bağlantı ile herkesin çağrıya katılmasını sağlayın.\n* 🌐 **Birleşik sohbetler** Diğer omni365 sunucularındaki kullanıcılarla sohbet edin\n* 💻 **Ekran paylaşımı!** Ekranınızı görüşmenizin katılımcılarıyla paylaşın.\n* 🚀 **Dosyalar, Takvim, Kullanıcı durumu, Pano, Akış, Haritalar, Akıllı seçici, Kişiler, Deck ve diğer omni365 uygulamalarıyla bütünleşik**.\n* 🌉 **Diğer sohbet çözümleriyle eşitleme** [Matterbridge](https://github.com/42wim/matterbridge/) Konuş uygulaması ile bütünleştirildiğinde, diğer birçok sohbet çözümünü omni365 Konuş ile kolayca eşitleyebilirsiniz.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "İş ortağımız Struktur AG, barındırılan bir signaling sunucusu isteğinde bulunabileceğiniz bir hizmet sunuyor. Bunun için aşağıdaki formu doldurmanız yeterlidir. omni365 kopyanız istekte bulunur. Sunucu kurulduktan sonra kimlik doğrulama bilgileri otomatik olarak doldurulur. Bu işlem var olan signaling sunucusu ayarlarının üzerine yazar.",
    ...
    "URL of this omni365 instance" : "Bu omni365 kopyasının adresi",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "omni365 Konuş ile diğer hizmetleri bağlamak için Matterbridge kurabilirsiniz. Ayrıntılı bilgi almak için Matterbridge {linkstart1}GitHub sayfasına{linkend} bakabilirsiniz. Uygulamanın indirilip kurulması biraz zaman alabilir. İşlem zaman aşımına uğrarsa {linkstart2}omni365 uygulama mağazasından{linkend} el ile kurun.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Matterbridge yürütülebilir dosyasının izinleri doğru değil. Lütfen Matterbridge yürütülebilir dosyasının sahibinin doğru kullanıcı olduğundan ve yürütülebilir olduğundan emin olun. Bu dosya \"/…/omni365/apps/talk_matterbridge/bin/\" klasöründe bulunur.",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Hata: omni365 sunucusunun ve kayıt arka yüzü sunucusunun sistem saatleri aynı değil. Lütfen her iki sunucunun da bir zaman sunucusuna bağlı olduğundan emin olun ya da saatlerini el ile eşitleyin.",
    ...
    "omni365 base URL" : "Temel omni365 adresi",
    ...
    "omni365 Talk setup not complete" : "omni365 Konuş kurulumu tamamlanmamış",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "omni365 Konuş uygulamasını yüksek başarımlı bir arka yüz ile kullanırken dağıtılmış bir ön bellek kurmanız önemle önerilir.",
    ...
    "Join conversations from remote omni365 servers" : "Uzak omni365 sunucularındaki görüşmelere katıl",
    ...
    "Replacement:" : "Yedek:",
    "Share from {omni365}" : "{omni365} üzerinden paylaş",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "omni365 kopyası için arka plan bulanıklığı tema ayarlarından yapılabilir.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "omni365 Konuş güncellenmiş. Bir çağrı başlatamaz ya da katılamazsınız.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Görüşmeye başka bir pencereden ya da aygıttan da katılmışsınız. omni365 Konuş henüz bu özelliği desteklemediği için bu oturum kapatılacak.",
    ...
    "omni365 URL" : "omni365 adresi",
    "omni365 user" : "omni365 kullanıcısı",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "omni365 Konuş güncellenmiş.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Başka bir pencereden ya da aygıttan da katıldığınız görüşmeye yeniden katılmaya çalışıyorsunuz. omni365 Konuş henüz bu özelliği desteklemiyor. Ne yapmak istersiniz?",
