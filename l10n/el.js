OC.L10N.register(
    ...
    "Talk" : "Talk",
    "Guest" : "Επισκέπτης",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Καλώς ήρθατε στο omni365 Talk!\nΣε αυτή τη συνομιλία θα ενημερώνεστε για νέες λειτουργίες που είναι διαθέσιμες στο omni365 Talk.",
    ...
    "- Webhooks are now available to implement bots. See the documentation for more information https://omni365-talk.readthedocs.io/en/latest/bot-list/" : "- Τα Webhooks είναι τώρα διαθέσιμα για την υλοποίηση bots. Δείτε την τεκμηρίωση για περισσότερες πληροφορίες https://omni365-talk.readthedocs.io/en/latest/bot-list/",
    ...
    "- Introducing the omni365 Talk desktop client for Windows, macOS and Linux: %s" : "- Παρουσίαση του πελάτη επιφάνειας εργασίας omni365 Talk για Windows, macOS και Linux: %s",
    "- Summarize call recordings and unread messages in chats with the omni365 Assistant" : "- Σύνοψη εγγραφών κλήσεων και μη αναγνωσμένων μηνυμάτων σε συνομιλίες με τον Βοηθό omni365",
    ...
    "There is already a trial registered for this omni365 instance." : "Υπάρχει ήδη μια δοκιμαστική καταχώριση για αυτήν την περίπτωση του omni365.",
    ...
    "**omni365 Talk** is a secure, self-hosted communication platform that integrates seamlessly with the omni365 ecosystem.\n\n#### Key Features of omni365 Talk:\n\n* Chat and messaging in private and group chats\n* Voice and video calls\n* File sharing and integration with other omni365 apps\n* Customizable conversation settings, moderation and privacy controls\n* Web, desktop and mobile (iOS and Android)\n* Private & secure communication\n\n Find out more in the [user documentation](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html)." : "**Το omni365 Talk** είναι μια ασφαλής, αυτο-φιλοξενούμενη πλατφόρμα επικοινωνίας που ενσωματώνεται απρόσκοπτα με το οικοσύστημα omni365.\n\n#### Βασικά Χαρακτηριστικά του omni365 Talk:\n\n* Συνομιλία και ανταλλαγή μηνυμάτων σε ιδιωτικές και ομαδικές συνομιλίες\n* Κλήσεις φωνής και βίντεο\n* Κοινή χρήση αρχείων και ενσωμάτωση με άλλες εφαρμογές omni365\n* Προσαρμόσιμες ρυθμίσεις συνομιλιών, συντονισμός και έλεγχος απορρήτου\n* Web, επιφάνεια εργασίας και κινητό (iOS και Android)\n* Ιδιωτική & ασφαλής επικοινωνία\n\n Μάθετε περισσότερα στην [τεκμηρίωση χρήστη](https://docs.omni365.com/server/latest/user_manual/en/talk/index.html).",
    "# Welcome to omni365 Talk\n\nomni365 Talk is a private and powerful messaging app that integrates with omni365. Chat in private or group conversations, collaborate over voice and video calls, organize webinars and events, customize your conversations and more." : "# Καλώς ήρθατε στο omni365 Talk\n\nΤο omni365 Talk είναι μια ιδιωτική και ισχυρή εφαρμογή ανταλλαγής μηνυμάτων που ενσωματώνεται με το omni365. Συνομιλήστε σε ιδιωτικές ή ομαδικές συνομιλίες, συνεργαστείτε μέσω κλήσεων φωνής και βίντεο, οργανώστε webinars και εκδηλώσεις, προσαρμόστε τις συνομιλίες σας και πολλά άλλα.",
    "## 🎨 Format texts to create rich messages\n\nIn omni365 Talk, you can use Markdown syntax to format your messages. For example, apply **bold** or *italic* formatting, or `highlight texts as code`. You can even create tables and add headings to your text.\n\nNeed to fix a typo or change formatting? Edit your message by clicking \"Edit message\" in the message menu." : "## 🎨 Μορφοποιήστε κείμενα για να δημιουργήσετε πλούσια μηνύματα\n\nΣτο omni365 Talk, μπορείτε να χρησιμοποιήσετε σύνταξη Markdown για να μορφοποιήσετε τα μηνύματά σας. Για παράδειγμα, εφαρμόστε **έντονη** ή *πλάγια* μορφοποίηση, ή `επισημάνετε κείμενα ως κώδικα`. Μπορείτε ακόμα να δημιουργήσετε πίνακες και να προσθέσετε επικεφαλίδες στο κείμενό σας.\n\nΧρειάζεται να διορθώσετε ένα ορθογραφικό λάθος ή να αλλάξετε τη μορφοποίηση; Επεξεργαστείτε το μήνυμά σας κάνοντας κλικ στο \"Επεξεργασία μηνύματος\" στο μενού μηνύματος.",
    "## 🔗 Add attachments and links\n\nAttach files from your omni365 Hub using the \"+\" button. Share items from Files and various omni365 apps. Some apps even support interactive widgets, for example, the Text app." : "## 🔗 Προσθέστε συνημμένα και συνδέσμους\n\nΕπισυνάψτε αρχεία από το omni365 Hub σας χρησιμοποιώντας το κουμπί \"+\". Μοιραστείτε στοιχεία από τα Αρχεία και διάφορες εφαρμογές omni365. Ορισμένες εφαρμογές υποστηρίζουν ακόμα και διαδραστικά widgets, για παράδειγμα, η εφαρμογή Κείμενο.",
    ...
    "## ✨ Do more with Smart Picker\n\nSimply type \"/\" or go to the \"+\" menu to open the Smart Picker where you can attach various content to your messages. You can configure the Smart Picker to be able to add items from omni365 apps, GIFs, map locations, AI generated content and much more." : "## ✨ Κάντε περισσότερα με τον Έξυπνο Επιλογέα\n\nΑπλώς πληκτρολογήστε \"/\" ή μεταβείτε στο μενού \"+\" για να ανοίξετε τον Έξυπνο Επιλογέα όπου μπορείτε να επισυνάψετε διάφορο περιεχόμενο στα μηνύματά σας. Μπορείτε να ρυθμίσετε τον Έξυπνο Επιλογέα για να μπορείτε να προσθέτετε στοιχεία από εφαρμογές omni365, GIFs, τοποθεσίες χαρτών, περιεχόμενο που δημιουργήθηκε από ΤΝ και πολλά άλλα.",
    ...
    "It is highly recommended to configure a memory cache when running omni365 Talk with a High-performance backend." : "Συνιστάται ιδιαίτερα η ρύθμιση μιας μνήμης cache όταν εκτελείτε το omni365 Talk με ένα backend υψηλής απόδοσης.",
    ...
    "Chat, video & audio-conferencing using WebRTC\n\n* 💬 **Chat** omni365 Talk comes with a simple text chat, allowing you to share or upload files from your omni365 Files app or local device and mention other participants.\n* 👥 **Private, group, public and password protected calls!** Invite someone, a whole group or send a public link to invite to a call.\n* 🌐 **Federated chats** Chat with other omni365 users on their servers\n* 💻 **Screen sharing!** Share your screen with the participants of your call.\n* 🚀 **Integration with other omni365 apps** like Files, Calendar, User status, Dashboard, Flow, Maps, Smart picker, Contacts, Deck, and many more.\n* 🌉 **Sync with other chat solutions** With [Matterbridge](https://github.com/42wim/matterbridge/) being integrated in Talk, you can easily sync a lot of other chat solutions to omni365 Talk and vice-versa." : "Συνομιλία, βίντεο & διάσκεψη ήχου χρησιμοποιώντας WebRTC\n\n* 💬 **Συνομιλία** Το omni365 Talk έρχεται με μια απλή συνομιλία κειμένου, επιτρέποντάς σας να μοιραστείτε ή να μεταφορτώσετε αρχεία από την εφαρμογή omni365 Files ή την τοπική συσκευή σας και να αναφέρετε άλλους συμμετέχοντες.\n* 👥 **Ιδιωτικές, ομαδικές, δημόσιες και κωδικοπροστατευμένες κλήσεις!** Προσκαλέστε κάποιον, μια ολόκληρη ομάδα ή στείλτε έναν δημόσιο σύνδεσμο για πρόσκληση σε κλήση.\n* 🌐 **Federated συνομιλίες** Συνομιλήστε με άλλους χρήστες omni365 στους διακομιστές τους\n* 💻 **Κοινή χρήση οθόνης!** Μοιραστείτε την οθόνη σας με τους συμμετέχοντες της κλήσης σας.\n* 🚀 **Ενσωμάτωση με άλλες εφαρμογές omni365** όπως Αρχεία, Ημερολόγιο, Κατάσταση χρήστη, Πίνακας ελέγχου, Flow, Χάρτες, Έξυπνος επιλογέας, Επαφές, Deck, και πολλά άλλα.\n* 🌉 **Συγχρονισμός με άλλες λύσεις συνομιλιών** Με το [Matterbridge](https://github.com/42wim/matterbridge/) να είναι ενσωματωμένο στο Talk, μπορείτε εύκολα να συγχρονίσετε πολλές άλλες λύσεις συνομιλιών με το omni365 Talk και αντίστροφα.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Ο συνεργάτης μας Struktur AG παρέχει μια υπηρεσία όπου μπορεί να ζητηθεί ένας φιλοξενούμενος διακομιστής σηματοδότησης. Για αυτό πρέπει να συμπληρώσετε μόνο την παρακάτω φόρμα και το omni365 θα το ζητήσει. Μόλις ο διακομιστής ρυθμιστεί για εσάς, τα διαπιστευτήρια θα συμπληρωθούν αυτόματα. Αυτό θα αντικαταστήσει τις υπάρχουσες ρυθμίσεις διακομιστή σηματοδότησης.",
    ...
    "URL of this omni365 instance" : "Διεύθυνση URL αυτής της εγκατάστασης omni365",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Μπορείτε να εγκαταστήσετε το Matterbridge για να συνδέσετε το omni365 Talk με άλλες υπηρεσίες, επισκεφτείτε τη {linkstart1}σελίδα GitHub{linkend} τους για περισσότερες λεπτομέρειες. Η λήψη και η εγκατάσταση της εφαρμογής μπορεί να πάρει λίγο χρόνο. Σε περίπτωση που λήξει το χρονικό όριο, παρακαλώ εγκαταστήστε το χειροκίνητα από το {linkstart2}omni365 App Store{linkend}.",
    "Matterbridge binary has incorrect permissions. Please make sure the Matterbridge binary file is owned by the correct user and can be executed. It can be found in \"/…/omni365/apps/talk_matterbridge/bin/\"." : "Το δυαδικό Matterbridge έχει εσφαλμένα δικαιώματα. Παρακαλώ βεβαιωθείτε ότι το δυαδικό αρχείο Matterbridge ανήκει στον σωστό χρήστη και μπορεί να εκτελεστεί. Μπορεί να βρεθεί στο \"/…/omni365/apps/talk_matterbridge/bin/\".",
    ...
    "Error: System times of omni365 server and Recording backend server are out of sync. Please make sure that both servers are connected to a time-server or manually synchronize their time." : "Σφάλμα: Οι ώρες συστήματος του διακομιστή omni365 και του διακομιστή backend εγγραφής δεν είναι συγχρονισμένες. Βεβαιωθείτε ότι και οι δύο διακομιστές είναι συνδεδεμένοι σε έναν διακομιστή ώρας ή συγχρονίστε χειροκίνητα την ώρα τους.",
    ...
    "omni365 base URL" : "Βασική διεύθυνση URL omni365",
    ...
    "omni365 Talk setup not complete" : "Η ρύθμιση του omni365 Talk δεν είναι πλήρης",
    ...
    "It is highly recommended to set up a distributed cache when using omni365 Talk with a High-performance backend." : "Συνιστάται ιδιαίτερα η ρύθμιση μιας κατανεμημένης cache όταν χρησιμοποιείτε το omni365 Talk με ένα backend υψηλής απόδοσης.",
    ...
    "Join conversations from remote omni365 servers" : "Συμμετοχή σε συνομιλίες από απομακρυσμένους διακομιστές omni365",
    ...
    "Share from {omni365}" : "Κοινή χρήση από {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "Το θόλωμα φόντου για την εγκατάσταση omni365 μπορεί να ρυθμιστεί στις ρυθμίσεις θεματοποίησης.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "Το omni365 Talk ενημερώθηκε, δεν μπορείτε να ξεκινήσετε ή να συμμετάσχετε σε κλήση.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Συμμετείχατε στη συνομιλία σε άλλο παράθυρο ή συσκευή. Αυτήν τη στιγμή δεν υποστηρίζεται από το omni365 Talk, επομένως αυτή η συνεδρία τερματίστηκε.",
    ...
    "omni365 URL" : "Διεύθυνση URL του omni365",
    "omni365 user" : "Χρήστης του omni365",
    ...
    "{actor}:" : "{actor}:",
    "omni365 Talk was updated." : "Το omni365 Talk ενημερώθηκε.",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Προσπαθείτε να συμμετάσχετε σε μια συνομιλία ενώ έχετε ενεργή συνεδρία σε άλλο παράθυρο ή συσκευή. Αυτή τη στιγμή δεν υποστηρίζεται αυτό από το omni365 Talk. Τι θέλετε να κάνετε;",
    ...
    "omni365 is in maintenance mode." : "Το omni365 βρίσκεται σε λειτουργία συντήρησης.",
    "omni365 Talk Federation was updated." : "Το omni365 Talk Federation ενημερώθηκε.",
    "The browser you're using is not fully supported by omni365 Talk. Please use the latest version of Mozilla Firefox, Microsoft Edge, Google Chrome, Opera or Apple Safari." : "Ο περιηγητής που χρησιμοποιείτε δεν υποστηρίζεται πλήρως από το omni365 Talk. Παρακαλώ χρησιμοποιήστε την τελευταία έκδοση του Mozilla Firefox, Microsoft Edge, Google Chrome ή Apple Safari.",
