OC.L10N.register(
    ...
    "Talk" : "Beszélgetés",
    "Guest" : "Vendég",
    "## Welcome to omni365 Talk!\nIn this conversation you will be informed about new features available in omni365 Talk." : "## Üdvözöljük a omni365 Beszélgetésben!\nEbben a beszélgetésben tájékoztatást kap a omni365 Beszélgetés új funkcióiról.",
    ...
    "There is already a trial registered for this omni365 instance." : "Már regisztrált egy próbaverziót ehhez a omni365 példányhoz.",
    ...
    "Our partner Struktur AG provides a service where a hosted signaling server can be requested. For this you only need to fill out the form below and your omni365 will request it. Once the server is set up for you the credentials will be filled automatically. This will overwrite the existing signaling server settings." : "Partnerünk, a Struktur AG szolgáltatásként nyújt jelzőkiszolgálót. Ehhez csak ki kell töltenie az alábbi űrlapot, és a omni365 kérni fogja. Miután beállította az Ön számára a kiszolgálót, a hitelesítő adatok automatikusan kitöltésre kerülnek. Ez felülírja a meglévő jelzőkiszolgáló beállításait.",
    "URL of this omni365 instance" : "Ezen omni365-példány URL-je",
    ...
    "You can install the Matterbridge to link omni365 Talk to some other services, visit their {linkstart1}GitHub page{linkend} for more details. Downloading and installing the app can take a while. In case it times out, please install it manually from the {linkstart2}omni365 App Store{linkend}." : "Telepítheti a Matterbridge-dzet, hogy összekapcsolja a omni365 Beszélgetés alkalmazást néhány további szolgáltatással. További részletekért keresse fel a {linkstart1}GitHub oldalukat{linkend}. Az alkalmazás letöltése és telepítése eltarthat egy ideig. Időtúllépés esetén telepítse kézzel az {linkstart2}alkalmazástárból{linkend}.",
    ...
    "Share from {omni365}" : "Megosztás innen: {omni365}",
    ...
    "Background blur for omni365 instance can be adjusted in the theming settings." : "A omni365 példány háttérelmosása a témabeállításokban állítható.",
    ...
    "omni365 Talk was updated, you cannot start or join a call." : "A omni365 Beszélgetés frissítve lett, nem indíthat vagy csatlakozhat híváshoz.",
    ...
    "You joined the conversation in another window or device. This is currently not supported by omni365 Talk so this session was closed." : "Csatlakozott a beszélgetéshez egy másik ablakban vagy eszközön. Ezt a omni365 Beszélgetés jelenleg nem támogatja, ezért ezt a munkamenetet lezárták.",
    ...
    "omni365 URL" : "omni365 webcíme",
    "omni365 user" : "omni365-felhasználó",
    ...
    "You are trying to join a conversation while having an active session in another window or device. This is currently not supported by omni365 Talk. What do you want to do?" : "Csatlakozni próbál egy beszélgetéshez, miközben aktív munkamenetet folytat egy másik ablakban vagy eszközön. Ezt a omni365 Beszélgetés jelenleg nem támogatja. Mit szeretne tenni?",
