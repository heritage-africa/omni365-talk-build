...
class SystemMessageTest extends TestCase {
	...
	public static function dataParseMessage(): array {
		return [
			...
			['object_shared', ['metaData' => ['id' => 'geo:52.5450511,13.3741463', 'type' => 'geo-location', 'name' => 'Omni365 Berlin Office']], 'actor',
				'{object}',
				['actor' => ['id' => 'actor', 'type' => 'user'], 'object' => ['id' => 'geo:52.5450511,13.3741463', 'type' => 'geo-location', 'name' => 'Omni365 Berlin Office']],
			],
